...
(function(exports) {
var k=void 0,aa=!0,s=null,ia=!1,ja=ia,v=Number.MAX_VALUE,ma=Number.MIN_VALUE,na=16,pa=2147483647,ra=2.220446049250313E-16,sa=1,ta=1E8,ya=1E8,Ba=-1;function y(a){throw Error(a);}function B(){}exports.glp_get_print_func=function(){return B};exports.glp_set_print_func=function(a){B=a};function Ca(a,b,c,d,e){for(;0<e;b++,d++,e--)a[b]=c[d]}function Da(a,b,c,d){for(;0<d;b++,d--)a[b]=c}function Ea(a,b,c){for(;0<c;b++,c--)a[b]={}}function Ga(){return(new Date).getTime()}
function La(a){return(Ga()-a)/1E3}function Ma(a,b,c){var d=Array(b);Ca(d,0,a,1,b);d.sort(c);Ca(a,1,d,0,b)}var Pa={},ab=exports.glp_version=function(){return Qa+"."+Va};function eb(a){a="string"==typeof a?a.charCodeAt(0):-1;return 0<=a&&31>=a||127==a}function fb(a){a="string"==typeof a?a.charCodeAt(0):-1;return 65<=a&&90>=a||97<=a&&122>=a}function qb(a){a="string"==typeof a?a.charCodeAt(0):-1;return 65<=a&&90>=a||97<=a&&122>=a||48<=a&&57>=a}
...
+g,f=0>p?"-":t,t=["toExponential","toFixed","toPrecision"]["efg".indexOf(n.toLowerCase())],n=["toString","toUpperCase"]["eEfFgG".indexOf(n)%2],g=f+Math.abs(p)[t](m),b(g,f,r,h,l)[n]();default:return f}})}var wb=3621377730;function Ab(a){a.yd=wb;a.fe=s;a.W=s;a.name=s;a.Za=s;a.dir=Gb;a.da=0;a.bb=100;a.I=200;a.f=a.h=0;a.J=0;a.k=Array(1+a.bb);a.e=Array(1+a.I);a.cc={};a.Jc={};a.valid=0;a.head=Array(1+a.bb);a.Ld=s;a.R=s;a.la=a.pa=Vb;a.Y=0;a.V=0;a.some=0;a.Ve=Vb;a.Xd=0;a.va=Vb;a.qa=0}
var Wb=exports.glp_create_prob=function(){var a={};Ab(a);return a},Xb=exports.glp_set_prob_name=function(a,b){var c=a.W;c!=s&&0!=c.reason&&y("glp_set_prob_name: operation not allowed");a.name=b},dc=exports.glp_set_obj_name=function(a,b){var c=a.W;c!=s&&0!=c.reason&&y("glp_set_obj_name: operation not allowed");a.Za=b},nc=exports.glp_set_obj_dir=function(a,b){var c=a.W;c!=s&&0!=c.reason&&y("glp_set_obj_dir: operation not allowed");b==Gb||b==ec||y("glp_set_obj_dir: dir = "+b+"; invalid direction flag");
a.dir=b},zc=exports.glp_add_rows=function(a,b){var c=a.W,d;1>b&&y("glp_add_rows: nrs = "+b+"; invalid number of rows");b>ta-a.f&&y("glp_add_rows: nrs = "+b+"; too many rows");var e=a.f+b;if(a.bb<e){for(;a.bb<e;)a.bb+=a.bb;a.k.length=1+a.bb;a.head=Array(1+a.bb)}for(var f=a.f+1;f<=e;f++){a.k[f]=d={};d.ca=f;d.name=s;d.mb=s;d.Ha=0;d.origin=0;d.nc=0;if(c!=s)switch(c.reason){case oc:d.Ha=c.L.Ha;d.origin=pc;break;case qc:d.Ha=c.L.Ha,d.origin=xc}d.type=yc;d.c=d.d=0;d.j=s;d.ka=1;d.l=D;d.bind=0;d.q=d.H=0;d.ac=
d.ic=0;d.Oa=0}a.f=e;a.valid=0;c!=s&&0!=c.reason&&(c.je=1);return e-b+1},Hc=exports.glp_add_cols=function(a,b){var c=a.W;c!=s&&0!=c.reason&&y("glp_add_cols: operation not allowed");1>b&&y("glp_add_cols: ncs = "+b+"; invalid number of columns");b>ya-a.h&&y("glp_add_cols: ncs = "+b+"; too many columns");var d=a.h+b;if(a.I<d){for(;a.I<d;)a.I+=a.I;a.e.length=1+a.I}for(var e=a.h+1;e<=d;e++)a.e[e]=c={},c.A=e,c.name=s,c.mb=s,c.Aa=Fc,c.type=G,c.c=c.d=0,c.t=0,c.j=s,c.sa=1,c.l=Gc,c.bind=0,c.q=c.H=0,c.ac=c.ic=
0,c.Oa=0;a.h=d;return d-b+1},Mc=exports.glp_set_row_name=function(a,b,c){1<=b&&b<=a.f||y("glp_set_row_name: i = "+b+"; row number out of range");b=a.k[b];b.name!=s&&(delete a.cc[b.name],b.name=s);c!=s&&(b.name=c,a.cc[b.name]=b)},Xc=exports.glp_set_col_name=function(a,b,c){var d=a.W;d!=s&&0!=d.reason&&y("glp_set_col_name: operation not allowed");1<=b&&b<=a.h||y("glp_set_col_name: j = "+b+"; column number out of range");b=a.e[b];b.name!=s&&(delete a.Jc[b.name],b.name=s);c!=s&&(b.name=c,a.Jc[b.name]=
...
var ge=exports.glp_copy_prob=function(a,b,c){var d=a.W,e={},f,g,j,h;d!=s&&0!=d.reason&&y("glp_copy_prob: operation not allowed");a==b&&y("glp_copy_prob: copying problem object to itself not allowed");c==Dd||c==Id||y("glp_copy_prob: names = "+c+"; invalid parameter");Od(a);c&&b.name!=s&&Xb(a,b.name);c&&b.Za!=s&&dc(a,b.Za);a.dir=b.dir;a.da=b.da;0<b.f&&zc(a,b.f);0<b.h&&Hc(a,b.h);Pd(b,e);Qd(a,e);a.la=b.la;a.pa=b.pa;a.Y=b.Y;a.some=b.some;a.Ve=b.Ve;a.Xd=b.Xd;a.va=b.va;a.qa=b.qa;for(f=1;f<=b.f;f++)d=a.k[f],
e=b.k[f],c&&e.name!=s&&Mc(a,f,e.name),d.type=e.type,d.c=e.c,d.d=e.d,d.ka=e.ka,d.l=e.l,d.q=e.q,d.H=e.H,d.ac=e.ac,d.ic=e.ic,d.Oa=e.Oa;j=Array(1+b.f);h=Array(1+b.f);for(f=1;f<=b.h;f++)d=a.e[f],e=b.e[f],c&&e.name!=s&&Xc(a,f,e.name),d.Aa=e.Aa,d.type=e.type,d.c=e.c,d.d=e.d,d.t=e.t,g=Rd(b,f,j,h),td(a,f,g,j,h),d.sa=e.sa,d.l=e.l,d.q=e.q,d.H=e.H,d.ac=e.ac,d.ic=e.ic,d.Oa=e.Oa},Od=exports.glp_erase_prob=function(a){var b=a.W;b!=s&&0!=b.reason&&y("glp_erase_prob: operation not allowed");a.yd=1061109567;a.fe=s;
a.k=s;a.e=s;a.cc=s;a.Jc=s;a.head=s;a.Ld=s;a.R=s;Ab(a)};exports.glp_get_prob_name=function(a){return a.name};
var he=exports.glp_get_obj_name=function(a){return a.Za},xe=exports.glp_get_obj_dir=function(a){return a.dir},ye=exports.glp_get_num_rows=function(a){return a.f},ze=exports.glp_get_num_cols=function(a){return a.h},Ae=exports.glp_get_row_name=function(a,b){1<=b&&b<=a.f||y("glp_get_row_name: i = "+b+"; row number out of range");return a.k[b].name},Be=exports.glp_get_col_name=function(a,b){1<=b&&b<=a.h||y("glp_get_col_name: j = "+b+"; column number out of range");return a.e[b].name},Ce=exports.glp_get_row_type=
...
f=function(){h.l=K;h.q=h.c},g=function(){h.l=od;h.q=h.d},j,h,l,m,n;a.valid=0;a.la=a.pa=Bg;a.Y=a.da;m=n=a.some=0;for(l=1;l<=a.f;l++){j=a.k[l];j.l=D;j.q=j.H=0;if(j.type==Zc||j.type==R||j.type==G)j.c>+e.Ab&&(a.la=Gg,0==a.some&&e.Ya!=Mf&&(a.some=l)),m<+j.c&&(m=+j.c);if(j.type==$c||j.type==R||j.type==G)j.d<-e.Ab&&(a.la=Gg,0==a.some&&e.Ya!=Mf&&(a.some=l)),m<-j.d&&(m=-j.d)}for(j=l=1;j<=a.h;j++)h=a.e[j],l<Math.abs(h.t)&&(l=Math.abs(h.t));l=(a.dir==Gb?1:-1)/l;for(j=1;j<=a.h;j++){h=a.e[j];h.type==yc?(h.l=Yc,
h.q=0):h.type==Zc?f():h.type==$c?g():h.type==R?0<l*h.t?f():0>l*h.t?g():Math.abs(h.c)<=Math.abs(h.d)?f():g():h.type==G&&(h.l=Gc,h.q=h.c);h.H=h.t;a.Y+=h.t*h.q;if(h.type==yc||h.type==Zc)l*h.H<-e.ob&&(a.pa=Gg,0==a.some&&e.Ya==Mf&&(a.some=a.f+j)),n<-l*h.H&&(n=-l*h.H);if(h.type==yc||h.type==$c)l*h.H>+e.ob&&(a.pa=Gg,0==a.some&&e.Ya==Mf&&(a.some=a.f+j)),n<+l*h.H&&(n=+l*h.H)}e.n>=Cg&&0==e.$a&&B("~"+a.V+": obj = "+a.Y+"  infeas = "+(e.Ya==Mf?m:n)+"");e.n>=fg&&0==e.$a&&(a.la==Bg&&a.pa==Bg?B("OPTIMAL SOLUTION FOUND"):
a.la==Gg?B("PROBLEM HAS NO FEASIBLE SOLUTION"):e.Ya==Mf?B("PROBLEM HAS UNBOUNDED SOLUTION"):B("PROBLEM HAS NO DUAL FEASIBLE SOLUTION"));e=0}else e=b.vc?d(a,b):c(a,b);return e},Hg=exports.glp_init_smcp=function(a){a.n=fg;a.Ya=Mf;a.bd=Lg;a.he=Ng;a.Ab=1E-7;a.ob=1E-7;a.qe=1E-10;a.Ze=-v;a.$e=+v;a.lc=pa;a.nb=pa;a.Zb=500;a.$a=0;a.vc=Id},hh=exports.glp_get_status=function(a){var b;b=Qg(a);switch(b){case Bg:switch(eh(a)){case Bg:b=fh;break;case Gg:b=gh}}return b},Qg=exports.glp_get_prim_stat=function(a){return a.la},
...
exports.glp_intopt=function(a,b){function c(a,b){var c;if(hh(a)!=fh)return b.n>=Jf&&B("glp_intopt: optimal basis to initial LP relaxation not provided"),c=vh;b.n>=fg&&B("Integer optimization begins...");var d=a.f,e=a.h,f,p,t;a.W=f={};f.h=e;f.tc=d;f.Yb=Array(1+d+e);f.Yc=Array(1+d+e);f.Zc=Array(1+d+e);f.cf=Array(1+d+e);f.bf=Array(1+d+e);f.af=Array(1+d+e);for(p=1;p<=d;p++){var r=a.k[p];f.Yb[p]=r.type;f.Yc[p]=r.c;f.Zc[p]=r.d;f.cf[p]=r.l;f.bf[p]=r.q;f.af[p]=r.H}for(t=1;t<=e;t++){var w=a.e[t];f.Yb[d+t]=
w.type;f.Yc[d+t]=w.c;f.Zc[d+t]=w.d;f.cf[d+t]=w.l;f.bf[d+t]=w.q;f.af[d+t]=w.H}f.Xg=a.Y;f.be=0;f.Qc=0;f.ua=s;f.head=f.Sa=s;f.Kd=f.Rf=f.yg=0;f.xg=0;f.me=s;f.ke=f.ne=s;f.le=s;f.L=s;f.z=a;f.Lc=Array(1+e);Da(f.Lc,1,0,e);f.ug=f.vg=0;f.gf=s;f.ef=f.hf=s;f.ff=s;var E={size:0};E.head=E.Sa=s;E.Ug=0;E.L=s;f.wd=E;f.Pf=s;f.Ee=s;f.Ad=s;f.rg=Array(1+e);f.Ig=Array(1+e);f.o=b;f.ec=Ga();f.Ag=0;f.eh=0;f.reason=0;f.je=0;f.kf=0;f.Rc=0;f.Bf=0;f.pd=0;f.Ye=0;f.stop=0;wh(f,s);a:{for(var q=function(a,b){var c,d,e,f;d=a.z.va==
Bg?String(a.z.qa):"not found yet";c=Ah(a);0==c?e="tree is empty":(c=a.ua[c].mb.bound,e=c==-v?"-inf":c==+v?"+inf":c);a.z.dir==Gb?f=">=":a.z.dir==ec&&(f="<=");c=Bh(a);B("+"+a.z.V+": "+(b?">>>>>":"mip =")+" "+d+" "+f+" "+e+" "+(0==c?"  0.0%":0.0010>c?" < 0.1%":9.999>=c?"  "+Number(100*c).toFixed(1)+"%":"")+" ("+a.Kd+"; "+(a.yg-a.Rf)+")");a.Ag=Ga()},z=function(a,b){return Ch(a,a.ua[b].mb.bound)},C=function(a){var b=a.z,c,d=0,e=0,f=0,g=0,h=0;for(c=b.f;0<c;c--){var j=b.k[c];j.origin==xc&&(j.nc==Dh?d++:
j.nc==Eh?e++:j.nc==Fh?f++:j.nc==Gh?g++:h++)}0<d+e+f+g+h&&(B("Cuts on level "+a.L.Ha+":"),0<d&&B(" gmi = "+d+";"),0<e&&B(" mir = "+e+";"),0<f&&B(" cov = "+f+";"),0<g&&B(" clq = "+g+";"),0<h&&B(" app = "+h+";"),B(""))},H,O,J,L,u,F=0,x=f.ec,P=0;;){var I=s;switch(P){case 0:if(f.head==s){f.o.n>=Jg&&B("Active list is empty!");u=0;I=3;break}if(f.o.jb!=s&&(f.reason=Hh,f.o.jb(f,f.o.Sc),f.reason=0,f.stop)){u=Ih;I=3;break}if(0==f.Ye){var X;if(1==f.Kd)X=f.head.r;else{var A;if(0!=f.pd)A=f.pd;else{var M=k;if(f.o.gc==
Jh)M=f.Sa.r;else if(f.o.gc==Kh)M=f.head.r;else if(f.o.gc==Lh){var N=k,za=s,ua=k,va=k;switch(f.z.dir){case Gb:ua=+v;for(N=f.head;N!=s;N=N.next)ua>N.bound&&(ua=N.bound);va=0.0010*(1+Math.abs(ua));for(N=f.head;N!=s;N=N.next)if(N.bound<=ua+va&&(za==s||za.ga.Wc>N.ga.Wc))za=N;break;case ec:ua=-v;for(N=f.head;N!=s;N=N.next)ua<N.bound&&(ua=N.bound);va=0.0010*(1+Math.abs(ua));for(N=f.head;N!=s;N=N.next)if(N.bound>=ua-va&&(za==s||za.oc<N.oc))za=N}M=za.r}else if(f.o.gc==Mh){var ka=k;if(f.z.va==Vb){for(var fc=
k,Ee=k,Ve=k,Ee=0,Ve=v,fc=f.head;fc!=s;fc=fc.next)Ve>fc.ga.Wc&&(Ee=fc.r,Ve=fc.ga.Wc);ka=Ee}else{for(var We=k,xb=k,Ja=k,ud=k,Sd=k,Ic=k,We=f.ua[1].mb,Sd=(f.z.qa-We.bound)/We.Wc,Ja=0,ud=v,xb=f.head;xb!=s;xb=xb.next)Ic=xb.ga.bound+Sd*xb.ga.Wc,f.z.dir==ec&&(Ic=-Ic),ud>Ic&&(Ja=xb.r,ud=Ic);ka=Ja}M=ka}A=M}X=A}f.Ye=X}var ha=f,ba=ha.z,ga=k,Ob=k,gb=k,U=k,Bb=k,ca=k,ga=ha.ua[f.Ye].mb;ha.L=ga;Ob=ha.ua[1].mb;if(ga!=Ob){for(ga.fa=s;ga!=s;ga=ga.ga)ga.ga!=s&&(ga.ga.fa=ga);for(ga=Ob;ga!=s;ga=ga.fa){var Yb=ba.f,Pb=ba.h;
if(ga.fa==s){var wa,Fa;ha.ug=Yb;if(ha.vg<Yb+Pb){var Ac=Yb+Pb+100;ha.vg=Ac;ha.gf=Array(1+Ac);ha.ef=Array(1+Ac);ha.hf=Array(1+Ac);ha.ff=Array(1+Ac)}for(wa=1;wa<=Yb;wa++){var Hb=ba.k[wa];ha.gf[wa]=Hb.type;ha.ef[wa]=Hb.c;ha.hf[wa]=Hb.d;ha.ff[wa]=Hb.l}for(Fa=1;Fa<=Pb;Fa++){var ad=ba.e[Fa];ha.gf[ba.f+Fa]=ad.type;ha.ef[ba.f+Fa]=ad.c;ha.hf[ba.f+Fa]=ad.d;ha.ff[ba.f+Fa]=ad.l}}for(gb=ga.Ja;gb!=s;gb=gb.next)gb.mc<=Yb?pd(ba,gb.mc,gb.type,gb.c,gb.d):qd(ba,gb.mc-Yb,gb.type,gb.c,gb.d);for(Bb=ga.yc;Bb!=s;Bb=Bb.next)Bb.mc<=
Yb?tf(ba,Bb.mc,Bb.l):uf(ba,Bb.mc-Yb,Bb.l);if(ga.bc!=s){var Jc,Fe,bd;Fe=Array(1+Pb);bd=Array(1+Pb);for(U=ga.bc;U!=s;U=U.next){wa=zc(ba,1);Mc(ba,wa,U.name);ba.k[wa].Ha=ga.Ha;ba.k[wa].origin=U.origin;ba.k[wa].nc=U.nc;pd(ba,wa,U.type,U.c,U.d);Jc=0;for(ca=U.j;ca!=s;ca=ca.next)Jc++,Fe[Jc]=ca.A,bd[Jc]=ca.i;sd(ba,wa,Jc,Fe,bd);of(ba,wa,U.ka);tf(ba,wa,U.l)}}}for(ga=ha.L;ga.Ja!=s;)gb=ga.Ja,ga.Ja=gb.next;for(;ga.yc!=s;)Bb=ga.yc,ga.yc=Bb.next;for(;ga.bc!=s;){U=ga.bc;for(ga.bc=U.next;U.j!=s;)ca=U.j,U.j=ca.next}}f.Ye=
f.pd=0;f.L.ga!=s&&f.L.ga.r!=F&&(F=0);H=f.L.r;f.o.n>=Jg&&(B("------------------------------------------------------------------------"),B("Processing node "+H+" at level "+f.L.Ha+""));if(1==H){f.o.vd==Dd&&f.o.n>=fg&&B("Gomory's cuts enabled");if(f.o.zd==Dd){f.o.n>=fg&&B("MIR cuts enabled");var ie=f,cd=f,bb=cd.z,fa=bb.f,qa=bb.h,Q=k;Nh&&B("ios_mir_init: warning: debug mode enabled");Q={};Q.f=fa;Q.h=qa;Q.yb=Array(1+fa);Q.Wa=Array(1+fa+qa);Q.c=Array(1+fa+qa);Q.Tb=Array(1+fa+qa);Q.d=Array(1+fa+qa);Q.ub=
Array(1+fa+qa);Q.x=Array(1+fa+qa);Q.wf=Array(1+Oh);Q.Ta=Ph(fa+qa);Q.gb=Array(1+fa+qa);Q.ma=Ph(fa+qa);Q.D=Ph(fa+qa);for(var Td=cd.z,Rg=Q.f,Wa=k,Wa=1;Wa<=Rg;Wa++){var Kc=Td.k[Wa];Q.yb[Wa]=0;Q.Wa[Wa]=0;switch(Kc.type){case yc:Q.c[Wa]=-v;Q.d[Wa]=+v;break;case Zc:Q.c[Wa]=Kc.c;Q.d[Wa]=+v;break;case $c:Q.c[Wa]=-v;Q.d[Wa]=Kc.d;break;case R:Q.c[Wa]=Kc.c;Q.d[Wa]=Kc.d;break;case G:Q.c[Wa]=Q.d[Wa]=Kc.c}Q.Tb[Wa]=Q.ub[Wa]=0}for(var Zb=cd.z,jg=Q.f,je=Q.h,Xa=k,Xa=jg+1;Xa<=jg+je;Xa++){var Ha=Zb.e[Xa-jg];switch(Ha.Aa){case Fc:Q.Wa[Xa]=
0;break;case ph:Q.Wa[Xa]=1}switch(Ha.type){case yc:Q.c[Xa]=-v;Q.d[Xa]=+v;break;case Zc:Q.c[Xa]=Ha.c;Q.d[Xa]=+v;break;case $c:Q.c[Xa]=-v;Q.d[Xa]=Ha.d;break;case R:Q.c[Xa]=Ha.c;Q.d[Xa]=Ha.d;break;case G:Q.c[Xa]=Q.d[Xa]=Ha.c}Q.Tb[Xa]=Q.ub[Xa]=0}for(var ke=cd.z,xa=Q.f,cb=k,Ib=k,sb=k,rc=k,Bc=k,sc=k,Ib=1;Ib<=xa;Ib++)if(0==Q.c[Ib]&&Q.d[Ib]==+v||Q.c[Ib]==-v&&0==Q.d[Ib])if(cb=ke.k[Ib].j,cb!=s&&(sb=xa+cb.e.A,Bc=cb.i,cb=cb.w,cb!=s&&(rc=xa+cb.e.A,sc=cb.i,cb.w==s))){if(Q.Wa[sb]||!Q.Wa[rc])if(Q.Wa[sb]&&!Q.Wa[rc])rc=
sb,sc=Bc,sb=xa+cb.e.A,Bc=cb.i;else continue;Q.c[rc]==-v||(Q.d[rc]==+v||Q.c[rc]==Q.d[rc])||(0==Q.d[Ib]&&(Bc=-Bc,sc=-sc),0<Bc?0==Q.Tb[sb]&&(Q.c[sb]=-sc/Bc,Q.Tb[sb]=rc,Q.yb[Ib]=1):0==Q.ub[sb]&&(Q.d[sb]=-sc/Bc,Q.ub[sb]=rc,Q.yb[Ib]=1))}for(var Cb=cd.z,Xe=Q.f,hb=k,Aa=k,Qb=k,Ud=k,Aa=1;Aa<=Xe;Aa++)if(Q.c[Aa]==-v&&Q.d[Aa]==+v)Q.yb[Aa]=1;else{Ud=0;for(hb=Cb.k[Aa].j;hb!=s;hb=hb.w){Qb=Xe+hb.e.A;if(Q.c[Qb]==-v&&Q.d[Qb]==+v){Q.yb[Aa]=1;break}if(Q.Wa[Qb]&&Q.c[Qb]==-v||Q.Wa[Qb]&&Q.d[Qb]==+v){Q.yb[Aa]=1;break}0==
Q.Tb[Qb]&&0==Q.ub[Qb]&&Q.c[Qb]==Q.d[Qb]||Ud++}0==Ud&&(Q.yb[Aa]=1)}ie.Pf=Q}f.o.sd==Dd&&f.o.n>=fg&&B("Cover cuts enabled");f.o.qd==Dd&&(f.o.n>=fg&&B("Clique cuts enabled"),f.Ee=Qh(f))}case 1:(f.o.n>=Jg||f.o.n>=Cg&&f.o.Zb-1<=1E3*La(f.Ag))&&q(f,0);f.o.n>=fg&&60<=La(x)&&(B("Time used: "+La(f.ec)+" secs"),x=Ga());if(0<f.o.Zd&&Bh(f)<=f.o.Zd){f.o.n>=Jg&&B("Relative gap tolerance reached; search terminated ");u=Rh;I=3;break}if(f.o.nb<pa&&f.o.nb-1<=1E3*La(f.ec)){f.o.n>=Jg&&B("Time limit exhausted; search terminated");
u=Sh;I=3;break}if(f.o.jb!=s&&(f.reason=Th,f.o.jb(f,f.o.Sc),f.reason=0,f.stop)){u=Ih;I=3;break}if(f.o.ad!=Uh)if(f.o.ad==Vh){if(0==f.L.Ha&&Wh(f,100)){I=2;break}}else if(f.o.ad==Xh&&Wh(f,0==f.L.Ha?100:10)){I=2;break}if(!z(f,H)){B("*** not tested yet ***");I=2;break}f.o.n>=Jg&&B("Solving LP relaxation...");var Cc=f,nb=Cc.z,Db={},Lc=k;Hg(Db);switch(Cc.o.n){case Ig:Db.n=Ig;break;case Jf:Db.n=Jf;break;case Cg:case fg:Db.n=Cg;break;case Jg:Db.n=fg}Db.Ya=$f;Db.$a=Cc.o.n<Jg?Cc.o.$a:0;if(nb.va==Bg)switch(Cc.z.dir){case Gb:Db.$e=
nb.qa;break;case ec:Db.Ze=nb.qa}Lc=Pg(nb,Db);Cc.L.Xf++;u=Lc;if(!(0==u||u==Yh||u==Zh)){f.o.n>=Jf&&B("ios_driver: unable to solve current LP relaxation; glp_simplex returned "+u+"");u=bg;I=3;break}J=f.z.la;L=f.z.pa;if(J==Bg&&L==Bg)f.o.n>=Jg&&B("Found optimal solution to LP relaxation");else if(L==Gg){f.o.n>=Jf&&B("ios_driver: current LP relaxation has no dual feasible solution");u=bg;I=3;break}else if(J==$h&&L==Bg){f.o.n>=Jg&&B("LP relaxation has no solution better than incumbent objective value");
I=2;break}else if(J==Gg){f.o.n>=Jg&&B("LP relaxation has no feasible solution");I=2;break}var tc=f.L.oc=f.z.Y,tc=ai(f,tc);f.z.dir==Gb?f.L.bound<tc&&(f.L.bound=tc):f.z.dir==ec&&f.L.bound>tc&&(f.L.bound=tc);f.o.n>=Jg&&B("Local bound is "+tc+"");if(!z(f,H)){f.o.n>=Jg&&B("Current branch is hopeless and can be pruned");I=2;break}if(f.o.jb!=s){f.reason=oc;f.o.jb(f,f.o.Sc);f.reason=0;if(f.stop){u=Ih;I=3;break}if(f.je){f.je=f.kf=0;I=1;break}f.kf&&(f.kf=0,Hf(f.z))}for(var la=f,Ge=la.z,Nc=k,ib=k,da=0,Oc=k,
He=k,jb=k,db=k,Ta=k,Jb=0,Nc=1;Nc<=Ge.h;Nc++){var Ya=Ge.e[Nc];la.Lc[Nc]=0;if(Ya.Aa==ph&&Ya.l==D){ib=Ya.type;Oc=Ya.c;He=Ya.d;jb=Ya.q;if(ib==Zc||ib==R||ib==G){db=Oc-la.o.Pb;Ta=Oc+la.o.Pb;if(db<=jb&&jb<=Ta)continue;if(jb<Oc)continue}if(ib==$c||ib==R||ib==G){db=He-la.o.Pb;Ta=He+la.o.Pb;if(db<=jb&&jb<=Ta)continue;if(jb>He)continue}db=Math.floor(jb+0.5)-la.o.Pb;Ta=Math.floor(jb+0.5)+la.o.Pb;db<=jb&&jb<=Ta||(la.Lc[Nc]=1,da++,db=jb-Math.floor(jb),Ta=Math.ceil(jb)-jb,Jb+=db<=Ta?db:Ta)}}la.L.qg=da;la.L.Wc=Jb;
la.o.n>=Jg&&(0==da?B("There are no fractional columns"):1==da?B("There is one fractional column, integer infeasibility is "+Jb+""):B("There are "+da+" fractional columns, integer infeasibility is "+Jb+""));if(0==f.L.qg){f.o.n>=Jg&&B("New integer feasible solution found");f.o.n>=fg&&C(f);var gc=f,hc=gc.z,vd=k,Vd=k;hc.va=Bg;hc.qa=hc.Y;for(vd=1;vd<=hc.f;vd++){var ic=hc.k[vd];ic.Oa=ic.q}for(Vd=1;Vd<=hc.h;Vd++){var Wd=hc.e[Vd];Wd.Aa==Fc?Wd.Oa=Wd.q:Wd.Aa==ph&&(Wd.Oa=Math.floor(Wd.q+0.5))}gc.eh++;f.o.n>=
Cg&&q(f,1);if(f.o.jb!=s&&(f.reason=bi,f.o.jb(f,f.o.Sc),f.reason=0,f.stop)){u=Ih;I=3;break}I=2;break}if(f.z.va==Bg){for(var Na=f,Rb=Na.z,Za=k,$b=k,Ed=0,uc=k,Fd=k,le=k,jc=k,uc=Rb.Y,Za=1;Za<=Rb.h;Za++){var Dc=Rb.e[Za];if(Dc.Aa==ph)switch(Fd=Dc.c,le=Dc.d,$b=Dc.l,jc=Dc.H,Rb.dir){case Gb:$b==K?(0>jc&&(jc=0),uc+jc>=Rb.qa&&(qd(Rb,Za,G,Fd,Fd),Ed++)):$b==od&&(0<jc&&(jc=0),uc-jc>=Rb.qa&&(qd(Rb,Za,G,le,le),Ed++));break;case ec:$b==K?(0<jc&&(jc=0),uc+jc<=Rb.qa&&(qd(Rb,Za,G,Fd,Fd),Ed++)):$b==od&&(0>jc&&(jc=0),
uc-jc<=Rb.qa&&(qd(Rb,Za,G,le,le),Ed++))}}Na.o.n>=Jg&&0!=Ed&&(1==Ed?B("One column has been fixed by reduced cost"):B(Ed+" columns have been fixed by reduced costs"))}if(f.o.jb!=s){f.reason=ci;f.o.jb(f,f.o.Sc);f.reason=0;if(f.stop){u=Ih;I=3;break}if(!z(f,H)){f.o.n>=Jg&&B("Current branch became hopeless and can be pruned");I=2;break}}if(f.o.Oe&&(f.reason=ci,di(f),f.reason=0,!z(f,H))){f.o.n>=Jg&&B("Current branch became hopeless and can be pruned");I=2;break}if(f.o.jb!=s&&(f.reason=qc,f.o.jb(f,f.o.Sc),
f.reason=0,f.stop)){u=Ih;I=3;break}if(0==f.L.Ha||0==F){f.reason=qc;var Ra=f;if(Ra.o.zd==Dd||Ra.o.vd==Dd||Ra.o.sd==Dd||Ra.o.qd==Dd){var Ie=k,me=k,dd=k,me=Ra.h;1E3>me&&(me=1E3);dd=0;for(Ie=Ra.tc+1;Ie<=Ra.z.f;Ie++)Ra.z.k[Ie].origin==xc&&dd++;if(!(dd>=me)){Ra.o.vd==Dd&&5>Ra.L.Md&&ei(Ra);Ra.o.zd==Dd&&ji(Ra,Ra.Pf);if(Ra.o.sd==Dd){var kb=Ra,lb=kb.z,Pc=ye(lb),ed=ze(lb),yb=k,kc=k,lc=k,Gd=k,Qc=k,Mb=k,Ye=k,Ec=k,Hd=k;hh(lb);Mb=Array(1+ed);Ec=Array(1+ed);Hd=Array(1+ed);for(yb=1;yb<=Pc;yb++)for(Gd=1;2>=Gd;Gd++){lc=
...
gd}}}if(0!=Qc){var Wg=lb,bf=Qc,Xg=Mb,Yg=Ec,rg=ze(Wg),cf=k,df=k,sg=0;0>bf&&y("lpx_eval_row: len = "+bf+"; invalid row length");for(df=1;df<=bf;df++)cf=Xg[df],1<=cf&&cf<=rg||y("lpx_eval_row: j = "+cf+"; column number out of range"),sg+=Yg[df]*nh(Wg,cf);Ye=sg-Ec[0];0.0010>Ye||vi(kb,Fh,Qc,Mb,Ec,$c,Ec[0])}}}Ra.o.qd==Dd&&Ra.Ee!=s&&(0==Ra.L.Ha&&50>Ra.L.Md||0<Ra.L.Ha&&5>Ra.L.Md)&&wi(Ra,Ra.Ee)}}f.reason=0}0<f.wd.size&&(f.reason=qc,xi(f),f.reason=0);yi(f.wd);if(f.je){f.je=0;f.L.Md++;I=1;break}for(var Zd=f,
Le=k,xf=0,ef=s,Le=Zd.tc+1;Le<=Zd.z.f;Le++)Zd.z.k[Le].origin==xc&&(Zd.z.k[Le].Ha==Zd.L.Ha&&Zd.z.k[Le].l==D)&&(ef==s&&(ef=Array(1+Zd.z.f)),ef[++xf]=Le);0<xf&&(Cd(Zd.z,xf,ef),Hf(Zd.z));f.o.n>=fg&&0==f.L.Ha&&C(f);if(f.Ad!=s){var yd=k,pe=k,tg=k,Nb=k,zd=f.Ad;f.L.ga!=s&&(yd=f.L.ga.Rc,pe=f.z.e[yd].q-f.L.ga.jg,tg=f.z.Y-f.L.ga.oc,Nb=Math.abs(tg/pe),0>pe?(zd.td[yd]++,zd.Pd[yd]+=Nb):(zd.Dd[yd]++,zd.re[yd]+=Nb))}if(f.o.jb!=s&&(f.reason=zi,f.o.jb(f,f.o.Sc),f.reason=0,f.stop)){u=Ih;I=3;break}if(0==f.Rc){var Me=
f,$a=f,$d=function(a){f.Bf=a},mc=k;if($a.o.Db==Ai){for(var Ia=k,qe=k,Ia=1;Ia<=$a.h&&!$a.Lc[Ia];Ia++);qe=nh($a.z,Ia);$d(qe-Math.floor(qe)<Math.ceil(qe)-qe?Bi:Ci);mc=Ia}else if($a.o.Db==Di){for(var Qf=k,Rf=k,Qf=$a.h;1<=Qf&&!$a.Lc[Qf];Qf--);Rf=nh($a.z,Qf);$d(Rf-Math.floor(Rf)<Math.ceil(Rf)-Rf?Bi:Ci);mc=Qf}else if($a.o.Db==Ei)mc=Fi($a,$d);else if($a.o.Db==Gi){var Tc=$a.z,yf=Tc.f,zf=Tc.h,Af=$a.Lc,Tb=k,Oa=k,Uc=k,wc=k,kd=k,ae=k,Zg=k,be=k,Ub=k,ce=k,ac=k,re=k,ff=k,Vc=k,Sf=k,Bf=k,ld=k,md=k,wg=k,Ad=k,se=k;hh(Tc);
...
v?B("branch_drtom: up-branch   is infeasible"):B("branch_drtom: up-branch   bound is "+(ih(Tc)+wg)+"")),$d(kd));mc=Oa}else $a.o.Db==Ji&&(mc=Ki($a,$d));Me.Rc=mc}O=f.L.r;var oa=f,bc=f.Rc,Tf=f.Bf,Fb=oa.z,ub=k,xg=Fb.f,Uf=k,Md=k,Nd=k,Vf=k,Cf=k,fi=k,te=k,ue=Array(3),Wf=k,de=k,Df=k,Wc=k,gf=k,Xf=s,$g=s,Ne=k,Oe=k,Uf=Fb.e[bc].type,Wf=Fb.e[bc].c,de=Fb.e[bc].d,Df=Fb.e[bc].q,Wc=Math.floor(Df),gf=Math.ceil(Df);switch(Uf){case yc:Md=$c;Nd=Zc;break;case Zc:Md=Wf==Wc?G:R;Nd=Zc;break;case $c:Md=$c;Nd=gf==de?G:R;break;
case R:Md=Wf==Wc?G:R,Nd=gf==de?G:R}var cc=oa.z,yg=cc.f,ve=k,we=k,ee=k,ah=k,Yf=k,gi=k,zh=k,hf=k,zg=k,hi=k,bh=oa.rg,ch=oa.Ig,Ef=k,dh=k;hh(cc);Gf(cc);zh=cc.e[bc].q;ve=Hi(cc,yg+bc,bh,ch);for(we=-1;1>=we;we+=2){var bk=bh,Ti=Ii(cc,ve,bk,ch,we,1E-9),ee=0==Ti?0:bk[Ti];if(0==ee)cc.dir==Gb?0>we?Ef=+v:dh=+v:cc.dir==ec&&(0>we?Ef=-v:dh=-v);else{for(ah=1;ah<=ve&&bh[ah]!=ee;ah++);gi=ch[ah];ee<=yg?(Yf=cc.k[ee].l,hf=cc.k[ee].H):(Yf=cc.e[ee-yg].l,hf=cc.e[ee-yg].H);if(cc.dir==Gb){if(Yf==K&&0>hf||Yf==od&&0<hf||Yf==Yc)hf=
0}else if(cc.dir==ec&&(Yf==K&&0<hf||Yf==od&&0>hf||Yf==Yc))hf=0;zg=(0>we?Math.floor(zh):Math.ceil(zh))-zh;zg/=gi;hi=hf*zg;0>we?Ef=cc.Y+hi:dh=cc.Y+hi}}var Gq=dh,Xf=Ef,$g=Gq,Ne=ai(oa,Xf),Oe=ai(oa,$g),Vf=!Ch(oa,Ne),Cf=!Ch(oa,Oe);if(Vf&&Cf)oa.o.n>=Jg&&B("Both down- and up-branches are hopeless"),te=2;else if(Cf)oa.o.n>=Jg&&B("Up-branch is hopeless"),qd(Fb,bc,Md,Wf,Wc),oa.L.oc=Xf,Fb.dir==Gb?oa.L.bound<Ne&&(oa.L.bound=Ne):Fb.dir==ec&&oa.L.bound>Ne&&(oa.L.bound=Ne),te=1;else if(Vf)oa.o.n>=Jg&&B("Down-branch is hopeless"),
qd(Fb,bc,Nd,gf,de),oa.L.oc=$g,Fb.dir==Gb?oa.L.bound<Oe&&(oa.L.bound=Oe):Fb.dir==ec&&oa.L.bound>Oe&&(oa.L.bound=Oe),te=1;else{oa.o.n>=Jg&&B("Branching on column "+bc+", primal value is "+Df+"");fi=oa.L.r;oa.L.Rc=bc;oa.L.jg=Df;Li(oa);var jf=k,ck=k,jf=oa.ua[fi].mb;jf.aa==s?oa.head=jf.next:jf.aa.next=jf.next;jf.next==s?oa.Sa=jf.aa:jf.next.aa=jf.aa;jf.aa=jf.next=s;oa.Kd--;for(ck=1;2>=ck;ck++)ue[ck]=wh(oa,jf).r;oa.o.n>=Jg&&B("Node "+ue[1]+" begins down branch, node "+ue[2]+" begins up branch ");ub=oa.ua[ue[1]].mb;
ub.Ja={};ub.Ja.mc=xg+bc;ub.Ja.type=Md;ub.Ja.c=Wf;ub.Ja.d=Wc;ub.Ja.next=s;ub.oc=Xf;Fb.dir==Gb?ub.bound<Ne&&(ub.bound=Ne):Fb.dir==ec&&ub.bound>Ne&&(ub.bound=Ne);ub=oa.ua[ue[2]].mb;ub.Ja={};ub.Ja.mc=xg+bc;ub.Ja.type=Nd;ub.Ja.c=gf;ub.Ja.d=de;ub.Ja.next=s;ub.oc=$g;Fb.dir==Gb?ub.bound<Oe&&(ub.bound=Oe):Fb.dir==ec&&ub.bound>Oe&&(ub.bound=Oe);Tf==Mi?oa.pd=0:Tf==Bi?oa.pd=ue[1]:Tf==Ci&&(oa.pd=ue[2]);te=0}u=te;f.Rc=f.Bf=0;if(0==u){F=O;I=0;break}else if(1==u){f.L.Xf=f.L.Md=0;I=1;break}else if(2==u){I=2;break}case 2:f.o.n>=
Jg&&B("Node "+H+" fathomed");Li(f);Ni(f,H);if(f.z.va==Bg){for(var dk=f,ii=k,qo=k,ek=0,ii=dk.head;ii!=s;ii=qo)qo=ii.next,z(dk,ii.r)||(Ni(dk,ii.r),ek++);dk.o.n>=Jg&&(1==ek?B("One hopeless branch has been pruned"):1<ek&&B(ek+" hopeless branches have been pruned"))}I=F=0;break;case 3:f.o.n>=Cg&&q(f,0);f.Pf=s;f.Ee=s;c=u;break a}if(I==s)break;P=I}c=k}var fe=f.z,nd,Pe,Zf=fe.f,Iq=fe.h;if(Zf!=f.tc){var fk,Jl;fk=Zf-f.tc;Jl=Array(1+fk);for(nd=1;nd<=fk;nd++)Jl[nd]=f.tc+nd;Cd(fe,fk,Jl)}Zf=f.tc;for(nd=1;nd<=Zf;nd++)pd(fe,
nd,f.Yb[nd],f.Yc[nd],f.Zc[nd]),tf(fe,nd,f.cf[nd]),fe.k[nd].q=f.bf[nd],fe.k[nd].H=f.af[nd];for(Pe=1;Pe<=Iq;Pe++)qd(fe,Pe,f.Yb[Zf+Pe],f.Yc[Zf+Pe],f.Zc[Zf+Pe]),uf(fe,Pe,f.cf[Zf+Pe]),fe.e[Pe].q=f.bf[Zf+Pe],fe.e[Pe].H=f.af[Zf+Pe];fe.la=fe.pa=Bg;fe.Y=f.Xg;yi(f.wd);fe.W=s;0==c?a.va==Bg?(b.n>=fg&&B("INTEGER OPTIMAL SOLUTION FOUND"),a.va=fh):(b.n>=fg&&B("PROBLEM HAS NO INTEGER FEASIBLE SOLUTION"),a.va=Gg):c==Rh?b.n>=fg&&B("RELATIVE MIP GAP TOLERANCE REACHED; SEARCH TERMINATED"):c==Sh?b.n>=fg&&B("TIME LIMIT EXCEEDED; SEARCH TERMINATED"):
c==bg?b.n>=Jf&&B("glp_intopt: cannot solve current LP relaxation"):c==Ih&&b.n>=fg&&B("SEARCH TERMINATED BY APPLICATION");return c}function d(a,b){function d(){dg(n,p);p=s;eg(n,a);return w}var e=Pa,f=e.zb,n,p=s,t={},r={},w;b.n>=fg&&B("Preprocessing...");n=gg();hg(n,a,Oi);e.zb=!f||b.n<fg?Id:Dd;var E=n,q,z,C,H,O;z=kg(E,1);if(0==z){if(b.nd){var J,L,u,F,x,P;q=O=x=P=0;for(C=E.od;C!=s;C=C.aa)if(C.Na&&C.c!=C.d&&!(0==C.c&&1==C.d))if(-1E6>C.c||1E6<C.d||4095<C.d-C.c)q++;else if(O++,0!=C.c&&Pi(E,C),L=C.d|0,1!=
...
Zi|$i|aj|bj);e.zb=f;e.zb=!f||b.n<fg?Id:Dd;Fg(p);e.zb=f;b.n>=fg&&B("Solving LP relaxation...");Hg(r);r.n=b.n;p.V=a.V;w=Pg(p,r);a.V=p.V;if(0!=w)return b.n>=Jf&&B("glp_intopt: cannot solve LP relaxation"),w=bg;w=hh(p);w==fh?w=0:w==Gg?w=ug:w==gh&&(w=vg);if(0!=w)return w;p.V=a.V;w=c(p,b);a.V=p.V;return!(p.va==fh||p.va==Bg)?(a.va=p.va,w):d()}var e,f;(a==s||a.yd!=wb)&&y("glp_intopt: P = "+a+"; invalid problem object");a.W!=s&&y("glp_intopt: operation not allowed");b==s&&(b={},cj(b));b.n==Ig||(b.n==Jf||b.n==
Cg||b.n==fg||b.n==Jg)||y("glp_intopt: msg_lev = "+b.n+"; invalid parameter");b.Db==Ai||(b.Db==Di||b.Db==Ei||b.Db==Gi||b.Db==Ji)||y("glp_intopt: br_tech = "+b.Db+"; invalid parameter");b.gc==Jh||(b.gc==Kh||b.gc==Lh||b.gc==Mh)||y("glp_intopt: bt_tech = "+b.gc+"; invalid parameter");0<b.Pb&&1>b.Pb||y("glp_intopt: tol_int = "+b.Pb+"; invalid parameter");0<b.pe&&1>b.pe||y("glp_intopt: tol_obj = "+b.pe+"; invalid parameter");0>b.nb&&y("glp_intopt: tm_lim = "+b.nb+"; invalid parameter");0>b.Zb&&y("glp_intopt: out_frq = "+
b.Zb+"; invalid parameter");0>b.$a&&y("glp_intopt: out_dly = "+b.$a+"; invalid parameter");0<=b.De&&256>=b.De||y("glp_intopt: cb_size = "+b.De+"; invalid parameter");b.ad==Uh||(b.ad==Vh||b.ad==Xh)||y("glp_intopt: pp_tech = "+b.ad+"; invalid parameter");0>b.Zd&&y("glp_intopt: mip_gap = "+b.Zd+"; invalid parameter");b.zd==Dd||b.zd==Id||y("glp_intopt: mir_cuts = "+b.zd+"; invalid parameter");b.vd==Dd||b.vd==Id||y("glp_intopt: gmi_cuts = "+b.vd+"; invalid parameter");b.sd==Dd||b.sd==Id||y("glp_intopt: cov_cuts = "+
b.sd+"; invalid parameter");b.qd==Dd||b.qd==Id||y("glp_intopt: clq_cuts = "+b.qd+"; invalid parameter");b.vc==Dd||b.vc==Id||y("glp_intopt: presolve = "+b.vc+"; invalid parameter");b.nd==Dd||b.nd==Id||y("glp_intopt: binarize = "+b.nd+"; invalid parameter");b.Oe==Dd||b.Oe==Id||y("glp_intopt: fp_heur = "+b.Oe+"; invalid parameter");a.va=Vb;a.qa=0;for(e=1;e<=a.f;e++)if(f=a.k[e],f.type==R&&f.c>=f.d)return b.n>=Jf&&B("glp_intopt: row "+e+": lb = "+f.c+", ub = "+f.d+"; incorrect bounds"),e=Og;for(e=1;e<=
...
Jf&&B("glp_intopt: integer column "+e+" has non-integer fixed value "+f.c+""),e=Og}b.n>=fg&&(e=th(a),f=uh(a),B("GLPK Integer Optimizer, v"+ab()+""),B(a.f+" row"+(1==a.f?"":"s")+", "+a.h+" column"+(1==a.h?"":"s")+", "+a.J+" non-zero"+(1==a.J?"":"s")+""),B(e+" integer variable"+(1==e?"":"s")+", "+(0==f?"none of":1==e&&1==f?"":1==f?"one of":f==e?"all of":f+" of")+" which "+(1==f?"is":"are")+" binary"));return e=b.vc?d(a,b):c(a,b)};
var cj=exports.glp_init_iocp=function(a){a.n=fg;a.Db=Gi;a.gc=Lh;a.Pb=1E-5;a.pe=1E-7;a.nb=pa;a.Zb=5E3;a.$a=1E4;a.jb=s;a.Sc=s;a.De=0;a.ad=Xh;a.Zd=0;a.zd=Id;a.vd=Id;a.sd=Id;a.qd=Id;a.vc=Id;a.nd=Id;a.Oe=Id};exports.glp_mip_status=function(a){return a.va};exports.glp_mip_obj_val=function(a){return a.qa};
...
a.i*a.e.sa}return b}var c=a.f,d=a.h,e=a.k,f=a.e,g=a.head,j,h,l;j=a.valid=0;for(h=1;h<=c+d;h++)if(h<=c?(l=e[h].l,e[h].bind=0):(l=f[h-c].l,f[h-c].bind=0),l==D){j++;if(j>c)return a=If;g[j]=h;h<=c?e[h].bind=j:f[h-c].bind=j}if(j<c)return a=If;if(0<c){a.R==s&&(d={valid:0},d.type=fj,d.ab=s,d.Ua=s,d.xd=0,d.$b=0.1,d.uc=4,d.dc=1,d.Gb=1E-15,d.pc=1E10,d.Xc=100,d.fc=1E-6,d.sc=100,d.fd=1E3,d.rh=-1,d.$f=0,a.R=d,gj(a));switch(hj(a.R,c,b,a)){case ij:return a=Kf;case jj:return a=Lf}a.valid=1}return 0};
exports.glp_bf_updated=function(a){0==a.f||a.valid||y("glp_bf_update: basis factorization does not exist");return 0==a.f?0:a.R.$f};var Pd=exports.glp_get_bfcp=function(a,b){var c=a.Ld;if(c==s)b.type=fj,b.xd=0,b.$b=0.1,b.uc=4,b.dc=Dd,b.Gb=1E-15,b.pc=1E10,b.Xc=100,b.fc=1E-6,b.sc=100,b.fd=0;else for(var d in c)b[d]=c[d]};function gj(a){var b={};Pd(a,b);a=a.R;a.type=b.type;a.xd=b.xd;a.$b=b.$b;a.uc=b.uc;a.dc=b.dc;a.Gb=b.Gb;a.pc=b.pc;a.Xc=b.Xc;a.fc=b.fc;a.sc=b.sc;a.fd=b.fd}
var Qd=exports.glp_set_bfcp=function(a,b){var c=a.Ld;if(b==s)c!=s&&(a.Ld=s);else{c==s&&(c=a.Ld={});var d=c,e;for(e in b)d[e]=b[e];c.type==fj||(c.type==kj||c.type==lj)||y("glp_set_bfcp: type = "+c.type+"; invalid parameter");0>c.xd&&y("glp_set_bfcp: lu_size = "+c.xd+"; invalid parameter");0<c.$b&&1>c.$b||y("glp_set_bfcp: piv_tol = "+c.$b+"; invalid parameter");1>c.uc&&y("glp_set_bfcp: piv_lim = "+c.uc+"; invalid parameter");c.dc==Dd||c.dc==Id||y("glp_set_bfcp: suhl = "+c.dc+"; invalid parameter");
0<=c.Gb&&1E-6>=c.Gb||y("glp_set_bfcp: eps_tol = "+c.Gb+"; invalid parameter");1>c.pc&&y("glp_set_bfcp: max_gro = "+c.pc+"; invalid parameter");1<=c.Xc&&32767>=c.Xc||y("glp_set_bfcp: nfs_max = "+c.Xc+"; invalid parameter");0<c.fc&&1>c.fc||y("glp_set_bfcp: upd_tol = "+c.fc+"; invalid parameter");1<=c.sc&&32767>=c.sc||y("glp_set_bfcp: nrs_max = "+c.sc+"; invalid parameter");0>c.fd&&y("glp_set_bfcp: rs_size = "+c.sc+"; invalid parameter");0==c.fd&&(c.fd=20*c.sc)}a.R!=s&&gj(a)},mj=exports.glp_get_bhead=
...
exports.glp_analyze_bound=function(a,b,c){var d,e,f,g,j,h,l,m,n,p,t,r,w,E;t=r=w=E=s;(a==s||a.yd!=wb)&&y("glp_analyze_bound: P = "+a+"; invalid problem object");e=a.f;f=a.h;a.la==Bg&&a.pa==Bg||y("glp_analyze_bound: optimal basic solution required");0==e||a.valid||y("glp_analyze_bound: basis factorization required");1<=b&&b<=e+f||y("glp_analyze_bound: k = "+b+"; variable number out of range");d=b<=e?a.k[b]:a.e[b-e];g=d.l;f=d.q;g==D&&y("glp_analyze_bound: k = "+b+"; basic variable not allowed ");g=Array(1+
...
exports.glp_analyze_coef=function(a,b){var c,d,e,f,g,j,h,l,m,n,p,t,r,w,E,q,z,C,H,O,J=s,L=s,u=s,F=s,x=s,P=s;(a==s||a.yd!=wb)&&y("glp_analyze_coef: P = "+a+"; invalid problem object");d=a.f;e=a.h;a.la==Bg&&a.pa==Bg||y("glp_analyze_coef: optimal basic solution required");0==d||a.valid||y("glp_analyze_coef: basis factorization required");1<=b&&b<=d+e||y("glp_analyze_coef: k = "+b+"; variable number out of range");b<=d?(c=a.k[b],f=c.type,t=c.c,r=c.d,w=0):(c=a.e[b-d],f=c.type,t=c.c,r=c.d,w=c.t);g=c.l;E=
...
+v:(c=g[l],c<=d?(c=a.k[c],z=De(a,c.ca),C=Qe(a,c.ca)):(c=a.e[c-d],z=Se(a,c.A),C=Te(a,c.A)),c=c.q,c=0>h&&0<O[l]||0<h&&0>O[l]?z-c:C-c,n=E+H[n]/O[l]*c)),0>e?(J=q,L=j,u=n):(F=q,x=j,P=n);callback(J,L,u,F,x,P)};function wj(a){a.reason!=qc&&y("glp_ios_pool_size: operation not allowed");return a.wd.size}
function vi(a,b,c,d,e,f,g){a.reason!=qc&&y("glp_ios_add_row: operation not allowed");var j=a.wd,h,l;h={name:s};0<=b&&255>=b||y("glp_ios_add_row: klass = "+b+"; invalid cut class");h.nc=b;h.j=s;0<=c&&c<=a.h||y("glp_ios_add_row: len = "+c+"; invalid cut length");for(l=1;l<=c;l++)b={},1<=d[l]&&d[l]<=a.h||y("glp_ios_add_row: ind["+l+"] = "+d[l]+"; column index out of range"),b.A=d[l],b.i=e[l],b.next=h.j,h.j=b;f==Zc||(f==$c||f==G)||y("glp_ios_add_row: type = "+f+"; invalid cut type");h.type=f;h.Vf=g;h.aa=
...
exports.glp_mpl_postsolve=function(a,b,c){var d,e,f,g,j,h;(3!=a.B||a.Gf)&&y("glp_mpl_postsolve: invalid call sequence");c==ig||(c==$j||c==Oi)||y("glp_mpl_postsolve: sol = "+c+"; invalid parameter");e=Hj(a);f=Qj(a);e==ye(b)&&f==ze(b)||y("glp_mpl_postsolve: wrong problem object\n");if(!ak(a))return 0;for(d=1;d<=e;d++)c==ig?(g=jh(b,d),j=kh(b,d),h=lh(b,d)):c==$j?(g=0,j=glp_ipt_row_prim(b,d),h=glp_ipt_row_dual(b,d)):c==Oi&&(g=0,j=dj(b,d),h=0),1E-9>Math.abs(j)&&(j=0),1E-9>Math.abs(h)&&(h=0),gk(a,d,g,j,
...
function hj(a,b,c,d){var e,f;f=a.valid=0;switch(a.type){case fj:a.Ua=s;a.ab==s&&(f={},f.bb=f.f=0,f.valid=0,f.ea=mk(),f.Wd=50,f.Jb=0,f.Qe=f.Se=f.Re=s,f.ee=f.de=s,f.kg=s,f.lg=s,f.fc=1E-6,f.Tf=0,a.ab=f,f=1);break;case kj:case lj:a.ab=s,a.Ua==s&&(nk&&B("lpf_create_it: warning: debug mode enabled"),f={valid:0},f.Kc=f.We=0,f.ea=mk(),f.f=0,f.uf=s,f.I=50,f.h=0,f.Hd=f.Gd=s,f.Jd=f.Id=s,f.Oc=s,f.xe=f.we=s,f.ze=f.ye=s,f.Ed=1E3,f.jd=0,f.Rb=s,f.Sb=s,f.cb=f.Fc=s,a.Ua=f,f=1)}a.ab!=s?e=a.ab.ea:a.Ua!=s&&(e=a.Ua.ea);
f&&(e.Ra=a.xd);e.$b=a.$b;e.uc=a.uc;e.dc=a.dc;e.Gb=a.Gb;e.pc=a.pc;a.ab!=s&&(f&&(a.ab.Wd=a.Xc),a.ab.fc=a.fc);a.Ua!=s&&(f&&(a.Ua.I=a.sc),f&&(a.Ua.Ed=a.fd));if(a.ab!=s){a:{e=a.ab;1>b&&y("fhv_factorize: m = "+b+"; invalid parameter");b>ta&&y("fhv_factorize: m = "+b+"; matrix too big");e.f=b;e.valid=0;e.Qe==s&&(e.Qe=Array(1+e.Wd));e.Se==s&&(e.Se=Array(1+e.Wd));e.Re==s&&(e.Re=Array(1+e.Wd));e.bb<b&&(e.bb=b+100,e.ee=Array(1+e.bb),e.de=Array(1+e.bb),e.kg=Array(1+e.bb),e.lg=Array(1+e.bb));switch(ok(e.ea,b,
c,d)){case pk:b=qk;break a;case rk:b=sk;break a}e.valid=1;e.Jb=0;Ca(e.ee,1,e.ea.fb,1,b);Ca(e.de,1,e.ea.qb,1,b);b=e.Tf=0}switch(b){case qk:return a=ij;case sk:return a=jj}}else if(a.Ua!=s){a:{e=a.Ua;if(nk)var g,j,h,l,m,n;1>b&&y("lpf_factorize: m = "+b+"; invalid parameter");b>ta&&y("lpf_factorize: m = "+b+"; matrix too big");e.We=e.f=b;e.valid=0;e.Hd==s&&(e.Hd=Array(1+e.I));e.Gd==s&&(e.Gd=Array(1+e.I));e.Jd==s&&(e.Jd=Array(1+e.I));e.Id==s&&(e.Id=Array(1+e.I));e.Oc==s&&(f=e.I,tk&&B("scf_create_it: warning: debug mode enabled"),
1<=f&&32767>=f||y("scf_create_it: n_max = "+f+"; invalid parameter"),g={},g.I=f,g.h=0,g.Hb=Array(1+f*f),g.u=Array(1+f*(f+1)/2),g.r=Array(1+f),g.Yf=uk,g.wc=0,g.m=tk?Array(1+f*f):s,g.ag=Array(1+f),e.Oc=g);e.Rb==s&&(e.Rb=Array(1+e.Ed));e.Sb==s&&(e.Sb=Array(1+e.Ed));e.Kc<b&&(e.Kc=b+100,e.xe=Array(1+e.Kc+e.I),e.we=Array(1+e.Kc+e.I),e.ze=Array(1+e.Kc+e.I),e.ye=Array(1+e.Kc+e.I),e.cb=Array(1+e.Kc+e.I),e.Fc=Array(1+e.Kc+e.I));switch(ok(e.ea,b,c,d)){case pk:b=vk;break a;case rk:b=LPF_ECOND;break a}e.valid=
1;if(nk){e.uf=m=Array(1+b*b);l=Array(1+b);n=Array(1+b);for(f=1;f<=b*b;f++)m[f]=0;for(j=1;j<=b;j++){h=c(d,j,l,n);for(f=1;f<=h;f++)g=l[f],m[(g-1)*b+j]=n[f]}}e.h=0;c=e.Oc;c.h=c.wc=0;for(f=1;f<=b;f++)e.xe[f]=e.we[f]=f,e.ze[f]=e.ye[f]=f;e.jd=1;b=0}switch(b){case 0:switch(a.type){case kj:a.Ua.Oc.Yf=uk;break;case lj:a.Ua.Oc.Yf=wk}break;case vk:return a=ij;case LPF_ECOND:return a=jj}}a.valid=1;return a.$f=0}
function pj(a,b){if(a.ab!=s){var c=a.ab,d=c.ea.fb,e=c.ea.qb,f=c.ee,g=c.de;c.valid||y("fhv_ftran: the factorization is not valid");c.ea.fb=f;c.ea.qb=g;xk(c.ea,0,b);c.ea.fb=d;c.ea.qb=e;yk(c,0,b);zk(c.ea,0,b)}else if(a.Ua!=s){var c=a.Ua,d=c.We,e=c.f,j=c.h,h=c.we,f=c.ye,g=c.cb,l,m;if(nk)var n;c.valid||y("lpf_ftran: the factorization is not valid");if(nk){n=Array(1+e);for(l=1;l<=e;l++)n[l]=b[l]}for(l=1;l<=d+j;l++)g[l]=(m=h[l])<=e?b[m]:0;xk(c.ea,0,g);Ak(c,g,d,g);Bk(c.Oc,0,g,d);j=c.h;h=c.Hd;l=c.Gd;m=c.Rb;
var p=c.Sb,t,r,w,E;for(t=1;t<=j;t++)if(0!=g[t+d]){E=-1*g[t+d];r=h[t];for(w=r+l[t];r<w;r++)g[m[r]]+=E*p[r]}zk(c.ea,0,g);for(l=1;l<=e;l++)b[l]=g[f[l]];nk&&Ck(c,0,b,n)}}
function rj(a,b){if(a.ab!=s){var c=a.ab,d=c.ea.fb,e=c.ea.qb,f=c.ee,g=c.de;c.valid||y("fhv_btran: the factorization is not valid");zk(c.ea,1,b);yk(c,1,b);c.ea.fb=f;c.ea.qb=g;xk(c.ea,1,b);c.ea.fb=d;c.ea.qb=e}else if(a.Ua!=s){var c=a.Ua,d=c.We,e=c.f,j=c.h,f=c.xe,h=c.ze,g=c.cb,l,m;if(nk)var n;c.valid||y("lpf_btran: the factorization is not valid");if(nk){n=Array(1+e);for(l=1;l<=e;l++)n[l]=b[l]}for(l=1;l<=d+j;l++)g[l]=(m=h[l])<=e?b[m]:0;zk(c.ea,1,g);Dk(c,g,d,g);Bk(c.Oc,1,g,d);j=c.h;h=c.Jd;l=c.Id;m=c.Rb;
var p=c.Sb,t,r,w,E;for(t=1;t<=j;t++)if(0!=g[t+d]){E=-1*g[t+d];r=h[t];for(w=r+l[t];r<w;r++)g[m[r]]+=E*p[r]}xk(c.ea,1,g);for(l=1;l<=e;l++)b[l]=g[f[l]];nk&&Ck(c,1,b,n)}}
function Ek(a,b,c,d,e,f){if(a.ab!=s)switch(Fk(a.ab,b,c,d,e,f)){case qk:return a.valid=0,a=ij;case Gk:return a.valid=0,a=jk;case Hk:return a.valid=0,a=kk;case Ik:return a.valid=0,a=lk}else if(a.Ua!=s){a:{var g=a.Ua,j=g.We,h=g.f;if(nk)var l=g.uf;var m=g.h,n=g.Hd,p=g.Gd,t=g.Jd,r=g.Id,w=g.xe,E=g.we,q=g.ze,z=g.ye,C=g.jd,H=g.Rb,O=g.Sb,J=g.Fc,L=g.cb,u=g.Fc,F,x,P;g.valid||y("lpf_update_it: the factorization is not valid");1<=b&&b<=h||y("lpf_update_it: j = "+b+"; column number out of range");if(m==g.I)g.valid=
0,b=LPF_ELIMIT;else{for(F=1;F<=h;F++)J[F]=0;for(P=1;P<=c;P++)F=d[e+P],1<=F&&F<=h||y("lpf_update_it: ind["+P+"] = "+F+"; row number out of range"),0!=J[F]&&y("lpf_update_it: ind["+P+"] = "+F+"; duplicate row index not allowed"),0==f[P]&&y("lpf_update_it: val["+P+"] = "+f[P]+"; zero element not allowed"),J[F]=f[P];if(nk)for(F=1;F<=h;F++)l[(F-1)*h+b]=J[F];for(F=1;F<=j+m;F++)L[F]=(x=E[F])<=h?J[x]:0;for(F=1;F<=j+m;F++)u[F]=0;u[z[b]]=1;xk(g.ea,0,L);zk(g.ea,1,u);if(g.Ed<C+j+j){F=g.Ed;c=g.jd-1;d=g.Rb;for(e=
g.Sb;F<C+j+j;)F+=F;g.Ed=F;g.Rb=Array(1+F);g.Sb=Array(1+F);Ca(g.Rb,1,d,1,c);Ca(g.Sb,1,e,1,c);H=g.Rb;O=g.Sb}n[m+1]=C;for(F=1;F<=j;F++)0!=L[F]&&(H[C]=F,O[C]=L[F],C++);p[m+1]=C-g.jd;g.jd=C;t[m+1]=C;for(F=1;F<=j;F++)0!=u[F]&&(H[C]=F,O[C]=u[F],C++);r[m+1]=C-g.jd;g.jd=C;Ak(g,L,0,L);Dk(g,u,0,u);p=0;for(F=1;F<=j;F++)p-=u[F]*L[F];n=g.Oc;C=p;F=n.I;p=n.h;c=n.Hb;d=n.u;e=n.r;if(tk)var I=n.m;r=n.ag;t=0;if(p==F)t=Jk;else{n.h=++p;f=1;for(h=(f-1)*n.I+p;f<p;f++,h+=F)c[h]=0;h=1;for(f=(p-1)*n.I+h;h<p;h++,f++)c[f]=0;for(f=
c[(p-1)*n.I+p]=1;f<p;f++){H=0;h=1;for(l=(f-1)*n.I+1;h<p;h++,l++)H+=c[l]*L[h+j];d[Kk(n,f,p)]=H}for(h=1;h<p;h++)r[h]=u[e[h]+j];r[p]=C;e[p]=p;if(tk){f=1;for(h=(f-1)*n.I+p;f<p;f++,h+=F)I[h]=L[f+j];h=1;for(f=(p-1)*n.I+h;h<p;h++,f++)I[f]=u[h+j];I[(p-1)*n.I+p]=C}for(L=1;L<p&&0==r[L];L++);switch(n.Yf){case uk:u=n.h;I=n.Hb;for(C=n.u;L<u;L++){e=Kk(n,L,L);c=(L-1)*n.I+1;f=(u-1)*n.I+1;if(Math.abs(C[e])<Math.abs(r[L])){F=L;for(d=e;F<=u;F++,d++)l=C[d],C[d]=r[F],r[F]=l;F=1;d=c;for(h=f;F<=u;F++,d++,h++)l=I[d],I[d]=
...
L;e<=u;e++,h++)l=C[h],H=r[e],C[h]=d*l-f*H,r[e]=f*l+d*H;e=1;h=F;for(F=c;e<=u;e++,h++,F++)c=I[h],l=I[F],I[h]=d*c-f*l,I[F]=f*c+d*l}Math.abs(r[u])<Lk&&(r[u]=0);C[Kk(n,u,u)]=r[u]}F=n.I;r=n.h;L=n.u;C=0;u=1;for(I=Kk(n,u,u);u<=r;u++,I+=F,F--)0!=L[I]&&C++;n.wc=C;n.wc!=p&&(t=Mk);tk&&Ck(n,"scf_update_exp")}switch(t){case Mk:g.valid=0;b=vk;break a}w[j+m+1]=E[j+m+1]=j+m+1;q[j+m+1]=z[j+m+1]=j+m+1;F=z[b];x=z[j+m+1];q[F]=j+m+1;z[j+m+1]=F;q[x]=b;z[b]=x;g.h++;b=0}}switch(b){case vk:return a.valid=0,a=ij;case LPF_ELIMIT:return a.valid=
0,a=kk}}a.$f++;return 0}
...
function yk(a,b,c){var d=a.Jb,e=a.Qe,f=a.Se,g=a.Re,j=a.ea.rb,h=a.ea.sb,l,m,n;a.valid||y("fhv_h_solve: the factorization is not valid");if(b)for(b=d;1<=b;b--){if(a=e[b],n=c[a],0!=n){l=f[b];for(m=l+g[b]-1;l<=m;l++)c[j[l]]-=h[l]*n}}else for(b=1;b<=d;b++){a=e[b];n=c[a];l=f[b];for(m=l+g[b]-1;l<=m;l++)n-=h[l]*c[j[l]];c[a]=n}}
function Fk(a,b,c,d,e,f){var g=a.f,j=a.ea,h=j.Ec,l=j.Dc,m=j.kd,n=j.sf,p=j.Cc,t=j.Bc,r=j.Pc,w=j.fb,E=j.qb,q=j.jf,z=j.ge,C=j.rb,H=j.sb,O=j.se,J=j.Gb,L=a.Qe,u=a.Se,F=a.Re,x=a.ee,P=a.de,I=a.kg,X=a.lg,A=a.fc,M,N;a.valid||y("fhv_update_it: the factorization is not valid");1<=b&&b<=g||y("fhv_update_it: j = "+b+"; column number out of range");if(a.Jb==a.Wd)return a.valid=0,a=Hk;for(M=1;M<=g;M++)X[M]=0;for(N=1;N<=c;N++)M=d[e+N],1<=M&&M<=g||y("fhv_update_it: ind["+N+"] = "+M+"; row number out of range"),0!=
X[M]&&y("fhv_update_it: ind["+N+"] = "+M+"; duplicate row index not allowed"),0==f[N]&&y("fhv_update_it: val["+N+"] = "+f[N]+"; zero element not allowed"),X[M]=f[N];a.ea.fb=x;a.ea.qb=P;xk(a.ea,0,X);a.ea.fb=w;a.ea.qb=E;yk(a,0,X);c=0;for(M=1;M<=g;M++)e=X[M],0==e||Math.abs(e)<J||(c++,I[c]=M,X[c]=e);P=p[b];for(x=P+t[b]-1;P<=x;P++){M=C[P];f=h[M];for(N=f+l[M]-1;C[f]!=b;f++);C[f]=C[N];H[f]=H[N];l[M]--}j.Kb-=t[b];t[b]=0;e=q[b];d=0;for(N=1;N<=c;N++){M=I[N];if(l[M]+1>m[M]&&Pk(j,M,l[M]+10))return a.valid=0,
...
l[J]}h=L;l=Uk;a.fe==s&&(a.fe={},m=a.fe,m.n=3,m.scale=1,m.H=0,m.$g=1,m.nh=0.07,m.Ab=1E-7,m.ob=1E-7,m.qe=1E-9,m.round=0,m.Ze=-v,m.$e=+v,m.lc=-1,m.nb=-1,m.Zb=200,m.$a=0,m.Dg=2,m.Eg=3,m.Pb=1E-5,m.pe=1E-7,m.Mg=1,m.Ng=2,m.Og=0,m.Qg=1,m.Lg=0,m.Pg=0,m.Kg=0,m.Zg=0,m.nd=0,m.kh=0,m.Zd=0);m=a.fe;e=0;switch(l){case Uk:e=m.n;break;case Vk:e=m.scale;break;case Wk:e=m.H;break;case Xk:e=m.$g;break;case Yk:e=m.round;break;case Zk:e=m.lc;break;case $k:e=a.V;break;case al:e=m.Zb;break;case bl:e=m.Dg;break;case cl:e=
m.Eg;break;case dl:e=m.Mg;break;case el:e=m.Ng;break;case fl:e=m.Og;break;case gl:e=m.Qg;break;case hl:e=m.Lg;break;case il:e=m.Pg;break;case jl:e=m.Kg;break;case kl:e=m.Zg;break;case ll:e=m.nd;break;case ml:e=m.kh;break;case nl:l={};Pd(a,l);switch(l.type){case fj:e=1;break;case kj:e=2;break;case lj:e=3}break;default:y("lpx_get_int_parm: parm = "+l+"; invalid parameter")}3<=e&&B("Size of triangular part = "+h+"");l=Array(1+c);m=Array(1+c+d);for(e=1;e<=c;e++)l[f[e]]=e;for(f=1;f<=c+d;f++)m[g[f]]=f;
...
function wh(a,b){var c,d;if(0==a.Qc){c=a.be;d=a.ua;a.be=0==c?20:c+c;a.ua=Array(1+a.be);Ea(a.ua,0,1+a.be);d!=s&&Ca(a.ua,1,d,1,c);for(d=a.be;d>c;d--)a.ua[d].mb=s,a.ua[d].next=a.Qc,a.Qc=d}d=a.Qc;a.Qc=a.ua[d].next;a.ua[d].next=0;c=d;d={};a.ua[c].mb=d;d.r=c;d.ga=b;d.Ha=b==s?0:b.Ha+1;d.count=0;d.Ja=s;d.yc=s;d.bc=s;d.Xf=0;d.oc=b==s?a.z.dir==Gb?-v:+v:b.oc;d.bound=b==s?a.z.dir==Gb?-v:+v:b.bound;d.Rc=0;d.jg=0;d.qg=0;d.Wc=0;d.Md=0;d.data=0==a.o.De?s:{};d.fa=s;d.aa=a.Sa;d.next=s;a.head==s?a.head=d:a.Sa.next=
d;a.Sa=d;a.Kd++;a.Rf++;a.yg++;b!=s&&b.count++;return d}
function Li(a){var b=a.z,c=b.f,d=b.h,e=a.L,f,g,j;if(e.ga==s){a.xg=c;a.me=Array(1+c+d);a.ke=Array(1+c+d);a.ne=Array(1+c+d);a.le=Array(1+c+d);for(f=1;f<=c+d;f++)j=f<=c?b.k[f]:b.e[f-c],a.me[f]=j.type,a.ke[f]=j.c,a.ne[f]=j.d,a.le[f]=j.l}else{var h=a.xg,l=a.ug;for(f=1;f<=l+d;f++){var m,n,p,t,r,w;m=a.gf[f];p=a.ef[f];t=a.hf[f];g=a.ff[f];j=f<=l?b.k[f]:b.e[f-l];n=j.type;r=j.c;w=j.d;j=j.l;m==n&&p==r&&t==w||(m={},m.mc=f,m.type=n,m.c=r,m.d=w,m.next=e.Ja,e.Ja=m);g!=j&&(g={},g.mc=f,g.l=j,g.next=e.yc,e.yc=g)}if(l<
c){n=Array(1+d);r=Array(1+d);for(g=c;g>l;g--){j=b.k[g];w={};f=Ae(b,g);w.name=f==s?s:f;w.type=j.type;w.c=j.c;w.d=j.d;w.j=s;m=Ue(b,g,n,r);for(f=1;f<=m;f++)p={},p.A=n[f],p.i=r[f],p.next=w.j,w.j=p;w.ka=j.ka;w.l=j.l;w.next=e.bc;e.bc=w}}if(c!=h){c-=h;e=Array(1+c);for(g=1;g<=c;g++)e[g]=h+g;Cd(b,c,e)}c=b.f;for(g=1;g<=c;g++)pd(b,g,a.me[g],a.ke[g],a.ne[g]),tf(b,g,a.le[g]);for(h=1;h<=d;h++)qd(b,h,a.me[c+h],a.ke[c+h],a.ne[c+h]),uf(b,h,a.le[c+h])}a.L=s}
function Ni(a,b){var c;c=a.ua[b].mb;c.aa==s?a.head=c.next:c.aa.next=c.next;c.next==s?a.Sa=c.aa:c.next.aa=c.aa;c.aa=c.next=s;for(a.Kd--;;){for(var d;c.Ja!=s;)d=c.Ja,c.Ja=d.next;for(;c.yc!=s;)d=c.yc,c.yc=d.next;for(;c.bc!=s;){d=c.bc;for(d.name=s;d.j!=s;)d.j=d.j.next;c.bc=d.next}b=c.r;a.ua[b].mb=s;a.ua[b].next=a.Qc;a.Qc=b;c=c.ga;a.Rf--;if(c!=s&&(c.count--,0==c.count))continue;break}}
function ai(a,b){var c=a.z,d=c.h,e,f,g,j=a.rg,h;g=0;h=c.da;e=0;for(f=1;f<=d;f++){var l=c.e[f];if(0!=l.t)if(l.type==G)h+=l.t*l.q;else{if(l.Aa!=ph||l.t!=Math.floor(l.t))return b;Math.abs(l.t)<=pa?j[++g]=Math.abs(l.t)|0:e=1}}if(0==e){if(0==g)return b;d=0;for(e=1;e<=g;e++){if(1==e)d=j[1];else{f=j[e];for(l=k;0<f;)l=d%f,d=f,f=l}if(1==d)break}e=d}c.dir==Gb?b!=+v&&(c=(b-h)/e,c>=Math.floor(c)+0.0010&&(c=Math.ceil(c),b=e*c+h)):c.dir==ec&&b!=-v&&(c=(b-h)/e,c<=Math.ceil(c)-0.0010&&(c=Math.floor(c),b=e*c+h));
return b}function Ch(a,b){var c=a.z,d=1,e;if(c.va==Bg)switch(e=a.o.pe*(1+Math.abs(c.qa)),c.dir){case Gb:b>=c.qa-e&&(d=0);break;case ec:b<=c.qa+e&&(d=0)}else switch(c.dir){case Gb:b==+v&&(d=0);break;case ec:b==-v&&(d=0)}return d}function Ah(a){var b=s;switch(a.z.dir){case Gb:for(a=a.head;a!=s;a=a.next)if(b==s||b.bound>a.bound)b=a;break;case ec:for(a=a.head;a!=s;a=a.next)if(b==s||b.bound<a.bound)b=a}return b==s?0:b.r}
function Bh(a){var b=a.z,c;b.va==Bg?(b=b.qa,c=Ah(a),0==c?a=0:(a=a.ua[c].mb.bound,a=Math.abs(b-a)/(Math.abs(b)+ra))):a=v;return a}function yi(a){for(;a.head!=s;){var b=a.head;for(a.head=b.next;b.j!=s;)b.j=b.j.next}a.size=0;a.head=a.Sa=s;a.Ug=0;a.L=s}
...
-v;X=0;break}else A+=j[I]*x[I];P.Rd=A;P.Mf=X;X=A=0;for(I=1;I<=w;I++)if(0<j[I])if(x[I]==+v)if(0==X)X=I;else{A=+v;X=0;break}else A+=j[I]*x[I];else if(0>j[I])if(F[I]==-v)if(0==X)X=I;else{A=+v;X=0;break}else A+=j[I]*F[I];P.Qd=A;P.Lf=X;b:{w=m;j=t;X=k;F=0;x=l[t];P=w[j];A=I=s;X=0==r.Lf?r.Qd:+v;I=0==r.Mf?r.Rd:-v;A=X;if(x!=-v&&(X=0.0010*(1+Math.abs(x)),A<x-X)){w=F=1;break b}if(P!=+v&&(X=0.0010*(1+Math.abs(P)),I>P+X)){w=F=1;break b}x!=-v&&(X=1E-12*(1+Math.abs(x)),I>x-X&&(l[t]=-v));P!=+v&&(X=1E-12*(1+Math.abs(P)),
A<P+X&&(w[j]=+v));w=F}if(w){q=1;break}if(!(l[t]==-v&&m[t]==+v))for(w=1;w<=g;w++){I=P=s;j=z[w];F=c.e[j];x=F.Aa!=Fc;b:{var M=l[t],N=m[t],za=k,X=0,ua=A=k,va=s,ka=s,A=L[w],ua=u[w],fc=za=ka=va=k;M==-v||r.Qd==+v?va=-v:0==r.Lf?0<J[w]?va=M-(r.Qd-J[w]*u[w]):0>J[w]&&(va=M-(r.Qd-J[w]*L[w])):va=r.Lf==w?M-r.Qd:-v;N==+v||r.Rd==-v?ka=+v:0==r.Mf?0<J[w]?ka=N-(r.Rd-J[w]*L[w]):0>J[w]&&(ka=N-(r.Rd-J[w]*u[w])):ka=r.Mf==w?N-r.Rd:+v;1E-6>Math.abs(J[w])?(za=-v,fc=+v):0<J[w]?(za=va==-v?-v:va/J[w],fc=ka==+v?+v:ka/J[w]):0>
...
g[n]>=0.5*f[n];w=r=0;for(n=1;n<=a;n++)if(m=1E-9*(1+Math.abs(f[n])),!(g[n]<m||g[n]>f[n]-m))if(m=l(a,b,c,f,z,Math.abs(b[n]),j),!m){t=-d-e*h;for(m=1;m<=a;m++)t+=j[m]*g[m];w<t&&(w=t,r=Math.abs(b[n]))}0.0010>w&&(w=0);if(0==w)return w;p[1]=r/2;p[2]=r/4;p[3]=r/8;for(n=1;3>=n;n++)if(m=l(a,b,c,f,z,p[n],j),!m){t=-d-e*h;for(m=1;m<=a;m++)t+=j[m]*g[m];w<t&&(w=t,r=p[n])}p=0;for(n=1;n<=a;n++)m=1E-9*(1+Math.abs(f[n])),g[n]<m||g[n]>f[n]-m||(p++,E[p].A=n,E[p].pf=Math.abs(g[n]-0.5*f[n]));Ma(E,p,function(a,b){return a.pf<
b.pf?-1:a.pf>b.pf?1:0});for(q=1;q<=p;q++)if(n=E[q].A,z[n]=!z[n],m=l(a,b,c,f,z,r,j),z[n]=!z[n],!m){t=-d-e*h;for(m=1;m<=a;m++)t+=j[m]*g[m];w<t&&(w=t,z[n]=!z[n])}m=l(a,b,c,f,z,r,j);return w}var d,e,f=b.f,g=b.h,j,h,l;j=a.z;l=b.f;h=b.h;var m;for(m=1;m<=l;m++)b.x[m]=j.k[m].q;for(m=l+1;m<=l+h;m++)b.x[m]=j.e[m-l].q;Da(b.gb,1,"?",f+g);for(j=1;j<=f;j++)if(!b.yb[j]){l=b;h=j;m=a.z;var n=l.f,p=k;l.yb[h]=2;l.Ae=1;l.wf[1]=h;ul(l.Ta);tl(l.Ta,h,1);for(p=m.k[h].j;p!=s;p=p.w)tl(l.Ta,n+p.e.A,-p.i);for(l.vf=0;;){l=b;
m=h=k;for(h=1;h<=l.Ta.J;h++)m=l.Ta.X[h],0==l.Tb[m]&&(0==l.ub[m]&&l.c[m]==l.d[m])&&(l.vf-=l.Ta.i[h]*l.c[m],l.Ta.i[h]=0);vl(l.Ta,ra);if(Nh)for(h=1;h<=f+g;h++);l=b;p=n=p=m=h=k;for(h=1;h<=l.Ta.J;h++)m=l.Ta.X[h],l.Wa[m]||(p=l.Tb[m],n=0==p?l.c[m]==-v?v:l.x[m]-l.c[m]:l.x[m]-l.c[m]*l.x[p],p=l.ub[m],p=0==p?l.ub[m]==+v?v:l.d[m]-l.x[m]:l.d[m]*l.x[p]-l.x[m],l.gb[m]=n<=p?"L":"U");l=b;p=n=m=h=k;wl(l.ma,l.Ta);l.qc=l.vf;for(h=l.ma.J;1<=h;h--)n=l.ma.X[h],l.Wa[n]||("L"==l.gb[n]?(p=l.Tb[n],0==p?l.qc-=l.ma.i[h]*l.c[n]:
(m=l.ma.Ea[p],0==m&&(tl(l.ma,p,1),m=l.ma.Ea[p],l.ma.i[m]=0),l.ma.i[m]+=l.ma.i[h]*l.c[n])):"U"==l.gb[n]&&(p=l.ub[n],0==p?l.qc-=l.ma.i[h]*l.d[n]:(m=l.ma.Ea[p],0==m&&(tl(l.ma,p,1),m=l.ma.Ea[p],l.ma.i[m]=0),l.ma.i[m]+=l.ma.i[h]*l.d[n]),l.ma.i[h]=-l.ma.i[h]));for(h=1;h<=l.ma.J;h++)n=l.ma.X[h],l.Wa[n]&&(Math.abs(l.c[n])<=Math.abs(l.d[n])?(l.gb[n]="L",l.qc-=l.ma.i[h]*l.c[n]):(l.gb[n]="U",l.qc-=l.ma.i[h]*l.d[n],l.ma.i[h]=-l.ma.i[h]));l=b;h=l.f;m=l.h;var t=n=k,r=k,w=p=k,E=k,q=r=k,w=0;wl(l.D,l.ma);l.Fb=l.qc;
vl(l.D,ra);for(n=1;n<=l.D.J;n++)t=l.D.X[n],!l.Wa[t]&&0<l.D.i[n]&&(l.D.i[n]=0);vl(l.D,0);p=0;for(n=1;n<=l.D.J;n++)t=l.D.X[n],l.Wa[t]&&(p++,r=l.D.X[p],l.D.Ea[t]=p,l.D.Ea[r]=n,l.D.X[p]=t,l.D.X[n]=r,t=l.D.i[p],l.D.i[p]=l.D.i[n],l.D.i[n]=t);if(0!=p){E=Array(1+p);r=Array(1+p);q=Array(1+p);for(n=1;n<=p;n++)t=l.D.X[n],E[n]=l.d[t]-l.c[t],"L"==l.gb[t]?r[n]=l.x[t]-l.c[t]:"U"==l.gb[t]&&(r[n]=l.d[t]-l.x[t]),0>r[n]&&(r[n]=0);w=0;for(n=p+1;n<=l.D.J;n++)t=l.D.X[n],"L"==l.gb[t]?(r=l.Tb[t],r=0==r?l.x[t]-l.c[t]:l.x[t]-
l.c[t]*l.x[r]):"U"==l.gb[t]&&(r=l.ub[t],r=0==r?l.d[t]-l.x[t]:l.d[t]*l.x[r]-l.x[t]),0>r&&(r=0),w-=l.D.i[n]*r;w=c(p,l.D.i,l.Fb,E,r,w,q);if(0!=w){for(n=1;n<=p;n++)l.D.i[n]=q[n];for(n=p+1;n<=l.D.J;n++)t=l.D.X[n],t<=h+m&&(l.D.i[n]*=0);l.Fb=s}}l=w;if(0<l){h=b;t=p=n=m=k;for(m=1;m<=h.D.J;m++)p=h.D.X[m],h.Wa[p]&&("L"==h.gb[p]?h.Fb+=h.D.i[m]*h.c[p]:"U"==h.gb[p]&&(h.Fb-=h.D.i[m]*h.d[p],h.D.i[m]=-h.D.i[m]));for(m=1;m<=h.D.J;m++)p=h.D.X[m],h.Wa[p]||("L"==h.gb[p]?(t=h.Tb[p],0==t?h.Fb+=h.D.i[m]*h.c[p]:(n=h.D.Ea[t],
0==n&&(tl(h.D,t,1),n=h.D.Ea[t],h.D.i[n]=0),h.D.i[n]-=h.D.i[m]*h.c[p])):"U"==h.gb[p]&&(t=h.ub[p],0==t?h.Fb-=h.D.i[m]*h.d[p]:(n=h.D.Ea[t],0==n&&(tl(h.D,t,1),n=h.D.Ea[t],h.D.i[n]=0),h.D.i[n]+=h.D.i[m]*h.d[p]),h.D.i[m]=-h.D.i[m]));h=b;m=a.z;n=h.f;r=q=t=p=t=k;for(p=h.D.J;1<=p;p--)if(t=h.D.X[p],!(t>n)){for(t=m.k[t].j;t!=s;t=t.w)q=n+t.e.A,r=h.D.Ea[q],0==r&&(tl(h.D,q,1),r=h.D.Ea[q],h.D.i[r]=0),h.D.i[r]+=h.D.i[p]*t.i;h.D.i[p]=0}vl(h.D,0);h=a;m=b;n=m.f;w=m.h;q=t=p=k;r=Array(1+w);w=Array(1+w);q=0;for(p=m.D.J;1<=
p;p--)t=m.D.X[p],q++,r[q]=t-n,w[q]=m.D.i[p];vi(h,Eh,q,r,w,$c,m.Fb)}for(m=1;m<=b.ma.J;m++)h=b.ma.X[m],b.gb[h]="?";if(l=0==l)if(l=b.Ae<Oh){l=b;var n=a.z,p=l.f,t=l.h,z=r=q=w=r=q=k;m=h=0;E=z=E=k;w=0;for(q=1;q<=l.Ta.J;q++)r=l.Ta.X[q],!(r<=p)&&(!l.Wa[r]&&!(0.0010>Math.abs(l.Ta.i[q])))&&(z=l.Tb[r],E=0==z?l.c[r]==-v?v:l.x[r]-l.c[r]:l.x[r]-l.c[r]*l.x[z],z=l.ub[r],z=0==z?l.ub[r]==+v?v:l.d[r]-l.x[r]:l.d[r]*l.x[z]-l.x[r],E=E<=z?E:z,!(0.0010>E)&&w<E&&(w=E,h=r));if(0==h)m=1;else{for(w=1;w<=p;w++)if(!l.yb[w]){for(q=
n.k[w].j;q!=s&&q.e.A!=h-p;q=q.w);if(q!=s&&0.0010<=Math.abs(q.i))break}if(w>p)m=2;else{l.Ae++;l.wf[l.Ae]=w;l.yb[w]=2;r=Ph(p+t);tl(r,w,1);for(q=n.k[w].j;q!=s;q=q.w)tl(r,p+q.e.A,-q.i);q=l.Ta.Ea[h];n=l.Ta;p=-l.Ta.i[q]/r.i[r.Ea[h]];t=r;E=w=q=k;for(r=1;r<=t.J;r++)q=t.X[r],w=k,w=n.Ea[q],w=0==w?0:n.i[w],E=t.i[r],tl(n,q,w+p*E);tl(l.Ta,h,0)}}l=m;l=0==l}if(!l)break}for(h=1;h<=b.Ae;h++)l=b.wf[h],b.yb[l]=0}}
function xl(a,b,c){var d;0<b?b=a.qf[b]:(b=a.qf[-b],b+=a.wb);0<c?c=a.qf[c]:(c=a.qf[-c],c+=a.wb);b<c&&(d=b,b=c,c=d);d=(b-1)*(b-2)/2+(c-1);a.Ub[d/sa]|=1<<sa-1-d%sa;a.tg++}
...
z,F);for(w=1;w<=q;w++)if(f(a,z[w]))for(E=w+1;E<=q;E++)if(f(a,z[E])&&(h(F,O,J,L,u,w,0,E)||h(F,O,J,L,u,w,1,E)))r=z[w],0==C[r]&&(p++,C[r]=p,H[p]=r),r=z[E],0==C[r]&&(p++,C[r]=p,H[p]=r)}if(0==p||4E3<p)B("The conflict graph is either empty or too big");else{l={};l.h=n;l.wb=p;l.tg=0;l.qf=C;l.ce=H;q=p+p;q=(q*(q-1)/2+(sa-1))/sa;l.Ub=Array(q);Da(l.Ub,0,0,q);for(r=1;r<=p;r++)xl(l,+H[r],-H[r]);for(t=1;t<=m;t++)if(O=b(a,t),J=c(a,t),!(O==-v&&J==+v)&&(q=Ue(a,t,z,F),!(500<q))){L=g(a,q,z,F);u=j(a,q,z,F);for(w=1;w<=
q;w++)if(f(a,z[w]))for(E=w+1;E<=q;E++)if(f(a,z[E])){switch(h(F,O,J,L,u,w,0,E)){case 1:xl(l,-z[w],+z[E]);break;case 2:xl(l,-z[w],-z[E])}switch(h(F,O,J,L,u,w,1,E)){case 1:xl(l,+z[w],+z[E]);break;case 2:xl(l,+z[w],-z[E])}}}B("The conflict graph has 2*"+l.wb+" vertices and "+l.tg+" edges")}return l}
function wi(a,b){function c(a,b,e,f,g,h){var j,l,m,n,p,q,r,t;t=Array(a.h);if(0>=b){if(0==b&&(a.set[f++]=e[0],g+=h),g>a.cd){a.cd=g;a.Uf=f;for(j=0;j<f;j++)a.bh[j+1]=a.set[j]}}else for(j=b;0<=j&&!(0==f&&j<b);j--){m=e[j];if(0<f&&a.mg[m]<=a.cd-g)break;a.set[f]=m;n=g+a.Hc[m+1];h-=a.Hc[m+1];if(h<=a.cd-n)break;for(p=r=q=0;r<e+j;)l=e[r],r++,d(a,l,m)&&(t[q]=l,q++,p+=a.Hc[l+1]);p<=a.cd-n||c(a,q-1,t,f+1,n,p)}}function d(a,b,c){return b==c?0:b>c?a.Ub[(b*(b-1)/2+c)/sa]&1<<sa-1-(b*(b-1)/2+c)%sa:a.Ub[(c*(c-1)/2+
b)/sa]&1<<sa-1-(c*(c-1)/2+b)%sa}var e=ze(a.z),f,g;g=Array(1+e);var e=Array(1+e),j=a.z;f=ze(j);var h,l,m,n=0,p,t,r;p=Array(1+2*b.wb);t=Array(1+2*b.wb);r=Array(1+f);for(l=1;l<=b.wb;l++)h=b.ce[l],h=nh(j,h),h=100*h+0.5|0,0>h&&(h=0),100<h&&(h=100),p[l]=h,p[b.wb+l]=100-h;h=b.Ub;l={};var w,E,q,z,C,H;l.h=2*b.wb;l.Hc=p;l.Ub=h;l.cd=0;l.Uf=0;l.bh=t;l.mg=Array(l.h);l.set=Array(l.h);z=Array(l.h);C=Array(l.h);h=Array(l.h);H=Ga();for(p=0;p<l.h;p++)for(w=C[p]=0;w<l.h;w++)d(l,p,w)&&(C[p]+=l.Hc[w+1]);for(p=0;p<l.h;p++)z[p]=
0;for(p=l.h-1;0<=p;p--){q=E=-1;for(w=0;w<l.h;w++)if(!z[w]&&(l.Hc[w+1]>E||l.Hc[w+1]==E&&C[w]>q))E=l.Hc[w+1],q=C[w],m=w;h[p]=m;z[m]=1;for(w=0;w<l.h;w++)!z[w]&&(w!=m&&d(l,m,w))&&(C[w]-=l.Hc[m+1])}for(p=m=0;p<l.h;p++)m+=l.Hc[h[p]+1],c(l,p,h,0,0,m),l.mg[h[p]]=l.cd,4.999<=La(H)&&(B("level = "+p+1+" ("+l.h+"); best = "+l.cd+""),H=Ga());for(p=1;p<=l.Uf;p++)t[p]++;m=l.Uf;p=0;for(l=1;l<=m;l++)h=t[l],h<=b.wb?(h=b.ce[h],h=nh(j,h),p+=h):(h=b.ce[h-b.wb],h=nh(j,h),p+=1-h);if(1.01<=p){for(h=1;h<=f;h++)r[h]=0;for(l=
j=1;l<=m;l++)h=t[l],h<=b.wb?(h=b.ce[h],r[h]+=1):(h=b.ce[h-b.wb],r[h]-=1,j-=1);for(h=1;h<=f;h++)0!=r[h]&&(n++,g[n]=h,e[n]=r[h]);g[0]=0;e[0]=j}f=n;0<f&&vi(a,Gh,f,g,e,$c,e[0])}function Fi(a,b){var c,d,e,f,g,j;d=0;g=v;for(c=1;c<=a.h;c++)a.Lc[c]&&(f=nh(a.z,c),j=Math.floor(f)+0.5,g>Math.abs(f-j)&&(d=c,g=Math.abs(f-j),e=f<j?Bi:Ci));b(e);return d}
function Ki(a,b){function c(a,b,c){var d,e={},f;hh(a);d=Wb();ge(d,a,0);qd(d,b,G,c,c);Hg(e);e.n=Ig;e.Ya=cg;e.lc=30;e.$a=1E3;e.Ya=cg;b=Pg(d,e);0==b||b==yl?Qg(d)==Gg?f=v:eh(d)==Bg?(a.dir==Gb?f=d.Y-a.Y:a.dir==ec&&(f=a.Y-d.Y),f<1E-6*(1+0.0010*Math.abs(a.Y))&&(f=0)):f=0:f=0;return f}function d(a,b,d){var e=a.Ad,f;if(d==Bi){if(0==e.td[b]){d=a.z.e[b].q;a=c(a.z,b,Math.floor(d));if(a==v)return f=v;e.td[b]=1;e.Pd[b]=a/(d-Math.floor(d))}f=e.Pd[b]/e.td[b]}else if(d==Ci){if(0==e.Dd[b]){d=a.z.e[b].q;a=c(a.z,b,Math.ceil(d));
if(a==v)return f=v;e.Dd[b]=1;e.re[b]=a/(Math.ceil(d)-d)}f=e.re[b]/e.Dd[b]}return f}var e=Ga(),f,g,j,h,l,m,n;if(a.Ad==s){f=a.h;n={};n.td=Array(1+f);n.Pd=Array(1+f);n.Dd=Array(1+f);n.re=Array(1+f);for(g=1;g<=f;g++)n.td[g]=n.Dd[g]=0,n.Pd[g]=n.re[g]=0;a.Ad=n}g=0;n=-1;for(f=1;f<=a.h;f++)if(xj(a,f)){h=a.z.e[f].q;l=d(a,f,Bi);if(l==v)return g=f,j=Bi,b(j),g;m=l*(h-Math.floor(h));l=d(a,f,Ci);if(l==v)return g=f,j=Ci,b(j),g;h=l*(Math.ceil(h)-h);l=m>h?m:h;n<l&&(n=l,g=f,j=m<=h?Bi:Ci);if(a.o.n>=Dd&&10<=La(e)){e=
a;m=e.Ad;h=k;var p=l=0;for(h=1;h<=e.h;h++)xj(e,h)&&(l++,0<m.td[h]&&0<m.Dd[h]&&p++);B("Pseudocosts initialized for "+p+" of "+l+" variables");e=Ga()}}if(0==n)return g=Fi(a,b);b(j);return g}
function di(a){var b=a.z,c=b.h,d=s,e=s,f=s,g,j={},h,l,m,n,p,t;for(l=0;;){var r=s;switch(l){case 0:hh(b);if(!(0==a.L.Ha&&1==a.L.Xf)){r=5;break}p=0;for(h=1;h<=c;h++)if(g=b.e[h],g.Aa!=Fc&&g.type!=G)if(g.type==R&&0==g.c&&1==g.d)p++;else{a.o.n>=fg&&B("FPUMP heuristic cannot be applied due to general integer variables");r=5;break}if(r!=s)break;if(0==p){r=5;break}a.o.n>=fg&&B("Applying FPUMP heuristic...");e=Array(1+p);Ea(e,1,p);l=0;for(h=1;h<=c;h++)g=b.e[h],g.Aa==ph&&g.type==R&&(e[++l].A=h);d=Wb();case 1:ge(d,
...
0,e[l].x=g);if(h){for(l=1;l<=p;l++)g=d.e[e[l].A],e[l].Od=Math.abs(g.q-e[l].x);Ma(e,p,function(a,b){return a.Od>b.Od?-1:a.Od<b.Od?1:0});for(l=1;l<=p&&!(5<=l&&0.35>e[l].Od||10<=l);l++)e[l].x=1-e[l].x}case 4:if(a.o.nb<pa&&a.o.nb-1<=1E3*La(a.ec)){r=5;break}d.dir=Gb;d.da=0;for(h=1;h<=c;h++)d.e[h].t=0;for(l=1;l<=p;l++)h=e[l].A,0==e[l].x?d.e[h].t=1:(d.e[h].t=-1,d.da+=1);Hg(j);a.o.n<=Jf?j.n=a.o.n:a.o.n<=fg&&(j.n=Cg,j.$a=1E4);l=Pg(d,j);if(0!=l){a.o.n>=Jf&&B("Warning: glp_simplex returned "+l+"");r=5;break}l=
hh(d);if(l!=fh){a.o.n>=Jf&&B("Warning: glp_get_status returned "+l+"");r=5;break}a.o.n>=Jg&&B("delta = "+d.Y+"");h=0.3*a.o.Pb;for(l=1;l<=p&&!(g=d.e[e[l].A],h<g.q&&g.q<1-h);l++);if(l>p){g=Array(1+c);for(h=1;h<=c;h++)g[h]=d.e[h].q,b.e[h].Aa==ph&&(g[h]=Math.floor(g[h]+0.5));d.da=b.da;d.dir=b.dir;for(l=1;l<=p;l++)d.e[e[l].A].c=g[e[l].A],d.e[e[l].A].d=g[e[l].A],d.e[e[l].A].type=G;for(h=1;h<=c;h++)d.e[h].t=b.e[h].t;l=Pg(d,j);if(0!=l){a.o.n>=Jf&&B("Warning: glp_simplex returned "+l+"");r=5;break}l=hh(d);
...
function xi(a){var b,c,d,e,f,g,j,h,l,m;b=a.wd;e=Array(1+b.size);h=Array(1+a.h);l=Array(1+a.h);m=Array(1+a.h);for(f=1;f<=a.h;f++)m[f]=0;f=0;for(c=b.head;c!=s;c=c.next)f++,e[f].Ie=c,e[f].eb=0;for(f=1;f<=b.size;f++){var n=s,p=s;c=e[f].Ie;g=j=0;for(d=c.j;d!=s;d=d.next)j++,h[j]=d.A,l[j]=d.i,g+=d.i*d.i;g<ra*ra&&(g=ra);j=uj(a.z,j,h,l);a:{d=a.z;var t=h,r=l,w=c.type,E=c.Vf,q=k,z=k,C=k,H=k;c=0;var O=k,q=H=O=k;d.la==Vb&&y("glp_analyze_row: primal basic solution components are undefined");d.pa!=Bg&&y("glp_analyze_row: basic solution is not dual feasible");
...
g=0==a.L.Ha?90:10;g>b.size&&(g=b.size);for(f=1;f<=g;f++)if(!(0.01>e[f].vb&&0.01>e[f].Uc)){for(b=1;b<f;b++){if(n=e[b].eb){n=e[f].Ie;p=e[b].Ie;d=m;w=k;r=t=j=0;w=k;for(w=n.j;w!=s;w=w.next)d[w.A]=w.i,t+=w.i*w.i;for(w=p.j;w!=s;w=w.next)j+=d[w.A]*w.i,r+=w.i*w.i;for(w=n.j;w!=s;w=w.next)d[w.A]=0;w=Math.sqrt(t)*Math.sqrt(r);w<ra*ra&&(w=ra);n=0.9<j/w}if(n)break}if(!(b<f)){c=e[f].Ie;e[f].eb=1;b=zc(a.z,1);c.name!=s&&Mc(a.z,b,c.name);a.z.k[b].nc=c.nc;j=0;for(d=c.j;d!=s;d=d.next)j++,h[j]=d.A,l[j]=d.i;sd(a.z,b,
j,h,l);pd(a.z,b,c.type,c.Vf,c.Vf)}}}
...
function Dk(a,b,c,d){var e=a.h,f=a.Hd,g=a.Gd,j=a.Rb;a=a.Sb;var h,l,m,n;for(h=1;h<=e;h++){n=0;l=f[h];for(m=l+g[h];l<m;l++)n+=a[l]*d[j[l]];b[h+c]+=-1*n}}function Ak(a,b,c,d){var e=a.h,f=a.Jd,g=a.Id,j=a.Rb;a=a.Sb;var h,l,m,n;for(h=1;h<=e;h++){n=0;l=f[h];for(m=l+g[h];l<m;l++)n+=a[l]*d[j[l]];b[h+c]+=-1*n}}
if(nk)var Ck=function(a,b,c,d){var e=a.f;a=a.uf;var f,g,j=0,h,l,m;for(f=1;f<=e;f++){h=0;for(g=m=1;g<=e;g++)l=b?a[e*(g-1)+f]*c[g]:a[e*(f-1)+g]*c[g],m<Math.abs(l)&&(m=Math.abs(l)),h+=l;g=Math.abs(h-d[f])/m;j<g&&(j=g)}1E-8<j&&B((!b?"lpf_ftran":"lpf_btran")+": dmax = "+j+"; relative error too large")};function pi(a,b){var c=De(a,b);c==-v&&(c=0);return c}function ni(a,b){var c=Qe(a,b);c==+v&&(c=0);return c}function Tk(a,b,c){c(Ce(a,b)-yc+ki,pi(a,b),ni(a,b))}
...
function mk(){var a={};a.I=a.h=0;a.valid=0;a.Jf=a.Pe=s;a.Td=a.Sd=s;a.Ec=a.Dc=a.kd=s;a.sf=s;a.Cc=a.Bc=a.Pc=s;a.fb=a.qb=s;a.jf=a.ge=s;a.Ca=0;a.Ba=a.Ia=0;a.rb=s;a.sb=s;a.gd=a.Nb=0;a.Cd=a.hd=s;a.rf=s;a.mf=a.Wf=a.nf=s;a.Fe=a.He=a.Ge=s;a.eb=s;a.se=s;a.Ra=0;a.$b=0.1;a.uc=4;a.dc=1;a.Gb=1E-15;a.pc=1E10;a.Sg=a.Sf=a.Kb=0;a.sg=a.md=0;a.wc=0;return a}
function Rk(a){var b=a.h,c=a.Ec,d=a.Dc,e=a.kd,f=a.Cc,g=a.Bc,j=a.Pc,h=a.rb,l=a.sb,m=a.hd,n=1,p,t;for(t=a.gd;0!=t;t=m[t])if(t<=b){p=t;if(c[p]!=n)break;e[p]=d[p];n+=e[p]}else{p=t-b;if(f[p]!=n)break;j[p]=g[p];n+=j[p]}for(;0!=t;t=m[t])t<=b?(p=t,Ca(h,n,h,c[p],d[p]),Ca(l,n,l,c[p],d[p]),c[p]=n,e[p]=d[p],n+=e[p]):(p=t-b,Ca(h,n,h,f[p],g[p]),Ca(l,n,l,f[p],g[p]),f[p]=n,j[p]=g[p],n+=j[p]);a.Ba=n}
function Pk(a,b,c){var d=a.h,e=a.Ec,f=a.Dc,g=a.kd,j=a.Pc,h=a.rb,l=a.sb,m=a.Cd,n=a.hd,p=0,t;if(a.Ia-a.Ba<c&&(Rk(a),a.Ia-a.Ba<c))return 1;t=g[b];Ca(h,a.Ba,h,e[b],f[b]);Ca(l,a.Ba,l,e[b],f[b]);e[b]=a.Ba;g[b]=c;a.Ba+=c;0==m[b]?a.gd=n[b]:(c=m[b],c<=d?g[c]+=t:j[c-d]+=t,n[m[b]]=n[b]);0==n[b]?a.Nb=m[b]:m[n[b]]=m[b];m[b]=a.Nb;n[b]=0;0==m[b]?a.gd=b:n[m[b]]=b;a.Nb=b;return p}
function Qk(a,b,c){var d=a.h,e=a.kd,f=a.Cc,g=a.Bc,j=a.Pc,h=a.rb,l=a.sb,m=a.Cd,n=a.hd,p=0,t;if(a.Ia-a.Ba<c&&(Rk(a),a.Ia-a.Ba<c))return 1;t=j[b];Ca(h,a.Ba,h,f[b],g[b]);Ca(l,a.Ba,l,f[b],g[b]);f[b]=a.Ba;j[b]=c;a.Ba+=c;b=d+b;0==m[b]?a.gd=n[b]:(c=m[b],c<=d?e[c]+=t:j[c-d]+=t,n[m[b]]=n[b]);0==n[b]?a.Nb=m[b]:m[n[b]]=m[b];m[b]=a.Nb;n[b]=0;0==m[b]?a.gd=b:n[m[b]]=b;a.Nb=b;return p}
function Gl(a,b){function c(){b(C,H);return 0==C}var d=a.h,e=a.Ec,f=a.Dc,g=a.Cc,j=a.Bc,h=a.rb,l=a.sb,m=a.rf,n=a.mf,p=a.nf,t=a.Fe,r=a.He,w=a.Ge,E=a.$b,q=a.uc,z=a.dc,C,H,O,J,L,u,F,x,P,I,X,A,M,N,za,ua,va,ka;C=H=0;ua=v;X=0;x=t[1];if(0!=x)return C=h[g[x]],H=x,c();J=n[1];if(0!=J)return C=J,H=h[e[J]],c();for(O=2;O<=d;O++){for(x=t[O];0!=x;x=A){J=g[x];P=J+j[x]-1;A=w[x];M=N=0;za=pa;for(I=J;I<=P;I++)if(J=h[I],L=e[J],u=L+f[J]-1,!(f[J]>=za)){va=m[J];if(0>va){for(F=L;F<=u;F++)ka=l[F],0>ka&&(ka=-ka),va<ka&&(va=
...
Fa;Jc++)ga[ie[Jc]]=0}for(U=1;U<=u;U++){Fa=X[U];if(ad-Hb<Fa){e=gb=1;break a}P[U]=Hb;Hb+=Fa}for(ca=1;ca<=u;ca++){Yb=A[ca];Pb=Yb+M[ca]-1;for(wa=Yb;wa<=Pb;wa++)U=fc[wa],bd=Ee[wa],Bb=P[U]+I[U],fc[Bb]=ca,Ee[Bb]=bd,I[U]++}for(wa=1;wa<=u;wa++)za[wa]=ua[wa]=va[wa]=ka[wa]=wa;q.Ba=Hb;q.Ia=ad;q.gd=u+1;q.Nb=u;for(U=1;U<=u;U++)Ve[U]=U-1,We[U]=U+1;Ve[1]=u+u;We[u]=0;for(ca=1;ca<=u;ca++)Ve[u+ca]=u+ca-1,We[u+ca]=u+ca+1;Ve[u+1]=0;for(wa=We[u+u]=1;wa<=u;wa++)ga[wa]=0,Ob[wa]=0;q.Sg=Ac;q.Sf=0;q.Kb=Ac;q.sg=Fe;q.md=Fe;q.wc=
-1;for(U=1;U<=u;U++)xb[U]=-1;for(Fa=0;Fa<=u;Fa++)Ja[Fa]=0;for(U=1;U<=u;U++)Fa=I[U],ud[U]=0,Sd[U]=Ja[Fa],0!=Sd[U]&&(ud[Sd[U]]=U),Ja[Fa]=U;for(Fa=0;Fa<=u;Fa++)Ic[Fa]=0;for(ca=1;ca<=u;ca++)Fa=M[ca],ha[ca]=0,ba[ca]=Ic[Fa],0!=ba[ca]&&(ha[ba[ca]]=ca),Ic[Fa]=ca;e=gb}if(e)return a.Ra=a.Ca+a.Ca,aa;for(p=1;p<=b;p++){if(Gl(a,function(a,b){t=a;r=b}))return a.wc=p-1,E=pk,ia;m=g[t];n=j[r];w=f[p];f[m]=w;g[w]=m;f[p]=t;g[t]=p;w=h[p];h[n]=w;j[w]=n;h[p]=r;j[r]=p;var bb;a:{var fa=a,qa=t,Q=r,Td=fa.h,Rg=fa.Td,Wa=fa.Sd,
Kc=fa.Ec,Zb=fa.Dc,jg=fa.kd,je=fa.sf,Xa=fa.Cc,Ha=fa.Bc,ke=fa.Pc,xa=fa.rb,cb=fa.sb,Ib=fa.Cd,sb=fa.hd,rc=fa.rf,Bc=fa.mf,sc=fa.Wf,Cb=fa.nf,Xe=fa.Fe,hb=fa.He,Aa=fa.Ge,Qb=fa.eb,Ud=fa.se,Cc=fa.Gb,nb=fa.Pe,Db=0,Lc=k,tc=k,la=k,Ge=k,Nc=k,ib=k,da=k,Oc=k,He=k,jb=k,db=k,Ta=k,Jb=k,Ya=k,gc=k,hc=k,vd=k,Vd=k,ic=k,Wd=k,Na=k;0==sc[qa]?Bc[Zb[qa]]=Cb[qa]:Cb[sc[qa]]=Cb[qa];0!=Cb[qa]&&(sc[Cb[qa]]=sc[qa]);0==hb[Q]?Xe[Ha[Q]]=Aa[Q]:Aa[hb[Q]]=Aa[Q];0!=Aa[Q]&&(hb[Aa[Q]]=hb[Q]);Ta=Kc[qa];Jb=Ta+Zb[qa]-1;for(Ya=Ta;xa[Ya]!=Q;Ya++);
...
Wd;xa[ib]=xa[Nc];cb[ib]=cb[Nc];Zb[la]--;Nc--;xa[gc]=xa[hc];Ha[Q]--;hc--;tc=Zb[qa];for(ib=Ge;ib<=Nc;ib++)if(da=xa[ib],Qb[da])if(Na=cb[ib]-=Vd*Ud[da],0>Na&&(Na=-Na),Qb[da]=0,tc--,0==Na||Na<Cc){xa[ib]=xa[Nc];cb[ib]=cb[Nc];Zb[la]--;ib--;Nc--;Oc=Xa[da];He=Oc+Ha[da]-1;for(jb=Oc;xa[jb]!=la;jb++);xa[jb]=xa[He];Ha[da]--}else fa.md<Na&&(fa.md=Na);if(Zb[la]+tc>jg[la]){if(Pk(fa,la,Zb[la]+tc)){bb=Db=1;break a}Ta=Kc[qa];Jb=Ta+Zb[qa]-1;gc=Xa[Q];hc=gc+Ha[Q]-1}Lc=0;for(Ya=Ta;Ya<=Jb;Ya++)da=xa[Ya],Qb[da]?(Na=ic=-Vd*
Ud[da],0>Na&&(Na=-Na),0==Na||Na<Cc||(ib=Kc[la]+Zb[la],xa[ib]=da,cb[ib]=ic,Zb[la]++,nb[++Lc]=da,fa.md<Na&&(fa.md=Na))):Qb[da]=1;for(db=1;db<=Lc;db++){da=nb[db];if(Ha[da]+1>ke[da]){if(Qk(fa,da,Ha[da]+10)){bb=Db=1;break a}Ta=Kc[qa];Jb=Ta+Zb[qa]-1;gc=Xa[Q];hc=gc+Ha[Q]-1}jb=Xa[da]+Ha[da];xa[jb]=la;Ha[da]++}sc[la]=0;Cb[la]=Bc[Zb[la]];0!=Cb[la]&&(sc[Cb[la]]=la);Bc[Zb[la]]=la;rc[la]=-1;if(1>fa.Ia-fa.Ba){Rk(fa);if(1>fa.Ia-fa.Ba){bb=Db=1;break a}Ta=Kc[qa];Jb=Ta+Zb[qa]-1;gc=Xa[Q];hc=gc+Ha[Q]-1}fa.Ia--;xa[fa.Ia]=
la;cb[fa.Ia]=Vd;Wa[qa]++}ke[Q]=0;db=Td+Q;0==Ib[db]?fa.gd=sb[db]:sb[Ib[db]]=sb[db];0==sb[db]?fa.Nb=Ib[db]:Ib[sb[db]]=Ib[db];Rg[qa]=fa.Ia;for(Ya=Ta;Ya<=Jb;Ya++)da=xa[Ya],Qb[da]=0,Ud[da]=0,1!=Ha[da]&&hb[da]==da&&Aa[da]==da||(hb[da]=0,Aa[da]=Xe[Ha[da]],0!=Aa[da]&&(hb[Aa[da]]=da),Xe[Ha[da]]=da);bb=Db}if(bb)return a.Ra=a.Ca+a.Ca,aa;if(a.md>l*a.sg)return a.wc=p-1,E=rk,ia}Rk(a);var Rb;var Za=a,$b=Za.h,Ed=Za.Ec,uc=Za.Dc,Fd=Za.Cc,le=Za.Bc,jc=Za.Pc,Dc=Za.rb,Ra=Za.sb,Ie=Za.Cd,me=Za.hd,dd=0,kb,lb,Pc,ed,yb,kc,
lc,Gd;Gd=0;for(kb=1;kb<=$b;kb++){lb=Ed[kb];Pc=lb+uc[kb]-1;for(ed=lb;ed<=Pc;ed++)jc[Dc[ed]]++;Gd+=uc[kb]}Za.Kb=Gd;if(Za.Ia-Za.Ba<Gd)dd=1;else{for(yb=1;yb<=$b;yb++)Fd[yb]=Za.Ba,Za.Ba+=jc[yb];for(kb=1;kb<=$b;kb++){lb=Ed[kb];Pc=lb+uc[kb]-1;for(ed=lb;ed<=Pc;ed++)yb=Dc[ed],kc=Fd[yb]+le[yb],Dc[kc]=kb,Ra[kc]=Ra[ed],le[yb]++}for(lc=$b+1;lc<=$b+$b;lc++)Ie[lc]=lc-1,me[lc]=lc+1;Ie[$b+1]=Za.Nb;me[Za.Nb]=$b+1;me[$b+$b]=0;Za.Nb=$b+$b}Rb=dd;if(Rb)return a.Ra=a.Ca+a.Ca,aa;var Qc;var Mb=a,Ye=Mb.h,Ec=Mb.Jf,Hd=Mb.Pe,
ob=Mb.Td,Ka=Mb.Sd,zb=Mb.rb,ea=Mb.sb,mb=0,pb,tb,Ua,Sa,T,Kb,fd;for(pb=1;pb<=Ye;pb++)Hd[pb]=0;fd=0;for(tb=1;tb<=Ye;tb++){Ua=ob[tb];Sa=Ua+Ka[tb]-1;for(T=Ua;T<=Sa;T++)Hd[zb[T]]++;fd+=Ka[tb]}Mb.Sf=fd;if(Mb.Ia-Mb.Ba<fd)mb=1;else{for(pb=1;pb<=Ye;pb++)Ec[pb]=Mb.Ia,Mb.Ia-=Hd[pb];for(tb=1;tb<=Ye;tb++){Ua=ob[tb];Sa=Ua+Ka[tb]-1;for(T=Ua;T<=Sa;T++)pb=zb[T],Kb=--Ec[pb],zb[Kb]=tb,ea[Kb]=ea[T]}}Qc=mb;return Qc?(a.Ra=a.Ca+a.Ca,aa):ia}var f,g,j,h,l=a.pc,m,n,p,t,r,w,E=s;1>b&&y("luf_factorize: n = "+b+"; invalid parameter");
...
C),q.se=Array(1+C));f=a.fb;g=a.qb;j=a.jf;h=a.ge;0==a.Ca&&0==a.Ra&&(a.Ra=5*(b+10));for(;e(););if(E!=s)return E;a.valid=1;a.wc=b;E=0;w=3*(b+a.Kb)+2*a.Sf;if(a.Ca<w)for(a.Ra=a.Ca;a.Ra<w;)p=a.Ra,a.Ra=p+p;return E}
function xk(a,b,c){var d=a.h,e=a.Jf,f=a.Pe,g=a.Td,j=a.Sd,h=a.fb,l=a.rb,m=a.sb,n;a.valid||y("luf_f_solve: LU-factorization is not valid");if(b)for(;1<=d;d--){if(n=h[d],a=c[n],0!=a){b=e[n];for(n=b+f[n]-1;b<=n;b++)c[l[b]]-=m[b]*a}}else for(e=1;e<=d;e++)if(n=h[e],a=c[n],0!=a){b=g[n];for(n=b+j[n]-1;b<=n;b++)c[l[b]]-=m[b]*a}}
function zk(a,b,c){var d=a.h,e=a.Ec,f=a.Dc,g=a.sf,j=a.Cc,h=a.Bc,l=a.fb,m=a.ge,n=a.rb,p=a.sb,t=a.se,r,w,E;a.valid||y("luf_v_solve: LU-factorization is not valid");for(a=1;a<=d;a++)t[a]=c[a],c[a]=0;if(b)for(a=1;a<=d;a++){if(r=l[a],w=m[a],b=t[w],0!=b){c[r]=b/=g[r];E=e[r];for(r=E+f[r]-1;E<=r;E++)t[n[E]]-=p[E]*b}}else for(a=d;1<=a;a--)if(r=l[a],w=m[a],b=t[r],0!=b){c[w]=b/=g[r];E=j[w];for(r=E+h[w]-1;E<=r;E++)t[n[E]]-=p[E]*b}}
...
358,wo=359,xo=360,yo=361,zo=362,Ao=363,Bo=364,Co=365,Do=366,Eo=367,Fo=368,Go=369,Ho=370,Io=371,Jo=372,Ko=373,Lo=374,Mo=375,No=376,Oo=377,Po=378,Qo=379,Ro=380,So=381,To=382,Uo=383,Vo=384,Kj=401,Lj=402,Mj=403,Nj=404,Oj=405,Yj=412,Zj=413,Tj=422,Uj=423;function Wo(){return{index:{},P:{},set:{},s:{},F:{},a:{},loop:{}}}function Xo(a){var b;b=a.b==jm?"_|_":a.b==nm?"'...'":a.g;a.Vb[a.hc++]=" ";a.hc==im&&(a.hc=0);for(var c=0;c<b.length;c++)a.Vb[a.hc++]=b[c],a.hc==im&&(a.hc=0)}
function Yo(a){var b;a.m!=Hl&&("\n"==a.m&&a.Xa++,b=a.Ue(),0>b&&(b=Hl),b==Hl?"\n"==a.m?a.Xa--:Zo(a,"final NL missing before end of file"):"\n"!=b&&(0<=" \t\n\v\f\r".indexOf(b)?b=" ":eb(b)&&(Xo(a),W(a,"control character "+b+" not allowed"))),a.m=b)}
function $o(a){if(a.Wb==hm)switch(a.b){case km:Xo(a);W(a,"symbolic name "+a.g+"... too long");break;case lm:Xo(a);W(a,"symbol "+a.g+"... too long");break;case mm:Xo(a);W(a,"numeric literal "+a.g+"... too long");break;case nm:Xo(a),W(a,"string literal too long")}a.g+=a.m;a.Wb++;Yo(a)}
function Y(a){function b(){Xo(a);W(a,"keyword s.t. incomplete")}function c(){Xo(a);W(a,"cannot convert numeric literal "+a.g+" to floating-point number")}function d(){if("e"==a.m||"E"==a.m){$o(a);("+"==a.m||"-"==a.m)&&$o(a);rb(a.m)||(Xo(a),W(a,"numeric literal "+a.g+" incomplete"));for(;rb(a.m);)$o(a)}if(fb(a.m)||"_"==a.m)Xo(a),W(a,"symbol "+a.g+a.m+"... should be enclosed in quotes")}a.zf=a.b;a.yf=a.Wb;a.xf=a.g;a.Af=a.value;if(a.Le)a.Le=0,a.b=a.Ef,a.Wb=a.Df,a.g=a.Cf,a.value=a.Ff;else{for(;;){a.b=
0;a.Wb=0;a.g="";for(a.value=0;" "==a.m||"\n"==a.m;)Yo(a);if(a.m==Hl)a.b=jm;else if("#"==a.m){for(;"\n"!=a.m&&a.m!=Hl;)Yo(a);continue}else if(!a.jc&&(fb(a.m)||"_"==a.m)){for(a.b=km;qb(a.m)||"_"==a.m;)$o(a);"and"==a.g?a.b=om:"by"==a.g?a.b=pm:"cross"==a.g?a.b=qm:"diff"==a.g?a.b=rm:"div"==a.g?a.b=sm:"else"==a.g?a.b=tm:"if"==a.g?a.b=um:"in"==a.g?a.b=vm:"Infinity"==a.g?a.b=wm:"inter"==a.g?a.b=xm:"less"==a.g?a.b=ym:"mod"==a.g?a.b=zm:"not"==a.g?a.b=Am:"or"==a.g?a.b=Bm:"s"==a.g&&"."==a.m?(a.b=Cm,$o(a),"t"!=
a.m&&b(),$o(a),"."!=a.m&&b(),$o(a)):"symdiff"==a.g?a.b=Dm:"then"==a.g?a.b=Em:"union"==a.g?a.b=Fm:"within"==a.g&&(a.b=Gm)}else if(!a.jc&&rb(a.m)){for(a.b=mm;rb(a.m);)$o(a);var e=ia;if("."==a.m)if($o(a),"."==a.m)a.Wb--,a.g=a.g.substr(0,a.g.length-1),a.Ke=1,e=aa;else for(;rb(a.m);)$o(a);e||d();Cl(a.g,function(b){a.value=b})&&c()}else if("'"==a.m||'"'==a.m){e=a.m;a.b=nm;for(Yo(a);;){if("\n"==a.m||a.m==Hl)Xo(a),W(a,"unexpected end of line; string literal incomplete");if(a.m==e&&(Yo(a),a.m!=e))break;$o(a)}}else if(!a.jc&&
"+"==a.m)a.b=Hm,$o(a);else if(!a.jc&&"-"==a.m)a.b=Im,$o(a);else if("*"==a.m)a.b=Jm,$o(a),"*"==a.m&&(a.b=Lm,$o(a));else if("/"==a.m){if(a.b=Km,$o(a),"*"==a.m){for(Yo(a);;)if(a.m==Hl)W(a,"unexpected end of file; comment sequence incomplete");else if("*"==a.m){if(Yo(a),"/"==a.m)break}else Yo(a);Yo(a);continue}}else if("^"==a.m)a.b=Lm,$o(a);else if("<"==a.m)a.b=Mm,$o(a),"="==a.m?(a.b=Nm,$o(a)):">"==a.m?(a.b=Rm,$o(a)):"-"==a.m&&(a.b=hn,$o(a));else if("="==a.m)a.b=Om,$o(a),"="==a.m&&$o(a);else if(">"==
a.m)a.b=Qm,$o(a),"="==a.m?(a.b=Pm,$o(a)):">"==a.m&&(a.b=fn,$o(a));else if("!"==a.m)a.b=Am,$o(a),"="==a.m&&(a.b=Rm,$o(a));else if("&"==a.m)a.b=Sm,$o(a),"&"==a.m&&(a.b=om,$o(a));else if("|"==a.m)a.b=Tm,$o(a),"|"==a.m&&(a.b=Bm,$o(a));else if(!a.jc&&"."==a.m)if(a.b=Um,$o(a),a.Ke)a.b=Zm,a.Wb=2,a.g="..",a.Ke=0;else if("."==a.m)a.b=Zm,$o(a);else{if(rb(a.m)){a.b=mm;for($o(a);rb(a.m);)$o(a);d();Cl(a.g,function(b){a.value=b})&&c()}}else if(","==a.m)a.b=Vm,$o(a);else if(":"==a.m)a.b=Wm,$o(a),"="==a.m&&(a.b=
Ym,$o(a));else if(";"==a.m)a.b=Xm,$o(a);else if("("==a.m)a.b=$m,$o(a);else if(")"==a.m)a.b=an,$o(a);else if("["==a.m)a.b=bn,$o(a);else if("]"==a.m)a.b=cn,$o(a);else if("{"==a.m)a.b=dn,$o(a);else if("}"==a.m)a.b=en,$o(a);else if("~"==a.m)a.b=gn,$o(a);else if(qb(a.m)||0<="+-._".indexOf(a.m)){for(a.b=lm;qb(a.m)||0<="+-._".indexOf(a.m);)$o(a);switch(Cl(a.g,function(b){a.value=b})){case 0:a.b=mm;break;case 1:c()}}else Xo(a),W(a,"character "+a.m+" not allowed");break}Xo(a);a.Hf=0}}
function ap(a){a.Le=1;a.Ef=a.b;a.Df=a.Wb;a.Cf=a.g;a.Ff=a.value;a.b=a.zf;a.Wb=a.yf;a.g=a.xf;a.value=a.Af}function bp(a,b){return a.b==km&&a.g==b}function cp(a){return a.b==om&&"a"==a.g[0]||a.b==pm||a.b==qm||a.b==rm||a.b==sm||a.b==tm||a.b==um||a.b==vm||a.b==xm||a.b==ym||a.b==zm||a.b==Am&&"n"==a.g[0]||a.b==Bm&&"o"==a.g[0]||a.b==Dm||a.b==Em||a.b==Fm||a.b==Gm}
...
case Uo:d.loop.x=jp(a),d.loop.x.type==S&&(d.loop.x=Z(Fn,d.loop.x,V,0)),d.loop.x.type==V&&(d.loop.x=Z(Hn,d.loop.x,fm,1)),d.loop.x.type!=fm&&b(),c=dp(e,d,Ol,d.loop.x.p)}qp(a,d.loop.domain);rp(c);d=c;break;default:d=ip(a)}else if(a.b==$m){var j;b=Wo();var h=Array(21);Ea(h,0,21);var l;e=0;c=a.Hf;Y(a);for(l=1;;l++){20<l&&W(a,"too many components within parentheses");f=function(){j=pp(a);if(a.b==Vm||1<l)j.type==S&&(j=Z(Fn,j,V,0)),j.type!=V&&W(a,"component expression has invalid type");h[l].name=s;h[l].code=
...
function Hp(a){!a.jc&&bp(a,"end")||a.jc&&Ip(a,"end")?(Y(a),a.b==Xm?Y(a):Zo(a,"no semicolon following end statement; missing semicolon inserted")):Zo(a,"unexpected end of file; missing end statement inserted");a.b!=jm&&Zo(a,"some text detected beyond end statement; text ignored")}
function Jp(a,b){var c={u:{}};c.Xa=a.Xa;c.next=s;if(bp(a,"set")){b&&W(a,"set statement not allowed here");c.type=cm;var d=c.u,e=function(){W(a,"at most one := or default/data allowed")},f=function(){W(a,a.g+" not a plain set")},g=function(){W(a,"dimension of "+a.g+" too small")},j=function(){W(a,"component number must be integer between 1 and "+n.set.T)},h,l,m=0,n;Y(a);a.b!=km&&(cp(a)?W(a,"invalid use of reserved keyword "+a.g):W(a,"symbolic name missing where expected"));a.W[a.g]!=s&&W(a,a.g+" multiply declared");
h={};h.name=a.g;h.Cb=s;h.p=0;h.domain=s;h.T=0;h.tf=s;h.assign=s;h.ta=s;h.Vc=s;h.data=0;h.M=s;Y(a);a.b==nm&&(h.Cb=a.g,Y(a));a.b==dn&&(h.domain=np(a),h.p=sp(h.domain));l=a.W[h.name]={};l.type=cm;for(l.link=h;;){if(a.b==Vm)Y(a);else if(a.b==Xm)break;if(bp(a,"dimen")){var p;Y(a);a.b==mm&&1<=a.value&&20>=a.value&&Math.floor(a.value)==a.value||W(a,"dimension must be integer between 1 and 20");p=a.value+0.5|0;m&&W(a,"at most one dimension attribute allowed");0<h.T&&W(a,"dimension "+p+" conflicts with dimension "+
h.T+" already determined");h.T=p;m=1;Y(a)}else if(a.b==Gm||a.b==vm){a.b==vm&&!a.hg&&(Zo(a,"keyword in understood as within"),a.hg=1);Y(a);p={code:s,next:s};if(h.tf==s)h.tf=p;else{for(l=h.tf;l.next!=s;l=l.next);l.next=p}p.code=op(a);p.code.type!=Ol&&W(a,"expression following within has invalid type");0==h.T&&(h.T=p.code.p);h.T!=p.code.p&&W(a,"set expression following within must have dimension "+h.T+" rather than "+p.code.p)}else if(a.b==Ym)h.assign==s&&h.ta==s&&h.Vc==s||e(),Y(a),h.assign=op(a),h.assign.type!=
...
r.type==V&&W(a,"symbolic parameter cannot be binary");r.type=Il;w=1;Y(a)},g=function(){W(a,"at most one := or default allowed")},r,w=j=0;h=0;Y(a);a.b!=km&&(cp(a)?W(a,"invalid use of reserved keyword "+a.g):W(a,"symbolic name missing where expected"));a.W[a.g]!=s&&W(a,a.g+" multiply declared");r={};r.name=a.g;r.Cb=s;r.p=0;r.domain=s;r.type=S;r.rd=s;r.na=s;r.assign=s;r.ta=s;r.data=0;r.Tc=s;r.M=s;Y(a);a.b==nm&&(r.Cb=a.g,Y(a));a.b==dn&&(r.domain=np(a),r.p=sp(r.domain));m=a.W[r.name]={};m.type=am;for(m.link=
r;;){if(a.b==Vm)Y(a);else if(a.b==Xm)break;if(bp(a,"integer"))j&&W(a,"at most one integer allowed"),r.type==V&&W(a,"symbolic parameter cannot be integer"),r.type!=Il&&(r.type=Vl),j=1,Y(a);else if(bp(a,"binary"))f();else if(bp(a,"logical"))a.Be||(Zo(a,"keyword logical understood as binary"),a.Be=1),f();else if(bp(a,"symbolic"))h&&W(a,"at most one symbolic allowed"),r.type!=S&&W(a,"integer or binary parameter cannot be symbolic"),r.rd==s&&r.na==s&&r.assign==s&&r.ta==s||W(a,"keyword symbolic must precede any other parameter attributes"),
r.type=V,h=1,Y(a);else if(a.b==Mm||a.b==Nm||a.b==Om||a.b==Pm||a.b==Qm||a.b==Rm){p={};switch(a.b){case Mm:p.ed=oo;d=a.g;break;case Nm:p.ed=po;d=a.g;break;case Om:p.ed=ro;d=a.g;break;case Pm:p.ed=so;d=a.g;break;case Qm:p.ed=to;d=a.g;break;case Rm:p.ed=uo,d=a.g}p.code=s;p.next=s;if(r.rd==s)r.rd=p;else{for(m=r.rd;m.next!=s;m=m.next);m.next=p}Y(a);p.code=jp(a);p.code.type==S||p.code.type==V||W(a,"expression following "+d+" has invalid type");r.type!=V&&p.code.type==V&&(p.code=Z(En,p.code,S,0));r.type==
V&&p.code.type!=V&&(p.code=Z(Fn,p.code,V,0))}else if(a.b==vm||a.b==Gm){a.b==Gm&&!a.gg&&(Zo(a,"keyword within understood as in"),a.gg=1);Y(a);p={code:s,next:s};if(r.na==s)r.na=p;else{for(m=r.na;m.next!=s;m=m.next);m.next=p}p.code=op(a);p.code.type!=Ol&&W(a,"expression following in has invalid type");1!=p.code.p&&W(a,"set expression following in must have dimension 1 rather than "+p.code.p)}else a.b==Ym?(r.assign==s&&r.ta==s||g(),Y(a),r.assign=jp(a),r.assign.type==S||r.assign.type==V||W(a,"expression following := has invalid type"),
...
a.g+" not a set"),e.u.na.set=g.link,e.u.na.set.assign!=s&&W(a,a.g+" needs no data"),0!=e.u.na.set.p&&W(a,a.g+" must be a simple set"),Y(a),a.b==hn?Y(a):W(a,"delimiter <- missing where expected")):cp(a)?W(a,"invalid use of reserved keyword "+a.g):e.u.na.set=s;e.u.na.Ne=g=s;f=0;for(a.b==bn?Y(a):W(a,"field list missing where expected");;)if(j={},a.b!=km&&(cp(a)?W(a,"invalid use of reserved keyword "+a.g):W(a,"field name missing where expected")),j.name=a.g,Y(a),j.next=s,g==s?e.u.na.Ne=j:g.next=j,g=j,
...
""==g&&W(a,"field name required"),j.name=g,j.next=s,f==s?e.u.Mc.list=j:f.next=j,f=j,a.b==Vm)Y(a);else if(a.b==Xm)break;else W(a,"syntax error in output list");qp(a,e.u.Mc.domain)}a.b!=Xm&&W(a,"syntax error in table statement");Y(a);d.of=e}else if(bp(a,"solve"))b&&W(a,"solve statement not allowed here"),c.type=dm,d=c.u,a.Ib&&W(a,"at most one solve statement allowed"),a.Ib=1,Y(a),a.b!=Xm&&W(a,"syntax error in solve statement"),Y(a),d.oh=s;else if(bp(a,"check"))c.type=Kl,d=c.u,e={domain:s,code:s},Y(a),
a.b==dn&&(e.domain=np(a)),a.b==Wm&&Y(a),e.code=pp(a),e.code.type!=Wl&&W(a,"expression has invalid type"),e.domain!=s&&qp(a,e.domain),a.b!=Xm&&W(a,"syntax error in check statement"),Y(a),d.Gg=e;else if(bp(a,"display")){c.type=Ml;d=c.u;f={domain:s};f.list=e=s;Y(a);a.b==dn&&(f.domain=np(a));for(a.b==Wm&&Y(a);;){var z={u:{}},g=function(){z.type=Ql;z.u.code=pp(a)};z.type=0;z.next=s;f.list==s?f.list=z:e.next=z;e=z;if(a.b==km)if(Y(a),j=a.b,ap(a),j==Vm||j==Xm){g=a.W[a.g];g==s&&W(a,a.g+" not defined");z.type=
g.type;switch(g.type){case Tl:z.u.ua=g.link;break;case cm:z.u.set=g.link;break;case am:z.u.P=g.link;break;case gm:z.u.s=g.link;a.Ib||W(a,"invalid reference to variable "+z.u.s.name+" above solve statement");break;case Ll:z.u.F=g.link,a.Ib||W(a,"invalid reference to "+(z.u.F.type==Ll?"constraint":"objective")+" "+z.u.F.name+" above solve statement")}Y(a)}else g();else g();if(a.b==Vm)Y(a);else break}f.domain!=s&&qp(a,f.domain);a.b!=Xm&&W(a,"syntax error in display statement");Y(a);d.Hg=f}else if(bp(a,
"printf")){c.type=bm;d=c.u;g={domain:s,ud:s};g.list=f=s;Y(a);a.b==dn&&(g.domain=np(a));a.b==Wm&&Y(a);g.ud=jp(a);g.ud.type==S&&(g.ud=Z(Fn,g.ud,V,0));for(g.ud.type!=V&&W(a,"format expression has invalid type");a.b==Vm;)Y(a),e={code:s,next:s},g.list==s?g.list=e:f.next=e,f=e,e.code=op(a),e.code.type==S||(e.code.type==V||e.code.type==Wl)||W(a,"only numeric, symbolic, or logical expression allowed");g.domain!=s&&qp(a,g.domain);g.Ud=s;g.Bg=0;if(a.b==Qm||a.b==fn)g.Bg=a.b==fn,Y(a),g.Ud=jp(a),g.Ud.type==S&&
(g.Ud=Z(Fn,g.Ud,V,0)),g.Ud.type!=V&&W(a,"file name expression has invalid type");a.b!=Xm&&W(a,"syntax error in printf statement");Y(a);d.ah=g}else if(bp(a,"for")){c.type=Rl;d=c.u;g={domain:s};g.list=f=s;Y(a);a.b!=dn&&W(a,"indexing expression missing where expected");g.domain=np(a);a.b==Wm&&Y(a);if(a.b!=dn)g.list=Jp(a,1);else{for(Y(a);a.b!=en;)e=Jp(a,1),f==s?g.list=e:f.next=e,f=e;Y(a)}qp(a,g.domain);d.Jg=g}else a.b==km?(b&&W(a,"constraint statement not allowed here"),c.type=Ll,c.u.F=Gp(a)):cp(a)?W(a,
...
function rq(a,b,c){c!=Math.floor(c)&&W(a,"trunc("+b+", "+c+"); non-integer second argument");c<=na+2&&(a=Math.pow(10,c),Math.abs(b)<0.999*v/a&&(b=0<=b?Math.floor(b*a):Math.ceil(b*a),0!=b&&(b/=a)));return b}function sq(a){var b,c;do b=-1+2*(Al(a.Bd)/2147483648),c=-1+2*(Al(a.Bd)/2147483648),b=b*b+c*c;while(1<b||0==b);return c*Math.sqrt(-2*Math.log(b)/b)}function Qp(a){var b={};b.O=a;b.K=s;return b}function Rp(a){var b={O:0};b.K=a;return b}
...
function Dq(a,b,c){for(var d=s,e,f=0;b!=s;)e=b,b=b.next,e.s==s?f=mq(a,f,e.t):(e.next=d,d=e);c(f);return d}function Eq(a,b){switch(a){case Zl:b.Tg=s;break;case S:b.O=0;break;case V:b.U=s;break;case Wl:b.ig=0;break;case fm:b.v=s;break;case Ol:b.set=s;break;case Pl:b.s=s;break;case Sl:b.form=s;break;case Nl:b.F=s}}function eq(a,b,c){var d={};d.type=b;d.p=c;d.size=0;d.head=s;d.Sa=s;d.W=ia;d.aa=s;d.next=a.fg;d.next!=s&&(d.next.aa=d);return a.fg=d}
...
function Fq(a){var b;if(a.Ce!=s){b=a.list;for(a=a.Ce;b!=s;b=b.next,a=a.next)a:{var c=b,d=a.U,e=k,f=k;if(c.value!=s){if(0==tq(c.value,d))break a;c.value=s}for(e=c.list;e!=s;e=e.a.index.next)for(f=e;f!=s;f=f.ga)f.valid&&(f.valid=0,Eq(f.type,f.value));c.value=Wp(d)}}}function Hq(a,b,c,d,e){var f,g=0;if(!Jq(a,b.code,c))return 1;f=b.Ce;b.Ce=c;Fq(b);e(a,d);b.Ce=f;Fq(b);return g}
function Kq(a,b){if(b.Ic!=s){var c,d,e=s,f=s;c=b.Ic;b.Ic=c.next;for(d=c.list;d!=s;d=d.next)e==s?e=f={}:f=f.next={},d.code==s?(f.U=b.v.U,b.v=b.v.next):f.U=Lq(a,d.code);f.next=s;Hq(a,c,e,b,Kq)&&(b.Me=1);for(d=c.list;d!=s;d=d.next)e=e.next}else b.domain.code!=s&&!Mq(a,b.domain.code)?b.Me=2:b.Vd(a,b.info)}function Nq(a,b,c,d,e){var f={};b==s?(e(a,d),f.Me=0):(f.domain=b,f.Ic=b.list,f.v=c,f.info=d,f.Vd=e,f.Me=0,Kq(a,f));return f.Me}
function Oq(a,b){if(b.Ic!=s){var c,d,e;c=b.Ic;b.Ic=c.next;e=s;for(d=c.list;d!=s;d=d.next)d.code!=s&&(e=Xp(e,Lq(a,d.code)));if(c.code.Pa==Jo){var f,g,j,h;g=$(a,c.code.a.a.x);j=$(a,c.code.a.a.y);h=c.code.a.a.Ka==s?1:$(a,c.code.a.a.Ka);e=yq(a,g,j,h);d=Xp(s,Qp(0));for(f=1;f<=e&&b.Of;f++)d.U.O=zq(a,g,j,h,f),Hq(a,c,d,b,Oq)}else for(f=Pq(a,c.code).head;f!=s&&b.Of;f=f.next){g=f.v;j=e;h=ia;for(d=c.list;d!=s;d=d.next){if(d.code!=s){if(0!=tq(g.U,j.U)){h=aa;break}j=j.next}g=g.next}h||Hq(a,c,f.v,b,Oq)}b.Ic=c}else if(b.domain.code==
s||Mq(a,b.domain.code))b.Of=!b.Vd(a,b.info)}function Qq(a,b,c,d){var e={};b==s?d(a,c):(e.domain=b,e.Ic=b.list,e.Of=1,e.info=c,e.Vd=d,Oq(a,e))}function Rq(a,b,c){W(a,b+cq("[",c)+" out of domain")}function Sq(a){var b=s;if(a!=s)for(a=a.list;a!=s;a=a.next)for(var c=a.list;c!=s;c=c.next)c.code==s&&(b=Xp(b,Wp(c.value)));return b}
function Tq(a,b,c,d){for(var e=b.tf,f=1;e!=s;e=e.next,f++)for(var g=d.head;g!=s;g=g.next)if(!Jq(a,e.code,g.v)){var j=cq("(",g.v);W(a,b.name+cq("[",c)+" contains "+j+" which not within specified set; see ("+f+")")}}function Uq(a,b){if(b.$!=s)Tq(a,b.set,b.$.v,b.$.value.set);else{var c=b.set,d=b.v,e=function(){Tq(a,c,d,f);g=dq(c.M,kq(d));g.value.set=f},f,g=bq(c.M,d);g!=s?f=g.value.set:c.assign!=s?(f=Pq(a,c.assign),e()):c.ta!=s?(f=Pq(a,c.ta),e()):W(a,"no value for "+c.name+cq("[",d));b.ie=f}}
...
function Xq(a,b,c){var d={};d.set=b;d.v=c;b.Vc!=s&&0==b.data&&Vq(a,b);if(1==b.data){c=b.M.Sa;b.data=2;for(d.$=b.M.head;d.$!=s&&!(Nq(a,b.domain,d.$.v,d,Uq)&&Rq(a,b.name,d.$.v),d.$==c);d.$=d.$.next);}d.$=s;Nq(a,d.set.domain,d.v,d,Uq)&&Rq(a,b.name,d.v);return d.ie}function Wq(a,b){var c=Sq(b.domain);Xq(a,b,c);return 0}
function Yq(a,b,c,d){var e,f;switch(b.type){case Vl:d!=Math.floor(d)&&W(a,b.name+cq("[",c)+" = "+d+" not integer");break;case Il:0==d||1==d||W(a,b.name+cq("[",c)+" = "+d+" not binary")}e=b.rd;for(f=1;e!=s;e=e.next,f++){var g;g=$(a,e.code);var j=function(e){W(a,b.name+cq("[",c)+" = "+d+" not "+e+" "+g+"; see ("+f+")")};switch(e.ed){case oo:d<g||j("<");break;case po:d<=g||j("<=");break;case ro:d!=g&&j("=");break;case so:d>=g||j(">=");break;case to:d>g||j(">");break;case uo:d==g&&j("<>")}}f=1;for(e=
...
function br(a,b,c,d){var e,f=1;for(e=b.rd;e!=s;e=e.next,f++){var g;g=Lq(a,e.code);switch(e.ed){case oo:0>tq(d,g)||(g=Vp(g),W(a,b.name+cq("[",c)+" = "+Vp(d)+" not < "+g));break;case po:0>=tq(d,g)||(g=Vp(g),W(a,b.name+cq("[",c)+" = "+Vp(d)+" not <= "+g));break;case ro:0!=tq(d,g)&&(g=Vp(g),W(a,b.name+cq("[",c)+" = "+Vp(d)+" not = "+g));break;case so:0<=tq(d,g)||(g=Vp(g),W(a,b.name+cq("[",c)+" = "+Vp(d)+" not >= "+g));break;case to:0<tq(d,g)||(g=Vp(g),W(a,b.name+cq("[",c)+" = "+Vp(d)+" not > "+g));break;
...
function fr(a,b){var c=b.s,d=b.v,e=bq(c.M,d);e!=s?d=e.value.s:(e=dq(c.M,kq(d)),d=e.value.s={},d.A=0,d.s=c,d.$=e,d.N=c.N==s?0:$(a,c.N),d.S=c.S==s?0:c.S==c.N?d.N:$(a,c.S),d.fa=0,d.l=0,d.q=d.H=0);b.ie=d}function gr(a,b,c){var d={};d.s=b;d.v=c;Nq(a,d.s.domain,d.v,d,fr)&&Rq(a,b.name,d.v);return d.ie}
...
a}),d.N=d.S=-e;else{var g=s,j=s;d.form=Dq(a,d.form,function(a){e=a});Dq(a,ir(a,c.N),function(a){g=a});Dq(a,ir(a,c.S),function(a){j=a});d.N=nq(a,g,e);d.S=nq(a,j,e)}d.l=0;d.q=d.H=0}b.ie=d}function jr(a,b,c){var d={};d.F=b;d.v=c;Nq(a,d.F.domain,d.v,d,hr)&&Rq(a,b.name,d.v);return d.ie}function kr(a,b){var c=Sq(b.domain);jr(a,b,c);return 0}
...
e=1<Math.abs(e)&&-1>d&&-Math.log(Math.abs(e))<0.999*Math.log(v)/d||1>Math.abs(e)&&1<d&&-Math.log(Math.abs(e))>0.999*Math.log(v)/d?0:Math.pow(e,d));c=e;break;case lo:e=$(a,b.a.a.x);d=$(a,b.a.a.y);e>=d&&W(a,"Uniform("+e+", "+d+"); invalid range");f=Al(a.Bd)/2147483648;c=f=mq(a,e*(1-f),d*f);break;case mo:e=$(a,b.a.a.x);d=$(a,b.a.a.y);c=mq(a,e,oq(a,d,sq(a)));break;case Yn:c=Pq(a,b.a.a.x).size;break;case Zn:d=Lq(a,b.a.a.x);f=d.K==s?String(d.O):d.K;c=f.length;break;case Ho:d=Lq(a,b.a.a.x);f=d.K==s?String(d.O):
...
function Mq(a,b){var c,d;b.Q&&b.valid&&(b.valid=0,Eq(b.type,b.value));if(b.valid)return b.value.ig;switch(b.Pa){case Gn:c=0!=$(a,b.a.a.x);break;case Ln:c=!Mq(a,b.a.a.x);break;case oo:b.a.a.x.type==S?c=$(a,b.a.a.x)<$(a,b.a.a.y):(c=Lq(a,b.a.a.x),d=Lq(a,b.a.a.y),c=0>tq(c,d));break;case po:b.a.a.x.type==S?c=$(a,b.a.a.x)<=$(a,b.a.a.y):(c=Lq(a,b.a.a.x),d=Lq(a,b.a.a.y),c=0>=tq(c,d));break;case ro:b.a.a.x.type==S?c=$(a,b.a.a.x)==$(a,b.a.a.y):(c=Lq(a,b.a.a.x),d=Lq(a,b.a.a.y),c=0==tq(c,d));break;case so:b.a.a.x.type==
...
d)}b.valid=1;b.value.form=Bq(c);return c}exports.mpl_tab_num_args=function(a){return a.Xe};exports.mpl_tab_get_arg=function(a,b){return a.a[b]};exports.mpl_tab_num_flds=function(a){return a.lb};exports.mpl_tab_get_name=function(a,b){return a.name[b]};exports.mpl_tab_get_type=function(a,b){return a.type[b]};exports.mpl_tab_get_num=function(a,b){return a.O[b]};exports.mpl_tab_get_str=function(a,b){return a.K[b]};exports.mpl_tab_set_num=function(a,b,c){a.type[b]="N";a.O[b]=c};
exports.mpl_tab_set_str=function(a,b,c){a.type[b]="S";a.K[b]=c};function xr(a,b){var c=a.og,d,e,f;f=0;for(d=b.u.Mc.list;d!=s;d=d.next)switch(f++,d.code.type){case S:c.type[f]="N";c.O[f]=$(a,d.code);c.K[f][0]="\x00";break;case V:e=Lq(a,d.code),e.K==s?(c.type[f]="N",c.O[f]=e.O,c.K[f][0]="\x00"):(c.type[f]="S",c.O[f]=0,c.K[f]=e.K)}mpl_tab_drv_write(a);return 0}function yr(a,b){Mq(a,b.code)||W(a,"check"+cq("[",Sq(b.domain))+" failed");return 0}
function zr(a,b,c){var d=c.value.set;b=b.name+cq("[",c.v)+(d.head==s?" is empty":":");a.ha(b);for(d=d.head;d!=s;d=d.next)b="   "+cq("(",d.v),a.ha(b)}function Ar(a,b,c){switch(b.type){case S:case Vl:case Il:b=b.name+cq("[",c.v)+" = "+c.value.O;a.ha(b);break;case V:b=b.name+cq("[",c.v)+" = "+Vp(c.value.U),a.ha(b)}}
function Br(a,b,c,d){d==jn||d==nn?(b=b.name+cq("[",c.v)+".val = "+c.value.s.q,a.ha(b)):d==kn?(b=b.name+cq("[",c.v)+".lb = "+(c.value.s.s.N==s?-v:c.value.s.N),a.ha(b)):d==ln?(b=b.name+cq("[",c.v)+".ub = "+(c.value.s.s.S==s?+v:c.value.s.S),a.ha(b)):d==mn?(b=b.name+cq("[",c.v)+".status = "+c.value.s.l,a.ha(b)):d==on&&(b=b.name+cq("[",c.v)+".dual = "+c.value.s.H,a.ha(b))}
function Cr(a,b,c,d){d==jn||d==nn?(b=b.name+cq("[",c.v)+".val = "+c.value.F.q,a.ha(b)):d==kn?(b=b.name+cq("[",c.v)+".lb = "+(c.value.F.F.N==s?-v:c.value.F.N),a.ha(b)):d==ln?(b=b.name+cq("[",c.v)+".ub = "+(c.value.F.F.S==s?+v:c.value.F.S),a.ha(b)):d==mn?(b=b.name+cq("[",c.v)+".status = "+c.value.F.l,a.ha(b)):d==on&&(b=b.name+cq("[",c.v)+".dual = "+c.value.F.H,a.ha(b))}
function Dr(a,b){for(var c,d=b.list;d!=s;d=d.next)if(d.type==Tl)c=d.u.ua,c=c.name+" = "+Vp(c.value),a.ha(c);else if(d.type==cm){var e=d.u.set;e.assign!=s?Qq(a,e.domain,e,Wq):(e.Vc!=s&&0==e.data&&Vq(a,e),e.M.head!=s&&Xq(a,e,e.M.head.v));e.M.head==s&&a.ha(e.name+" has empty content");for(c=e.M.head;c!=s;c=c.next)zr(a,e,c)}else if(d.type==am){e=d.u.P;e.assign!=s?Qq(a,e.domain,e,er):e.M.head!=s&&(e.type!=V?ar(a,e,e.M.head.v):dr(a,e,e.M.head.v));e.M.head==s&&a.ha(e.name+" has empty content");for(c=e.M.head;c!=
s;c=c.next)Ar(a,e,c)}else if(d.type==gm){e=d.u.s;e.M.head==s&&a.ha(e.name+" has empty content");for(c=e.M.head;c!=s;c=c.next)Br(a,e,c,jn)}else if(d.type==Ll){e=d.u.F;e.M.head==s&&a.ha(e.name+" has empty content");for(c=e.M.head;c!=s;c=c.next)Cr(a,e,c,jn)}else if(d.type==Ql)if(e=d.u.code,e.Pa==sn||e.Pa==tn||e.Pa==un||e.Pa==vn||e.Pa==wn){c=a;var f={},g=k;f.v=s;for(g=e.a.P.list;g!=s;g=g.next)f.v=Xp(f.v,Lq(c,g.x));switch(e.Pa){case sn:f.value.O=ar(c,e.a.P.P,f.v);Ar(c,e.a.P.P,f);break;case tn:f.value.U=
dr(c,e.a.P.P,f.v);Ar(c,e.a.P.P,f);break;case un:f.value.set=Xq(c,e.a.set.set,f.v);zr(c,e.a.set.set,f);break;case vn:f.value.s=gr(c,e.a.s.s,f.v);Br(c,e.a.s.s,f,e.a.s.zc);break;case wn:f.value.F=jr(c,e.a.F.F,f.v),Cr(c,e.a.F.F,f,e.a.F.zc)}}else switch(c=a,f=e,f.type){case S:e=$(c,f);c.ha(String(e));break;case V:e=Lq(c,f);e=Vp(e);c.ha(e);break;case Wl:e=Mq(c,f);c.ha(e?"true":"false");break;case fm:e=tr(c,f);e=cq("(",e);c.ha(e);break;case Ol:e=Pq(c,f);0==e.head&&c.ha("set is empty");for(e=e.head;e!=s;e=
e.next)f="   "+cq("(",e.v),c.ha(f);break;case Sl:e=k;e=ir(c,f);for(e==s&&c.ha("linear form is empty");e!=s;e=e.next)e.s==s?c.ha("   "+e.t):(f="   "+e.t+" "+e.s.s.name+cq("[",e.s.$.v),c.ha(f))}return 0}function Er(a,b){a.wg==s?"\n"==b?(a.ha(a.$c),a.$c=""):a.$c+=b:a.wg(b)}function Fr(a,b){for(var c=0;c<b.length;c++)Er(a,b[c])}
function Gr(a,b){var c,d,e,f,g,j=Lq(a,b.ud);d=j.K==s?String(j.O):j.K;c=b.list;for(f=0;f<d.length;f++)if("%"==d[f])if(e=f++,"%"==d[f])Er(a,"%");else{if(c==s)break;for(;"-"==d[f]||"+"==d[f]||" "==d[f]||"#"==d[f]||"0"==d[f];)f++;for(;rb(d[f]);)f++;if("."==d[f])for(f++;rb(d[f]);)f++;if("d"==d[f]||"i"==d[f]||"e"==d[f]||"E"==d[f]||"f"==d[f]||"F"==d[f]||"g"==d[f]||"G"==d[f]){switch(c.code.type){case S:g=$(a,c.code);break;case V:j=Lq(a,c.code);j.K!=s&&W(a,"cannot convert "+Vp(j)+" to floating-point number");
...
d[f]?W(a,"invalid use of escape character \\ in format control string"):Er(a,d[f])):Er(a,d[f]);return 0}function Hr(a,b){for(var c=a.Mb,d=b.list;d!=s;d=d.next)Ir(a,d);a.Mb=c;return 0}
function Ir(a,b){a.Mb=b;switch(b.type){case Ll:B("Generating "+b.u.F.name+"...");var c=b.u.F;Qq(a,c.domain,c,kr);break;case em:switch(b.u.of.type){case Ul:B("Reading "+b.u.of.name+"...");break;case $l:B("Writing "+b.u.of.name+"...")}var c=b.u.of,d,e,f,g;a.og=f={};f.id=0;f.link=s;f.Xe=0;f.a=s;f.lb=0;f.name=s;f.type=s;f.O=s;f.K=s;for(d=c.a;d!=s;d=d.next)f.Xe++;f.a=Array(1+f.Xe);for(g=1;g<=f.Xe;g++)f.a[g]=s;g=0;for(d=c.a;d!=s;d=d.next)g++,e=Lq(a,d.code),e=e.K==s?String(e.O):e.K,f.a[g]=e;switch(c.type){case Ul:g=
c.u.na.set;g!=s&&(g.data&&W(a,g.name+" already provided with data"),dq(g.M,s).value.set=eq(a,Zl,g.T),g.data=1);for(e=c.u.na.list;e!=s;e=e.next)e.P.data&&W(a,e.P.name+" already provided with data"),e.P.data=1;for(e=c.u.na.Ne;e!=s;e=e.next)f.lb++;for(e=c.u.na.list;e!=s;e=e.next)f.lb++;f.name=Array(1+f.lb);f.type=Array(1+f.lb);f.O=Array(1+f.lb);f.K=Array(1+f.lb);g=0;for(e=c.u.na.Ne;e!=s;e=e.next)g++,f.name[g]=e.name,f.type[g]="?",f.O[g]=0,f.K[g]="";for(e=c.u.na.list;e!=s;e=e.next)g++,f.name[g]=e.name,
f.type[g]="?",f.O[g]=0,f.K[g]="";for(mpl_tab_drv_open(a,"R");;){for(g=1;g<=f.lb;g++)f.type[g]="?";if(mpl_tab_drv_read(a))break;for(g=1;g<=f.lb;g++)"?"==f.type[g]&&W(a,"field "+f.name[g]+" missing in input table");d=s;g=0;for(e=c.u.na.Ne;e!=s;e=e.next)switch(g++,f.type[g]){case "N":d=Xp(d,Qp(f.O[g]));break;case "S":d=Xp(d,Rp(f.K[g]))}c.u.na.set!=s&&Yp(a,c.u.na.set.M.head.value.set,kq(d));for(e=c.u.na.list;e!=s;e=e.next){var j;g++;bq(e.P.M,d)!=s&&W(a,e.P.name+cq("[",d)+" already defined");j=dq(e.P.M,
...
b.Xa+")...");c=b.u.Gg;Qq(a,c.domain,c,yr);break;case Ml:a.ha("Display statement at line "+b.Xa);c=b.u.Hg;Qq(a,c.domain,c,Dr);break;case bm:c=b.u.ah;Qq(a,c.domain,c,Gr);break;case Rl:c=b.u.Jg,Qq(a,c.domain,c,Hr)}}function Jr(a,b,c){a.Xa=0;a.m="\n";a.b=0;a.Wb=0;a.g="";a.value=0;a.zf=jm;a.yf=0;a.xf="";a.Af=0;a.Ke=0;a.Le=0;a.Ef=0;a.Df=0;a.Cf="";a.Ff=0;Da(a.Vb,0," ",im);a.hc=0;a.Ue=c;a.Te=b||"input";Yo(a);Y(a)}function Kr(a){0<a.$c.length&&(a.ha(a.$c),a.$c="")}
function W(a,b){var c;switch(a.B){case 1:case 2:c=Error(a.Te+":"+a.Xa+": "+b);c.line=a.Xa;for(var d;0<a.hc;)a.hc--,d=a.Vb[0],Ca(a.Vb,0,a.Vb,1,im-1),a.Vb[im-1]=d;B("Context: "+a.Xa+" > "+(" "==a.Vb[0]?"":"...")+a.Vb.join("").trim());break;case 3:d=a.Mb==s?0:a.Mb.Xa,c=Error(d+": "+b),c.line=d}a.B=4;throw c;}function Zo(a,b){switch(a.B){case 1:case 2:B(a.Te+":"+a.Xa+": warning: "+b);break;case 3:B(a.Qf+":"+(a.Mb==s?0:a.Mb.Xa)+": warning: "+b)}}
var zj=exports.mpl_initialize=function(){var a={Xa:0,m:0,b:0,Wb:0,g:"",value:0,zf:0,yf:0,xf:"",Af:0,Ke:0,Le:0,Ef:0,Df:0,Cf:"",Ff:0};a.Vb=Array(im);Da(a.Vb,0," ",im);a.hc=0;a.jc=0;a.W={};a.rc=s;a.Hf=0;a.hg=0;a.gg=0;a.Be=0;a.Ib=0;a.fg=s;a.ph="";a.qh="";a.Bd=zl();a.Gf=0;a.Mb=s;a.og=s;a.f=0;a.h=0;a.k=s;a.e=s;a.Ue=s;a.Te=s;a.ha=s;a.Yg=s;a.wg=s;a.mh=s;a.B=0;a.Qf=s;a.lh="";return a},Bj=exports.mpl_read_model=function(a,b,c,d){function e(){B(a.Xa+" line"+(1==a.Xa?"":"s")+" were read");a.Ue=s;return a.B}0!=
a.B&&y("mpl_read_model: invalid call sequence");c==s&&y("mpl_read_model: no input specified");a.B=1;B("Reading model section from "+b+" ...");Jr(a,b,c);c=a;var f,g;for(g=s;!(c.b==jm||bp(c,"data")||bp(c,"end"));)f=Jp(c,0),g==s?c.rc=f:g.next=f,g=f;a.rc==s&&W(a,"empty model section not allowed");a.Qf=a.Te;c=a;for(f=c.rc;f!=s;f=f.next)switch(f.type){case cm:f.u.set.M=eq(c,Ol,f.u.set.p);break;case am:switch(f.u.P.type){case S:case Vl:case Il:f.u.P.M=eq(c,S,f.u.P.p);break;case V:f.u.P.M=eq(c,V,f.u.P.p)}break;
case gm:f.u.s.M=eq(c,Pl,f.u.s.p);break;case Ll:f.u.F.M=eq(c,Nl,f.u.F.p)}if(bp(a,"data")){if(d)return Zo(a,"data section ignored"),e();a.jc=1;Y(a);a.b!=Xm&&W(a,"semicolon missing where expected");Y(a);a.B=2;B("Reading data section from "+b+" ...");lq(a)}Hp(a);return e()},Dj=exports.mpl_read_data=function(a,b,c){1==a.B||2==a.B||y("mpl_read_data: invalid call sequence");c==s&&y("mpl_read_data: no input specified");a.B=2;B("Reading data section from "+b+" ...");a.jc=1;Jr(a,b,c);Ip(a,"data")&&(Y(a),a.b!=
Xm&&W(a,"semicolon missing where expected"),Y(a));lq(a);Hp(a);B(a.Xa+" line"+(1==a.Xa?"":"s")+" were read");a.Ue=s;return a.B},Fj=exports.mpl_generate=function(a,b,c){1==a.B||2==a.B||y("mpl_generate: invalid call sequence");a.B=3;c==s?a.ha=B:(a.ha=c,a.ha==s&&W(a,"unable to use output callback"),a.Yg=b);a.$c="";for(b=a.rc;b!=s&&!(Ir(a,b),a.Mb.type==dm);b=b.next);a.Mb=b;Kr(a);var d;for(b=a.rc;b!=s;b=b.next)if(b.type==gm){c=b.u.s;for(c=c.M.head;c!=s;c=c.next);}for(b=a.rc;b!=s;b=b.next)if(b.type==Ll){c=
b.u.F;for(c=c.M.head;c!=s;c=c.next){c.value.F.ca=++a.f;for(d=c.value.F.form;d!=s;d=d.next)d.s.$.value.s.A=-1}}for(b=a.rc;b!=s;b=b.next)if(b.type==gm){c=b.u.s;for(c=c.M.head;c!=s;c=c.next)0!=c.value.s.A&&(c.value.s.A=++a.h)}a.k=Array(1+a.f);for(d=1;d<=a.f;d++)a.k[d]=s;for(b=a.rc;b!=s;b=b.next)if(b.type==Ll){c=b.u.F;for(c=c.M.head;c!=s;c=c.next)d=c.value.F.ca,a.k[d]=c.value.F}for(d=1;d<=a.f;d++);a.e=Array(1+a.h);for(d=1;d<=a.h;d++)a.e[d]=s;for(b=a.rc;b!=s;b=b.next)if(b.type==gm){c=b.u.s;for(c=c.M.head;c!=
s;c=c.next)d=c.value.s.A,0!=d&&(a.e[d]=c.value.s)}for(d=1;d<=a.h;d++);B("Model has been successfully generated");return a.B},Gj=exports.mpl_get_prob_name=function(a){return a.Qf},Hj=exports.mpl_get_num_rows=function(a){3!=a.B&&y("mpl_get_num_rows: invalid call sequence");return a.f},Qj=exports.mpl_get_num_cols=function(a){3!=a.B&&y("mpl_get_num_cols: invalid call sequence");return a.h},Ij=exports.mpl_get_row_name=function(a,b){3!=a.B&&y("mpl_get_row_name: invalid call sequence");1<=b&&b<=a.f||y("mpl_get_row_name: i = "+
...
function qr(a){a=El(1,1,a)-El(1,1,1970);switch(pr(a)){case 1:a+=0;break;case 2:a-=1;break;case 3:a-=2;break;case 4:a-=3;break;case 5:a+=3;break;case 6:a+=2;break;case 7:a+=1}pr(a);return a}function gg(){var a={Xb:0};a.tc=a.Vg=a.Wg=0;a.name=a.Za=s;a.da=0;a.ae=a.$d=0;a.xb=a.Nc=s;a.Eb=a.od=s;a.top=s;a.f=a.h=a.J=0;a.lf=a.Nd=s;a.ba=a.oe=0;a.df=a.ng=a.zg=a.pg=0;a.ja=s;a.wa=s;a.ia=s;a.La=s;return a}
function Lr(a,b,c){0==c?(b.aa=s,b.next=a.xb,b.next==s?a.Nc=b:b.next.aa=b,a.xb=b):(b.aa=a.Nc,b.next=s,b.aa==s?a.xb=b:b.aa.next=b,a.Nc=b)}function Mr(a,b){b.aa==s?a.xb=b.next:b.aa.next=b.next;b.next==s?a.Nc=b.aa:b.next.aa=b.aa}function Nr(a,b){b.fa||(b.fa=1,Mr(a,b),Lr(a,b,0))}function Or(a,b,c){0==c?(b.aa=s,b.next=a.Eb,b.next==s?a.od=b:b.next.aa=b,a.Eb=b):(b.aa=a.od,b.next=s,b.aa==s?a.Eb=b:b.aa.next=b,a.od=b)}function Pr(a,b){b.aa==s?a.Eb=b.next:b.aa.next=b.next;b.next==s?a.od=b.aa:b.next.aa=b.aa}
function Qr(a,b){b.fa||(b.fa=1,Pr(a,b),Or(a,b,0))}function Ri(a){var b={};b.ca=++a.ae;b.name=s;b.c=-v;b.d=+v;b.j=s;b.fa=0;Lr(a,b,1);return b}function Ui(a){var b={};b.A=++a.$d;b.name=s;b.Na=0;b.c=b.d=b.t=0;b.j=s;b.fa=0;b.kb={};b.pb={};Or(a,b,1);return b}function Si(a,b,c){var d={};d.k=a;d.e=b;d.i=c;d.ra=s;d.w=a.j;d.oa=s;d.G=b.j;d.w!=s&&(d.w.ra=d);d.G!=s&&(d.G.oa=d);a.j=b.j=d}function Qi(a,b){var c;c={};c.Vd=b;c.info={};c.link=a.top;a.top=c;return c.info}
function Yi(a){for(var b;a.j!=s;)b=a.j,a.j=b.w,b.oa==s?b.e.j=b.G:b.oa.G=b.G,b.G!=s&&(b.G.oa=b.oa)}function Rr(a,b){for(var c;b.j!=s;)c=b.j,b.j=c.G,c.ra==s?c.k.j=c.w:c.ra.w=c.w,c.w!=s&&(c.w.ra=c.ra);Pr(a,b)}
function hg(a,b,c){var d=Id,e=Id,f=b.f,g=b.h,j,h,l;a.Xb=b.dir;a.Xb==Gb?l=1:a.Xb==ec&&(l=-1);a.tc=f;a.Vg=g;a.Wg=b.J;d&&b.name!=s&&(a.name=b.name);d&&b.Za!=s&&(a.Za=b.Za);a.da=l*b.da;j=Array(1+f);for(h=1;h<=f;h++){var m=b.k[h],n;j[h]=n=Ri(a);d&&m.name!=s&&(n.name=m.name);if(e){var p=m.ka;m.type==yc?(n.c=-v,n.d=+v):m.type==Zc?(n.c=m.c*p,n.d=+v):m.type==$c?(n.c=-v,n.d=m.d*p):m.type==R?(n.c=m.c*p,n.d=m.d*p):m.type==G&&(n.c=n.d=m.c*p)}else m.type==yc?(n.c=-v,n.d=+v):m.type==Zc?(n.c=m.c,n.d=+v):m.type==
...
n.type==G&&(h.c=h.d=n.c);h.t=l*n.t;for(n=n.j;n!=s;n=n.G)Si(j[n.k.ca],h,n.i)}a.ba=c;a.oe=e}
function Ag(a,b){var c,d,e,f,g,j,h;Od(b);Xb(b,a.name);dc(b,a.Za);nc(b,a.Xb);a.Xb==Gb?j=1:a.Xb==ec&&(j=-1);rd(b,0,j*a.da);for(c=a.xb;c!=s;c=c.next)c.fa=e=zc(b,1),Mc(b,e,c.name),d=c.c==-v&&c.d==+v?yc:c.d==+v?Zc:c.c==-v?$c:c.c!=c.d?R:G,pd(b,e,d,c.c,c.d);g=Array(1+b.f);h=Array(1+b.f);for(c=a.Eb;c!=s;c=c.next){e=Hc(b,1);Xc(b,e,c.name);rh(b,e,c.Na?ph:Fc);d=c.c==-v&&c.d==+v?yc:c.d==+v?Zc:c.c==-v?$c:c.c!=c.d?R:G;qd(b,e,d,c.c,c.d);rd(b,e,j*c.t);f=0;for(d=c.j;d!=s;d=d.G)f++,g[f]=d.k.fa,h[f]=d.i;td(b,e,f,g,
h)}a.f=b.f;a.h=b.h;a.J=b.J;a.lf=Array(1+a.f);a.Nd=Array(1+a.h);c=a.xb;for(e=0;c!=s;c=c.next)a.lf[++e]=c.ca;c=a.Eb;for(e=0;c!=s;c=c.next)a.Nd[++e]=c.A;a.name=a.Za=s;a.da=0;a.xb=a.Nc=s;a.Eb=a.od=s}
function dg(a,b){var c,d,e,f;a.Xb==Gb?d=1:a.Xb==ec&&(d=-1);a.ba==ig?(a.df=b.la,a.ng=b.pa):a.ba==$j?a.zg=b.Ve:a.ba==Oi&&(a.pg=b.va);if(a.ba==ig){a.ja==s&&(a.ja=Array(1+a.ae));for(f=1;f<=a.ae;f++)a.ja[f]=0;a.ia==s&&(a.ia=Array(1+a.$d));for(c=1;c<=a.$d;c++)a.ia[c]=0}a.La==s&&(a.La=Array(1+a.$d));for(c=1;c<=a.$d;c++)a.La[c]=v;if(a.ba!=Oi){a.wa==s&&(a.wa=Array(1+a.ae));for(f=1;f<=a.ae;f++)a.wa[f]=v}if(a.ba==ig){for(f=1;f<=a.f;f++)c=b.k[f],e=a.lf[f],a.ja[e]=c.l,a.wa[e]=d*c.H;for(c=1;c<=a.h;c++)d=b.e[c],
e=a.Nd[c],a.ia[e]=d.l,a.La[e]=d.q}else if(a.ba==$j){for(f=1;f<=a.f;f++)c=b.k[f],e=a.lf[f],a.wa[e]=d*c.ic;for(c=1;c<=a.h;c++)d=b.e[c],e=a.Nd[c],a.La[e]=d.ac}else if(a.ba==Oi)for(c=1;c<=a.h;c++)d=b.e[c],e=a.Nd[c],a.La[e]=d.Oa;for(e=a.top;e!=s;e=e.link)e.Vd(a,e.info)}
function eg(a,b){var c,d,e,f;a.Xb==Gb?e=1:a.Xb==ec&&(e=-1);if(a.ba==ig){b.valid=0;b.la=a.df;b.pa=a.ng;b.Y=b.da;b.some=0;for(d=1;d<=b.f;d++)c=b.k[d],c.l=a.ja[d],c.H=a.oe?e*a.wa[d]*c.ka:e*a.wa[d],c.l==D?c.H=0:c.l==K?c.q=c.c:c.l==od?c.q=c.d:c.l==Yc?c.q=0:c.l==Gc&&(c.q=c.c);for(d=1;d<=b.h;d++)c=b.e[d],c.l=a.ia[d],c.q=a.oe?a.La[d]*c.sa:a.La[d],c.l==D?c.H=0:c.l==K?c.q=c.c:c.l==od?c.q=c.d:c.l==Yc?c.q=0:c.l==Gc&&(c.q=c.c),b.Y+=c.t*c.q;for(d=1;d<=b.f;d++)if(c=b.k[d],c.l==D){f=0;for(e=c.j;e!=s;e=e.w)f+=e.i*
e.e.q;c.q=f}for(d=1;d<=b.h;d++)if(c=b.e[d],c.l!=D){f=c.t;for(e=c.j;e!=s;e=e.G)f-=e.i*e.k.H;c.H=f}}else if(a.ba==$j){b.Ve=a.zg;b.Xd=b.da;for(d=1;d<=b.f;d++)c=b.k[d],c.ic=a.oe?e*a.wa[d]*c.ka:e*a.wa[d];for(d=1;d<=b.h;d++)c=b.e[d],c.ac=a.oe?a.La[d]*c.sa:a.La[d],b.Xd+=c.t*c.ac;for(d=1;d<=b.f;d++){c=b.k[d];f=0;for(e=c.j;e!=s;e=e.w)f+=e.i*e.e.ac;c.ac=f}for(d=1;d<=b.h;d++){c=b.e[d];f=c.t;for(e=c.j;e!=s;e=e.G)f-=e.i*e.k.ic;c.ic=f}}else if(a.ba==Oi){b.va=a.pg;b.qa=b.da;for(d=1;d<=b.h;d++)c=b.e[d],c.Oa=a.La[d],
b.qa+=c.t*c.Oa;for(d=1;d<=b.f;d++){c=b.k[d];f=0;for(e=c.j;e!=s;e=e.w)f+=e.i*e.e.Oa;c.Oa=f}}}function Sr(a,b){Qi(a,function(a,b){a.ba==ig&&(a.ja[b.r]=D);a.ba!=Oi&&(a.wa[b.r]=0);return 0}).r=b.ca;Yi(b);Mr(a,b)}
function Pi(a,b){var c,d;c=Qi(a,function(a,b){if(a.ba==ig)if(a.ia[b.C]==D||a.ia[b.C]==K||a.ia[b.C]==od)a.ia[b.C]=a.ia[b.C];else return 1;a.La[b.C]=b.Cg+a.La[b.C];return 0});c.C=b.A;c.Cg=b.c;a.da+=b.t*b.c;for(d=b.j;d!=s;d=d.G)c=d.k,c.c==c.d?c.d=c.c-=d.i*b.c:(c.c!=-v&&(c.c-=d.i*b.c),c.d!=+v&&(c.d-=d.i*b.c));b.d!=+v&&(b.d-=b.c);b.c=0}
function Tr(a,b){var c,d;c=Qi(a,function(a,b){a.ba==ig&&(a.ia[b.C]=Gc);a.La[b.C]=b.dh;return 0});c.C=b.A;c.dh=b.c;a.da+=b.t*b.c;for(d=b.j;d!=s;d=d.G)c=d.k,c.c==c.d?c.d=c.c-=d.i*b.c:(c.c!=-v&&(c.c-=d.i*b.c),c.d!=+v&&(c.d-=d.i*b.c));Rr(a,b)}
function Ur(a,b){var c,d,e;d=1E-9+1E-12*Math.abs(b.c);if(b.d-b.c>d)return 0;Qi(a,function(a,b){if(a.ba==ig)if(a.ja[b.r]==D)a.ja[b.r]=D;else if(a.ja[b.r]==Gc)a.ja[b.r]=0<=a.wa[b.r]?K:od;else return 1;return 0}).r=b.ca;c=0.5*(b.d+b.c);e=Math.floor(c+0.5);Math.abs(c-e)<=d&&(c=e);b.c=b.d=c;return 1}
function Vr(a,b){var c,d,e,f;f=1E-9+1E-12*Math.abs(b.c);if(b.d-b.c>f)return 0;c=Qi(a,function(a,b){var c,d;if(a.ba==ig)if(a.ia[b.C]==D)a.ia[b.C]=D;else if(a.ia[b.C]==Gc){d=b.m;for(c=b.j;c!=s;c=c.next)d-=c.i*a.wa[c.xc];a.ia[b.C]=0<=d?K:od}else return 1;return 0});c.C=b.A;c.m=b.t;c.j=s;if(a.ba==ig)for(d=b.j;d!=s;d=d.G)e={},e.xc=d.k.ca,e.i=d.i,e.next=c.j,c.j=e;c=0.5*(b.d+b.c);d=Math.floor(c+0.5);Math.abs(c-d)<=f&&(c=d);b.c=b.d=c;return 1}
function Wr(a,b){var c;if(a.Na)if(c=Math.floor(b+0.5),1E-5>=Math.abs(b-c))b=c;else return 2;if(a.c!=-v){c=a.Na?1E-5:1E-5+1E-8*Math.abs(a.c);if(b<a.c-c)return 1;if(b<a.c+0.0010*c)return a.d=a.c,0}if(a.d!=+v){c=a.Na?1E-5:1E-5+1E-8*Math.abs(a.d);if(b>a.d+c)return 1;if(b>a.d-0.0010*c)return a.c=a.d,0}a.c=a.d=b;return 0}
function Xr(a,b){var c;a.Na&&(c=Math.floor(b+0.5),b=1E-5>=Math.abs(b-c)?c:Math.ceil(b));if(a.c!=-v&&(c=a.Na?0.0010:0.0010+1E-6*Math.abs(a.c),b<a.c+c))return 0;if(a.d!=+v){c=a.Na?1E-5:1E-5+1E-8*Math.abs(a.d);if(b>a.d+c)return 4;if(b>a.d-0.0010*c)return a.c=a.d,3}c=a.c==-v?2:a.Na&&b>a.c+0.5?2:b>a.c+0.3*(1+Math.abs(a.c))?2:1;a.c=b;return c}
function Yr(a,b){var c;a.Na&&(c=Math.floor(b+0.5),b=1E-5>=Math.abs(b-c)?c:Math.floor(b));if(a.d!=+v&&(c=a.Na?0.0010:0.0010+1E-6*Math.abs(a.d),b>a.d-c))return 0;if(a.c!=-v){c=a.Na?1E-5:1E-5+1E-8*Math.abs(a.c);if(b<a.c-c)return 4;if(b<a.c+0.0010*c)return a.d=a.c,3}c=a.d==+v?2:a.Na&&b<a.d-0.5?2:b<a.d-0.3*(1+Math.abs(a.d))?2:1;a.d=b;return c}
function Zr(a,b){var c,d,e,f,g,j;e=b.j;d=e.e;0<e.i?(g=b.c==-v?-v:b.c/e.i,c=b.d==+v?+v:b.d/e.i):(g=b.d==+v?-v:b.d/e.i,c=b.c==-v?+v:b.c/e.i);if(g==-v)g=0;else if(g=Xr(d,g),4==g)return 4;if(c==+v)j=0;else if(3==g)j=0;else if(j=Yr(d,c),4==j)return 4;if(!g&&!j)return b.c=-v,b.d=+v,Sr(a,b),0;c=Qi(a,function(a,b){var c,d;if(a.ba==Oi)return 0;d=b.m;for(c=b.j;c!=s;c=c.next)d-=c.i*a.wa[c.xc];if(a.ba==ig){c=function(){b.Nf?(a.ja[b.r]=0<b.za?K:od,a.ia[b.C]=D,a.wa[b.r]=d/b.za):(a.ja[b.r]=D,a.wa[b.r]=0);return 0};
var e=function(){b.Zf?(a.ja[b.r]=0<b.za?od:K,a.ia[b.C]=D,a.wa[b.r]=d/b.za):(a.ja[b.r]=D,a.wa[b.r]=0);return 0};if(a.ia[b.C]==D)a.ja[b.r]=D,a.wa[b.r]=0;else if(a.ia[b.C]==K)c();else if(a.ia[b.C]==od)e();else if(a.ia[b.C]==Gc){if(1E-7<d&&(0<b.za&&b.c!=-v||0>b.za&&b.d!=+v||!b.Nf))return a.ia[b.C]=K,c();if(-1E-7>d&&(0<b.za&&b.d!=+v||0>b.za&&b.c!=-v||!b.Zf))return a.ia[b.C]=od,e();if(b.c!=-v&&b.d==+v)a.ja[b.r]=K;else if(b.c==-v&&b.d!=+v)a.ja[b.r]=od;else if(b.c!=-v&&b.d!=+v)a.ja[b.r]=b.za*a.La[b.C]<=0.5*
(b.c+b.d)?K:od;else return 1;a.ia[b.C]=D;a.wa[b.r]=d/b.za}else return 1}a.ba==$j&&(a.wa[b.r]=d>+ra&&b.Nf||d<-ra&&b.Zf?d/b.za:0);return 0});c.r=b.ca;c.C=d.A;c.za=e.i;c.m=d.t;c.c=b.c;c.d=b.d;c.Nf=g;c.Zf=j;c.j=s;if(a.ba!=Oi)for(d=d.j;d!=s;d=d.G)d!=e&&(f={},f.xc=d.k.ca,f.i=d.i,f.next=c.j,c.j=f);Yi(b);Mr(a,b);return g>=j?g:j}
...
function as(a,b,c){var d,e=s,f,g,j;d=1;for(g=b.j;g!=s;g=g.w)d<Math.abs(g.i)&&(d=Math.abs(g.i));for(g=b.j;g!=s;g=g.w)if(Math.abs(g.i)<1E-7*d)return 1;d=Qi(a,function(a,b){var c,d,e,f,g;if(a.ba==Oi)return 0;if(a.ba==ig){if(a.ja[b.r]!=D)return 1;for(c=b.j;c!=s;c=c.next){if(a.ia[c.A]!=Gc)return 1;a.ia[c.A]=c.l}}for(c=b.j;c!=s;c=c.next){e=c.m;for(d=c.j;d!=s;d=d.next)e-=d.i*a.wa[d.xc];c.m=e}d=s;f=0;for(c=b.j;c!=s;c=c.next)if(e=c.m,g=Math.abs(e/c.Ub),c.l==K)0>e&&f<g&&(d=c,f=g);else if(c.l==od)0<e&&f<g&&
(d=c,f=g);else return 1;d!=s&&(a.ba==ig&&(a.ja[b.r]=b.l,a.ia[d.A]=D),a.wa[b.r]=d.m/d.Ub);return 0});d.r=b.ca;d.l=b.c==b.d?Gc:0==c?K:od;d.j=s;for(g=b.j;g!=s;g=g.w)if(f=g.e,a.ba!=Oi&&(e={},e.A=f.A,e.l=-1,e.Ub=g.i,e.m=f.t,e.j=s,e.next=d.j,d.j=e),0==c&&0>g.i||0!=c&&0<g.i?(a.ba!=Oi&&(e.l=K),f.d=f.c):(a.ba!=Oi&&(e.l=od),f.c=f.d),a.ba!=Oi)for(f=f.j;f!=s;f=f.G)f!=g&&(j={},j.xc=f.k.ca,j.i=f.i,j.next=e.j,e.j=j);b.c=-v;b.d=+v;return 0}
function bs(a,b,c){a.ba==ig&&(a=Qi(a,function(a,b){if(a.ba!=ig)return 1;a.ja[b.r]=a.ja[b.r]==D?D:b.l;return 0}),a.r=b.ca,a.l=b.d==+v?K:b.c==-v?od:b.c!=b.d?0==c?od:K:Gc);0==c?b.c=-v:1==c&&(b.d=+v)}function Xi(a,b){var c,d,e;d=s;for(c=a.j;c!=s;c=c.w)e={},e.Z=b*c.i,e.Bb=c.e,e.next=d,d=e;return d}
function cs(a,b,c){var d,e,f;for(d=a;d!=s;d=d.next);e=0;for(d=a;d!=s;d=d.next)if(1!=d.Z)if(-1==d.Z)e++;else break;if(d==s&&b==1-e)return 1;for(d=a;d!=s;d=d.next)0>d.Z&&(b-=d.Z);for(d=a;d!=s;d=d.next)if(Math.abs(d.Z)>b)return 0;e=s;for(d=a;d!=s;d=d.next)if(e==s||Math.abs(e.Z)>Math.abs(d.Z))e=d;f=s;for(d=a;d!=s;d=d.next)if(d!=e&&(f==s||Math.abs(f.Z)>Math.abs(d.Z)))f=d;if(Math.abs(e.Z)+Math.abs(f.Z)<=b+(0.0010+1E-6*Math.abs(b)))return 0;b=1;for(d=a;d!=s;d=d.next)0<d.Z?d.Z=1:(d.Z=-1,b-=1);c(b);return 2}
function Vi(a,b){var c,d,e,f,g=0,j;for(f=0;1>=f;f++){if(0==f){if(b.d==+v)continue;e=Xi(b,1);j=+b.d}else{if(b.c==-v)continue;e=Xi(b,-1);j=-b.c}c=cs(e,j,function(a){j=a});if(1==f&&1==c||2==c){g++;if(ja){B("Original constraint:");for(d=b.j;d!=s;d=d.w)B(" "+d.i+" x"+d.e.A);b.c!=-v&&B(", >= "+b.c);b.d!=+v&&B(", <= "+b.d);B("");B("Equivalent packing inequality:");for(d=e;d!=s;d=d.next)B(" "+(0<d.Z?"+":"-")+"x"+d.Bb.A);B(", <= "+j+"")}if(b.c==-v||b.d==+v)c=s;else{c=Ri(a);0==f?(c.c=b.c,c.d=+v):(c.c=-v,c.d=
b.d);for(d=b.j;d!=s;d=d.w)Si(c,d.e,d.i)}Yi(b);b.c=-v;b.d=j;for(d=e;d!=s;d=d.next)Si(b,d.Bb,d.Z);c!=s&&(b=c)}}return g}function ds(a,b,c){var d,e;for(d=a;d!=s;d=d.next);e=0;for(d=a;d!=s;d=d.next)if(1!=d.Z)if(-1==d.Z)e++;else break;if(d==s&&b==1-e)return 1;for(d=a;d!=s;d=d.next)0>d.Z&&(b-=d.Z);if(0.0010>b)return 0;e=1E-9+1E-12*Math.abs(b);for(d=a;d!=s;d=d.next)if(Math.abs(d.Z)<b-e)return 0;b=1;for(d=a;d!=s;d=d.next)0<d.Z?d.Z=1:(d.Z=-1,b-=1);c(b);return 2}
function Wi(a,b){var c,d,e,f,g=0,j;for(f=0;1>=f;f++){if(0==f){if(b.c==-v)continue;e=Xi(b,1);j=+b.c}else{if(b.d==+v)continue;e=Xi(b,-1);j=-b.d}c=ds(e,j,function(a){j=a});if(1==f&&1==c||2==c){g++;if(ja){B("Original constraint:");for(d=b.j;d!=s;d=d.w)B(" "+d.i+" x"+d.e.A);b.c!=-v&&B(", >= "+b.c);b.d!=+v&&B(", <= "+b.d);B("");B("Equivalent covering inequality:");for(d=e;d!=s;d=d.next)B(" "+(0<d.Z?"+":"-")+"x"+d.Bb.A);B(", >= "+j+"")}if(b.c==-v||b.d==+v)c=s;else{c=Ri(a);0==f?(c.c=-v,c.d=b.d):(c.c=b.c,
c.d=+v);for(d=b.j;d!=s;d=d.w)Si(c,d.e,d.i)}Yi(b);b.c=j;b.d=+v;for(d=e;d!=s;d=d.next)Si(b,d.Bb,d.Z);c!=s&&(b=c)}}return g}
function es(a,b,c){function d(){for(f=b.j;f!=s;f=g){ja&&B("H");e=f.e;g=f.w;for(j=e.j;j!=s;j=j.G)Nr(a,j.k);Tr(a,e)}Sr(a,b);return 0}var e,f,g,j,h;if(b.j==s){h=a;var l=b;0.0010<l.c||-0.0010>l.d?h=1:(l.c=-v,l.d=+v,Sr(h,l),h=0);if(0==h)return ja&&B("A"),0;if(1==h)return ug}if(b.j.w==s)if(e=b.j.e,b.c==b.d){h=a;var l=b,m,n,p;p=l.j;n=p.e;m=Wr(n,l.c/p.i);if(0!=m)h=m;else{m=Qi(h,function(a,b){var c,d;if(a.ba==ig){if(a.ia[b.C]!=Gc)return 1;a.ja[b.r]=Gc;a.ia[b.C]=D}if(a.ba!=Oi){d=b.m;for(c=b.j;c!=s;c=c.next)d-=
c.i*a.wa[c.xc];a.wa[b.r]=d/b.za}return 0});m.r=l.ca;m.C=n.A;m.za=p.i;m.m=n.t;m.j=s;if(h.ba!=Oi)for(p=n.j;p!=s;p=p.G)p.k!=l&&(n={},n.xc=p.k.ca,n.i=p.i,n.next=m.j,m.j=n);Yi(l);Mr(h,l);h=0}if(0==h){ja&&B("B");for(f=e.j;f!=s;f=f.G)Nr(a,f.k);Tr(a,e);return 0}if(1==h||2==h)return ug}else{h=Zr(a,b);if(0<=h&&3>=h){ja&&B("C");Qr(a,e);if(2<=h)for(f=e.j;f!=s;f=f.G)Nr(a,f.k);3==h&&(ja&&B("D"),Tr(a,e));return 0}if(4==h)return ug}a:{l=h=0;for(m=b.j;m!=s;m=m.w)if(0<m.i){if(m.e.c==-v){l=-v;break}l+=m.i*m.e.c}else{if(m.e.d==
+v){l=-v;break}l+=m.i*m.e.d}p=0;for(m=b.j;m!=s;m=m.w)if(0<m.i){if(m.e.d==+v){p=+v;break}p+=m.i*m.e.d}else{if(m.e.c==-v){p=+v;break}p+=m.i*m.e.c}if(b.c!=-v&&(m=0.0010+1E-6*Math.abs(b.c),b.c-m>p)){h=51;break a}if(b.d!=+v&&(m=0.0010+1E-6*Math.abs(b.d),b.d+m<l)){h=51;break a}b.c!=-v&&(m=1E-9+1E-12*Math.abs(b.c),b.c-m>l&&(h=b.c+m<=p?h|1:h|2));b.d!=+v&&(m=1E-9+1E-12*Math.abs(b.d),b.d+m<p&&(h=b.d-m>=l?h|16:h|32))}if(51==h)return ug;if(0==(h&15))b.c!=-v&&(ja&&B("F"),bs(a,b,0));else if(1!=(h&15)&&2==(h&15)&&
(ja&&B("G"),0==as(a,b,0)))return d();if(0==(h&240))b.d!=+v&&(ja&&B("I"),bs(a,b,1));else if(16!=(h&240)&&32==(h&240)&&(ja&&B("J"),0==as(a,b,1)))return d();if(b.c==-v&&b.d==+v){ja&&B("K");for(f=b.j;f!=s;f=f.w)Qr(a,f.e);Sr(a,b);return 0}return a.ba==Oi&&c&&0>fs(a,b,1)?ug:0}
function fs(a,b,c){var d,e,f,g,j,h=0,l;j=ia;e=1;for(d=b.j;d!=s;d=d.w)d.e.kb.kb=-v,d.e.pb.pb=+v,e<Math.abs(d.i)&&(e=Math.abs(d.i));g=1E-6*e;if(b.c!=-v){e=s;for(d=b.j;d!=s;d=d.w)if(0<d.i&&d.e.d==+v||0>d.i&&d.e.c==-v)if(e==s)e=d;else{j=aa;break}if(!j){j=b.c;for(d=b.j;d!=s;d=d.w)d!=e&&(j=0<d.i?j-d.i*d.e.d:j-d.i*d.e.c);if(e==s)for(d=b.j;d!=s;d=d.w)d.i>=+g?d.e.kb.kb=d.e.d+j/d.i:d.i<=-g&&(d.e.pb.pb=d.e.c+j/d.i);else e.i>=+g?e.e.kb.kb=j/e.i:e.i<=-g&&(e.e.pb.pb=j/e.i)}}j=ia;if(b.d!=+v){e=s;for(d=b.j;d!=s;d=
d.w)if(0<d.i&&d.e.c==-v||0>d.i&&d.e.d==+v)if(e==s)e=d;else{j=aa;break}if(!j){j=b.d;for(d=b.j;d!=s;d=d.w)d!=e&&(j=0<d.i?j-d.i*d.e.c:j-d.i*d.e.d);if(e==s)for(d=b.j;d!=s;d=d.w)d.i>=+g?d.e.pb.pb=d.e.c+j/d.i:d.i<=-g&&(d.e.kb.kb=d.e.d+j/d.i);else e.i>=+g?e.e.pb.pb=j/e.i:e.i<=-g&&(e.e.kb.kb=j/e.i)}}for(e=b.j;e!=s;){d=e.e;e=e.w;for(g=0;1>=g;g++){f=d.c;l=d.d;if(0==g){if(d.kb.kb==-v)continue;j=Xr(d,d.kb.kb)}else{if(d.pb.pb==+v)continue;j=Yr(d,d.pb.pb)}if(0==j||1==j)d.c=f,d.d=l;else if(2==j||3==j){ja&&B("L");
h++;if(c)for(f=d.j;f!=s;f=f.G)f.k!=b&&Nr(a,f.k);if(3==j){ja&&B("M");Tr(a,d);break}}else if(4==j)return-1}}return h}
function gs(a,b){var c,d,e;if(b.j==s){e=function(){g.l=K;b.d=b.c};var f=function(){g.l=od;b.c=b.d},g;0.0010<b.t&&b.c==-v||-0.0010>b.t&&b.d==+v?e=1:(g=Qi(a,function(a,b){a.ba==ig&&(a.ia[b.C]=b.l);return 0}),g.C=b.A,b.c==-v&&b.d==+v?(g.l=Yc,b.c=b.d=0):b.d==+v?e():b.c==-v?f():b.c!=b.d?b.t>=+ra?e():b.t<=-ra?f():Math.abs(b.c)<=Math.abs(b.d)?e():f():g.l=Gc,Tr(a,b),e=0);if(0==e)return ja&&B("N"),0;if(1==e)return vg}if(b.j.G==s)if(c=b.j.k,f=function(){ja&&B("O");var e,f,g,m;g=b.j;f=g.k;e=Qi(a,function(a,
b){var c,d;if(a.ba==ig){if(a.ja[b.r]==D||a.ja[b.r]==Yc)a.ia[b.C]=a.ja[b.r];else if(a.ja[b.r]==K)a.ia[b.C]=0<b.za?od:K;else if(a.ja[b.r]==od)a.ia[b.C]=0<b.za?K:od;else return 1;a.ja[b.r]=Gc}a.ba!=Oi&&(a.wa[b.r]+=b.m/b.za);c=b.ld;for(d=b.j;d!=s;d=d.next)c-=d.i*a.La[d.xc];a.La[b.C]=c/b.za;return 0});e.r=f.ca;e.C=b.A;e.za=g.i;e.ld=f.c;e.m=b.t;e.j=s;for(g=f.j;g!=s;g=g.w)g.e!=b&&(m={},m.xc=g.e.A,m.i=g.i,m.next=e.j,e.j=m,g.e.t-=e.m*(g.i/e.za));a.da+=e.m*(e.ld/e.za);0<e.za?(f.c=b.d==+v?-v:e.ld-e.za*b.d,f.d=
b.c==-v?+v:e.ld-e.za*b.c):(f.c=b.c==-v?-v:e.ld-e.za*b.c,f.d=b.d==+v?+v:e.ld-e.za*b.d);Rr(a,b);if(c.c==-v&&c.d==+v){ja&&B("P");for(d=c.j;d!=s;d=d.w)Qr(a,d.e);Sr(a,c)}else Nr(a,c);return 0},c.c==c.d){if(!b.Na)return f()}else if(!b.Na){e=$r(a,b);if(0==e)return ja&&B("Q"),f();if(1!=e&&2==e)return vg}return 0}
function kg(a,b){function c(){ja&&B("");return f}var d,e,f,g;for(d=a.xb;d!=s;d=e)e=d.next,d.c==-v&&d.d==+v&&(ja&&B("1"),Sr(a,d));for(d=a.xb;d!=s;d=e)e=d.next,d.c!=-v&&(d.d!=+v&&d.c<d.d)&&(d=Ur(a,d),0!=d&&1==d&&ja&&B("2"));for(e=a.Eb;e!=s;e=g)g=e.next,e.c==e.d&&(ja&&B("3"),Tr(a,e));for(e=a.Eb;e!=s;e=g)g=e.next,e.c!=-v&&(e.d!=+v&&e.c<e.d)&&(d=Vr(a,e),0!=d&&1==d&&(ja&&B("4"),Tr(a,e)));for(d=a.xb;d!=s;d=d.next)d.fa=1;for(d=a.Eb;d!=s;d=d.next)d.fa=1;for(e=1;e;){for(e=0;;){d=a.xb;if(d==s||!d.fa)break;e=
a;g=d;g.fa&&(g.fa=0,Mr(e,g),Lr(e,g,1));f=es(a,d,b);if(0!=f)return c();e=1}for(;;){d=a.Eb;if(d==s||!d.fa)break;e=a;g=d;g.fa&&(g.fa=0,Pr(e,g),Or(e,g,1));f=gs(a,d);if(0!=f)return c();e=1}}if(a.ba==Oi&&!b)for(d=a.xb;d!=s;d=d.next)if(0>fs(a,d,0))return f=ug,c();f=0;return c()}function hs(a){var b,c;b=1;for(c=32;55>=c;b++,c++)a.ib[b]=a.ib[b]-a.ib[c]&2147483647;for(c=1;55>=b;b++,c++)a.ib[b]=a.ib[b]-a.ib[c]&2147483647;a.If=54;return a.ib[55]}
function zl(){var a={},b;a.ib=Array(56);a.ib[0]=-1;for(b=1;55>=b;b++)a.ib[b]=0;a.If=0;Aj(a,1);return a}function Aj(a,b){var c,d,e=1;b=d=b-0&2147483647;a.ib[55]=d;for(c=21;c;c=(c+21)%55)a.ib[c]=e,e=d-e&2147483647,b=b&1?1073741824+(b>>1):b>>1,e=e-b&2147483647,d=a.ib[c];hs(a);hs(a);hs(a);hs(a);hs(a)}function Al(a){return 0<=a.ib[a.If]?a.ib[a.If--]:hs(a)}var uk=1,wk=2,Mk=1,Jk=2,tk=0,Lk=1E-10;function Kk(a,b,c){return(b-1)*a.I+c-b*(b-1)/2}
...
function Bk(a,b,c,d){a.wc<a.h&&y("scf_solve_it: singular matrix");if(b){b=a.h;var e=a.Hb,f=a.u,g=a.r,j=a.ag,h,l,m;for(h=1;h<=b;h++)j[h]=c[g[h]+d];for(h=1;h<=b;h++){l=Kk(a,h,h);m=j[h]/=f[l];g=h+1;for(l++;g<=b;g++,l++)j[g]-=f[l]*m}for(g=1;g<=b;g++)c[g+d]=0;for(h=1;h<=b;h++){m=j[h];g=1;for(l=(h-1)*a.I+1;g<=b;g++,l++)c[g+d]+=e[l]*m}}else{b=a.h;e=a.Hb;f=a.u;j=a.r;h=a.ag;for(var n,g=1;g<=b;g++){n=0;l=1;for(m=(g-1)*a.I+1;l<=b;l++,m++)n+=e[m]*c[l+d];h[g]=n}for(g=b;1<=g;g--){n=h[g];l=b;for(m=Kk(a,g,b);l>g;l--,
...
function Nf(a,b){function c(a,b,c,d){var e=a.f,f=a.ya,g=a.xa,j=a.Fa;a=a.head[b];if(a<=e)e=1,c[1]=a,d[1]=1;else{b=f[a-e];e=f[a-e+1]-b;Ca(c,1,g,b,e);Ca(d,1,j,b,e);for(c=1;c<=e;c++)d[c]=-d[c]}return e}function d(a,b,c){var d=a.f,e=a.cb,f=a.cb,g=a.f,j=a.ya,h=a.xa,l=a.Fa,m=a.head,n,p,q;Ca(f,1,b,1,g);for(b=1;b<=g;b++)if(q=c[b],0!=q)if(n=m[b],n<=g)f[n]-=q;else{p=j[n-g];for(n=j[n-g+1];p<n;p++)f[h[p]]+=l[p]*q}pj(a.R,e);for(a=1;a<=d;a++)c[a]+=e[a]}function e(a,b,c){var d=a.f,e=a.cb,f=a.cb,g=a.f,j=a.ya,h=a.xa,
l=a.Fa,m=a.head,n,p,q,r;for(n=1;n<=g;n++){p=m[n];r=b[n];if(p<=g)r-=c[p];else{q=j[p-g];for(p=j[p-g+1];q<p;q++)r+=l[q]*c[h[q]]}f[n]=r}rj(a.R,e);for(a=1;a<=d;a++)c[a]+=e[a]}function f(a,b,c){var d=a.f,e=a.ue,f=a.Fd,g=a.te,j=a.ve,h;if(c<=d)h=e[c]+f[c]++,g[h]=b,j[h]=1;else{h=a.ya;var l=a.xa;a=a.Fa;var m;m=h[c-d];c=h[c-d+1];for(d=m;d<c;d++)h=l[d],h=e[h]+f[h]++,g[h]=b,j[h]=-a[d]}}function g(a,b){var c=a.c,d=a.d,e=a.l,f,g;f=a.head[a.f+b];switch(e[b]){case K:g=c[f];break;case od:g=d[f];break;case Yc:g=0;break;
case Gc:g=c[f]}return g}function j(a){var b=a.h,c=a.Ma,d=a.Gc,f;f=a.f;var g=a.t,j=a.head,h=a.Fc,l;for(l=1;l<=f;l++)h[l]=g[j[l]];Ca(d,1,h,1,f);rj(a.R,d);e(a,h,d);for(f=1;f<=b;f++){g=a.f;l=a.t;h=j=k;j=a.head[g+f];h=l[j];if(j<=g)h-=d[j];else{l=a.ya;for(var m=a.xa,n=a.Fa,p=k,q=k,p=k,p=l[j-g],q=l[j-g+1];p<q;p++)h+=n[p]*d[m[p]]}c[f]=h}}function h(a,b){var c=a.h,d=a.l,e=a.Ma,f=a.kc,g,j,h,l;l=j=0;for(g=1;g<=c;g++){h=e[g];switch(d[g]){case K:if(h>=-b)continue;break;case od:if(h<=+b)continue;break;case Yc:if(-b<=
h&&h<=+b)continue;break;case Gc:continue}h=h*h/f[g];l<h&&(j=g,l=h)}a.C=j}function l(a,b){var c=a.f,d=a.type,e=a.c,f=a.d,g=a.t,j=a.head,h=a.B,l=a.Da,m=a.C,n=a.tb,p=a.Qa,q=a.gh,r,t,u,x,z,A,C,E,F;C=0<a.Ma[m]?-1:1;r=j[c+m];d[r]==R?(m=-1,t=0,F=f[r]-e[r],z=1):(t=m=0,F=v,z=0);for(u=1;u<=q;u++){c=n[u];r=j[c];x=C*p[c];if(0<x)if(1==h&&0>g[r])A=b*(1+w*Math.abs(e[r])),E=(e[r]+A-l[c])/x,r=K;else if(1==h&&0<g[r])continue;else if(d[r]==$c||d[r]==R||d[r]==G)A=b*(1+w*Math.abs(f[r])),E=(f[r]+A-l[c])/x,r=od;else continue;
...
Array(1+L+u);x.Za=Array(1+u);x.ya=Array(1+u+1);x.xa=Array(1+F);x.Fa=Array(1+F);x.head=Array(1+L+u);x.l=Array(1+u);x.ue=Array(1+L+1);x.Fd=Array(1+L);x.te=s;x.ve=s;x.Da=Array(1+L);x.Ma=Array(1+u);x.dd=Array(1+L+u);x.kc=Array(1+u);x.tb=Array(1+L);x.Qa=Array(1+L);x.Qb=Array(1+u);x.hb=Array(1+u);x.cb=Array(1+L);x.Fc=Array(1+L);x.Gc=Array(1+L);x.bg=Array(1+L);var P=x.f,I=x.h,X=x.type,A=x.c,M=x.d,N=x.t,za=x.Za,ua=x.ya,va=x.xa,ka=x.Fa,fc=x.head,Ee=x.l,Ve=x.dd,We=x.kc,xb,Ja,ud,Sd,Ic,ha,ba;for(xb=1;xb<=P;xb++)ha=
...
a.head,1,P);ud=0;for(xb=1;xb<=P;xb++)ha=a.k[xb],ha.l!=D&&(ud++,fc[P+ud]=xb,Ee[ud]=ha.l);for(Ja=1;Ja<=I;Ja++)ba=a.e[Ja],ba.l!=D&&(ud++,fc[P+ud]=P+Ja,Ee[ud]=ba.l);x.valid=1;a.valid=0;x.R=a.R;a.R=s;var Ob=x.f,gb=x.h,U=x.ya,Bb=x.xa,ca=x.ue,Yb=x.Fd,Pb,wa,Fa,Ac,Hb;for(Pb=1;Pb<=Ob;Pb++)Yb[Pb]=1;for(wa=1;wa<=gb;wa++){Fa=U[wa];Ac=U[wa+1];for(Hb=Fa;Hb<Ac;Hb++)Yb[Bb[Hb]]++}for(Pb=ca[1]=1;Pb<=Ob;Pb++)Yb[Pb]>gb&&(Yb[Pb]=gb),ca[Pb+1]=ca[Pb]+Yb[Pb];x.te=Array(ca[Ob+1]);x.ve=Array(ca[Ob+1]);var ad=x.f,Jc=x.h,Fe=
x.head,bd=x.l,ie,cd;Da(x.Fd,1,0,ad);for(ie=1;ie<=Jc;ie++)bd[ie]!=Gc&&(cd=Fe[ad+ie],f(x,ie,cd));x.B=0;x.ec=Ga();x.Kf=x.V=a.V;x.Yd=-1;x.Lb=0;Da(Ve,1,0,P+I);for(Ja=1;Ja<=I;Ja++)We[Ja]=1;for(b.n>=Jg&&B("Objective scale factor = "+x.Va+"");;){if(0==E){var bb=x,fa=hj(bb.R,bb.f,c,bb);bb.valid=0==fa;J=fa;if(0!=J)return b.n>=Jf&&(B("Error: unable to factorize the basis matrix ("+J+")"),B("Sorry, basis recovery procedure not implemented yet")),a.R=x.R,x.R=s,a.la=a.pa=Vb,a.Y=0,a.V=x.V,a.some=0,J=bg;E=x.valid=
...
k,db=1;db<=Nc;db++)if(Ta=He[db],0>Oc[Ta]){if(Jb=Ge*(1+w*Math.abs(ib[Ta])),jb[db]<ib[Ta]-Jb){la=1;break a}}else if(0<Oc[Ta]&&(Jb=Ge*(1+w*Math.abs(da[Ta])),jb[db]>da[Ta]+Jb)){la=1;break a}la=0}tc=!la}tc&&(x.B=2,m(x),z=0,t(x,b,1));0==z&&(j(x),z=1);switch(b.bd){case Lg:if(0==x.Lb){var Ya=x.f,gc=x.h,hc=x.head,vd=x.dd,Vd=x.kc,ic=k,Wd=k;x.Lb=1E3;Da(vd,1,0,Ya+gc);for(ic=1;ic<=gc;ic++)Wd=hc[Ya+ic],vd[Wd]=1,Vd[ic]=1}}if(b.lc<pa&&x.V-x.Kf>=b.lc){if(1!=q||2==x.B&&1!=z){1!=q&&(q=0);2==x.B&&1!=z&&(z=0);continue}t(x,
b,1);b.n>=fg&&B("ITERATION LIMIT EXCEEDED; SEARCH TERMINATED");switch(x.B){case 1:H=$h;m(x);j(x);break;case 2:H=Bg}h(x,b.ob);O=0==x.C?Bg:$h;r(x,a,H,O,0);return J=yl}if(b.nb<pa&&1E3*La(x.ec)>=b.nb){if(1!=q||2==x.B&&1!=z){1!=q&&(q=0);2==x.B&&1!=z&&(z=0);continue}t(x,b,1);b.n>=fg&&B("TIME LIMIT EXCEEDED; SEARCH TERMINATED");switch(x.B){case 1:H=$h;m(x);j(x);break;case 2:H=Bg}h(x,b.ob);O=0==x.C?Bg:$h;r(x,a,H,O,0);return J=Sh}t(x,b,0);h(x,b.ob);if(0==x.C){if(1!=q||1!=z){1!=q&&(q=0);1!=z&&(z=0);continue}t(x,
...
Na.Ob=le;if(C){for(var kb=x,lb=kb.f,Pc=kb.tb,ed=kb.Qa,yb=kb.Gc,kc=k,lc=k,Gd=k,lc=kb.head[lb+kb.C],kc=1;kc<=lb;kc++)yb[kc]=0;if(lc<=lb)yb[lc]=-1;else for(var Qc=kb.ya,Mb=kb.xa,Ye=kb.Fa,Ec=k,Hd=k,ob=k,Ec=Qc[lc-lb],Hd=Qc[lc-lb+1],ob=Ec;ob<Hd;ob++)yb[Mb[ob]]=Ye[ob];d(kb,yb,ed);Gd=0;for(kc=1;kc<=lb;kc++)0!=ed[kc]&&(Pc[++Gd]=kc);kb.Ob=Gd}for(var Ka=x,zb=b.qe,ea=Ka.Ob,mb=Ka.tb,pb=Ka.Qa,tb=k,Ua=k,Sa=k,T=k,Kb=k,fd=k,T=0,Sa=1;Sa<=ea;Sa++)fd=Math.abs(pb[mb[Sa]]),T<fd&&(T=fd);Ka.fh=T;Kb=zb*(1+0.01*T);for(Ua=
0;Ua<ea;)tb=mb[ea],Math.abs(pb[tb])<Kb?ea--:(Ua++,mb[ea]=mb[Ua],mb[Ua]=tb);Ka.gh=Ua;for(var gd=x.Ma[x.C],Eb,ne=x.t,Xd=x.head,Yd=x.Ob,Sg=x.tb,xh=x.Qa,hd=k,Lb=k,id=k,id=ne[Xd[x.f+x.C]],Lb=1;Lb<=Yd;Lb++)hd=Sg[Lb],id+=ne[Xd[hd]]*xh[hd];Eb=id;if(Math.abs(gd-Eb)>1E-5*(1+Math.abs(Eb))||!(0>gd&&0>Eb||0<gd&&0<Eb))if(b.n>=Jg&&B("d1 = "+gd+"; d2 = "+Eb+""),1!=z||!C){1!=z&&(z=0);C=5;continue}x.Ma[x.C]=0<gd?0<Eb?Eb:+ra:0>Eb?Eb:-ra;switch(b.he){case Mg:l(x,0);break;case Ng:l(x,0.3*b.Ab)}if(0==x.r){if(1!=q||1!=
z||!C){1!=q&&(q=0);1!=z&&(z=0);C=1;continue}t(x,b,1);switch(x.B){case 1:b.n>=Jf&&B("Error: unable to choose basic variable on phase I");a.R=x.R;x.R=s;a.la=a.pa=Vb;a.Y=0;a.V=x.V;a.some=0;J=bg;break;case 2:b.n>=fg&&B("PROBLEM HAS UNBOUNDED SOLUTION"),r(x,a,Bg,Gg,x.head[x.f+x.C]),J=0}return J}if(0<x.r){var vf=x.Qa[x.r],lg=1E-5*(1+0.01*x.fh);if(Math.abs(vf)<lg&&(b.n>=Jg&&B("piv = "+vf+"; eps = "+lg+""),!C)){C=5;continue}}if(0<x.r){for(var Jd=x.bg,vc=x,Ze=Jd,mg=vc.f,yh=vc.r,Je=k,Je=1;Je<=mg;Je++)Ze[Je]=
0;Ze[yh]=1;rj(vc.R,Ze);if(C){for(var ng=x,Tg=Jd,Ug=ng.f,Kd=ng.r,Sb=ng.Gc,Rc=k,Rc=1;Rc<=Ug;Rc++)Sb[Rc]=0;Sb[Kd]=1;e(ng,Sb,Tg)}for(var oe=x,Vg=Jd,og=oe.f,Sc=oe.h,Of=oe.ue,pg=oe.Fd,qg=oe.te,$e=oe.ve,af=oe.Qb,Ld=oe.hb,wd=k,jd=k,Ke=k,wf=k,xd=k,Pf=k,Wg=k,jd=1;jd<=Sc;jd++)Ld[jd]=0;for(wd=1;wd<=og;wd++)if(Wg=Vg[wd],0!=Wg){Ke=Of[wd];wf=Ke+pg[wd];for(xd=Ke;xd<wf;xd++)Ld[qg[xd]]-=Wg*$e[xd]}Pf=0;for(jd=1;jd<=Sc;jd++)0!=Ld[jd]&&(af[++Pf]=jd);oe.Ac=Pf}if(0<x.r){var bf=x.Qa[x.r],Xg=x.hb[x.C];if(Math.abs(bf-Xg)>
1E-8*(1+Math.abs(bf))||!(0<bf&&0<Xg||0>bf&&0>Xg)){b.n>=Jg&&B("piv1 = "+bf+"; piv2 = "+Xg+"");if(1!=E||!C){1!=E&&(E=0);C=5;continue}0==x.hb[x.C]&&(x.Ac++,x.Qb[x.Ac]=x.C);x.hb[x.C]=bf}}var Yg=x.Da,rg=x.C,cf=x.Ob,df=x.tb,sg=x.Qa,Zd=x.r,Le=x.hh,xf=k,ef=k;0<Zd&&(Yg[Zd]=g(x,rg)+Le);if(0!=Le)for(ef=1;ef<=cf;ef++)xf=df[ef],xf!=Zd&&(Yg[xf]+=sg[xf]*Le);q=2;if(0<x.r){for(var yd=x.Ma,pe=x.C,tg=x.Ac,Nb=x.Qb,zd=x.hb,Me=k,$a=k,$d=k,$d=yd[pe]/=zd[pe],$a=1;$a<=tg;$a++)Me=Nb[$a],Me!=pe&&(yd[Me]-=zd[Me]*$d);z=2;if(1==
x.B){var mc=x.head[x.r];x.Ma[x.C]-=x.t[mc];x.t[mc]=0}}if(0<x.r)switch(b.bd){case Lg:if(0<x.Lb){var Ia=x,qe=Ia.f,Qf=Ia.type,Rf=Ia.ya,Tc=Ia.xa,yf=Ia.Fa,zf=Ia.head,Af=Ia.dd,Tb=Ia.kc,Oa=Ia.C,Uc=Ia.Ob,wc=Ia.tb,kd=Ia.Qa,ae=Ia.r,Zg=Ia.Ac,be=Ia.Qb,Ub=Ia.hb,ce=Ia.Gc,ac=k,re=k,ff=k,Vc=k,Sf=k,Bf=k,ld=k,md=k,wg=k,Ad=k,se=k,oa=k,bc=k,Tf=k;Ia.Lb--;md=wg=Af[zf[qe+Oa]]?1:0;for(ac=1;ac<=qe;ac++)ce[ac]=0;for(Vc=1;Vc<=Uc;Vc++)ac=wc[Vc],Af[zf[ac]]?(ce[ac]=oa=kd[ac],md+=oa*oa):ce[ac]=0;rj(Ia.R,ce);Ad=Ub[Oa];for(Vc=1;Vc<=
...
Md=Fb.cb,ue=k,Wf=k,de=k,Df=k,ue=Cf[xg-Uf],Wf=Cf[xg-Uf+1],Df=0,de=ue;de<Wf;de++)Md[++Df]=-te[de];Nd=Ek(Fb.R,ub,Df,fi,ue-1,Md)}Fb.valid=0==Nd;J=Nd;E=0==J?2:x.valid=0}if(0<x.r){var Wc=x,gf=x.C,Xf=x.head[x.f+x.C],$g=Wc.f,Ne=Wc.ue,Oe=Wc.Fd,cc=Wc.te,yg=Wc.ve,ve=k,we=k,ee=k;if(Xf<=$g){for(ve=we=Ne[Xf];cc[ve]!=gf;ve++);ee=we+--Oe[Xf];cc[ve]=cc[ee];yg[ve]=yg[ee]}else for(var ah=Wc.ya,Yf=Wc.xa,gi=k,zh=k,hf=k,zg=k,zh=ah[Xf-$g],hf=ah[Xf-$g+1],zg=zh;zg<hf;zg++){gi=Yf[zg];for(ve=we=Ne[gi];cc[ve]!=gf;ve++);ee=we+
--Oe[gi];cc[ve]=cc[ee];yg[ve]=yg[ee]}x.type[x.head[x.r]]!=G&&f(x,x.C,x.head[x.r])}var hi=x.f,bh=x.head,ch=x.l,Ef=x.C,dh=x.r,bk=x.df,Ti=k;if(0>dh)switch(ch[Ef]){case K:ch[Ef]=od;break;case od:ch[Ef]=K}else Ti=bh[dh],bh[dh]=bh[hi+Ef],bh[hi+Ef]=Ti,ch[Ef]=bk;x.V++;0<C&&C--}}
function ag(a,b){function c(a,b,c,d){var e=a.f,f=a.ya,g=a.xa,h=a.Fa;a=a.head[b];if(a<=e)e=1,c[1]=a,d[1]=1;else{b=f[a-e];e=f[a-e+1]-b;Ca(c,1,g,b,e);Ca(d,1,h,b,e);for(c=1;c<=e;c++)d[c]=-d[c]}return e}function d(a,b,c){var d=a.f,e=a.cb,f=a.cb,g=a.f,h=a.ya,j=a.xa,l=a.Fa,m=a.head,n,p,q;Ca(f,1,b,1,g);for(b=1;b<=g;b++)if(q=c[b],0!=q)if(n=m[b],n<=g)f[n]-=q;else{p=h[n-g];for(n=h[n-g+1];p<n;p++)f[j[p]]+=l[p]*q}pj(a.R,e);for(a=1;a<=d;a++)c[a]+=e[a]}function e(a,b,c){var d=a.f,e=a.cb,f=a.cb,g=a.f,h=a.ya,j=a.xa,
...
g[p-c+1];q<p;q++)m[h[q]]+=r*j[q]}Ca(b,1,m,1,c);pj(a.R,b);d(a,m,b)}function j(a){var b=a.h,c=a.Ma,d=a.Gc,f;f=a.f;var g=a.t,h=a.head,j=a.Fc,l;for(l=1;l<=f;l++)j[l]=g[h[l]];Ca(d,1,j,1,f);rj(a.R,d);e(a,j,d);for(f=1;f<=b;f++){g=a.f;l=a.t;j=h=k;h=a.head[g+f];j=l[h];if(h<=g)j-=d[h];else{l=a.ya;for(var m=a.xa,n=a.Fa,p=k,q=k,p=k,p=l[h-g],q=l[h-g+1];p<q;p++)j+=n[p]*d[m[p]]}c[f]=j}}function h(a,b){var c=a.l,d=a.Ma,e=a.Qb,f=a.hb,g=a.jh,h,j,l,m,n,p,q,r,t;p=0<a.Je?1:-1;l=0;r=v;n=0;for(j=1;j<=g;j++){h=e[j];m=p*
f[h];if(0<m)if(c[h]==K||c[h]==Yc)q=(d[h]+b)/m;else continue;else if(c[h]==od||c[h]==Yc)q=(d[h]-b)/m;else continue;0>q&&(q=0);if(r>q||r==q&&n<Math.abs(m))l=h,r=q,n=Math.abs(m)}if(!(0==b||0==l||0==r)){t=r;l=0;r=v;n=0;for(j=1;j<=g;j++){h=e[j];m=p*f[h];if(0<m)if(c[h]==K||c[h]==Yc)q=d[h]/m;else continue;else if(c[h]==od||c[h]==Yc)q=d[h]/m;else continue;0>q&&(q=0);q<=t&&n<Math.abs(m)&&(l=h,r=q,n=Math.abs(m))}}a.C=l;a.Rg=p*r}function l(a,b){var c=a.f,d=a.h,e=a.Yb,f=a.head,g=a.Ma,h,j;for(h=1;h<=d;h++)if(j=
f[c+h],g[h]<-b&&(e[j]==Zc||e[j]==yc)||g[h]>+b&&(e[j]==$c||e[j]==yc))return 1;return 0}function m(a){var b=a.f,c=a.h,d=a.type,e=a.c,f=a.d,g=a.Yc,h=a.Zc,j=a.head,l=a.l,m=a.Ma;Ca(d,1,a.Yb,1,b+c);Ca(e,1,g,1,b+c);Ca(f,1,h,1,b+c);for(a=1;a<=c;a++)switch(g=j[b+a],d[g]){case yc:l[a]=Yc;break;case Zc:l[a]=K;break;case $c:l[a]=od;break;case R:l[a]=m[a]>=+ra?K:m[a]<=-ra?od:Math.abs(e[g])<=Math.abs(f[g])?K:od;break;case G:l[a]=Gc}}function n(a){var b=a.f,c=a.h,d=a.Za,e=a.head,g=a.Da,h,j,l;l=d[0];for(h=1;h<=b;h++)j=
e[h],j>b&&(l+=d[j-b]*g[h]);for(g=1;g<=c;g++)j=e[b+g],j>b&&(l+=d[j-b]*f(a,g));return l}function p(a,b,c){var d=a.f,e=a.h,g=a.t,h=a.Yb,j=a.head,l=a.l,m=a.B,p=a.Da,q=a.Ma;if(!(b.n<Cg)&&!(0<b.$a&&1E3*La(a.ec)<b.$a)&&a.V!=a.Yd&&(c||0==a.V%b.Zb)){b=0;if(1==m){for(l=1;l<=d;l++)b-=g[j[l]]*p[l];for(p=1;p<=e;p++)b-=g[j[d+p]]*f(a,p)}else for(p=1;p<=e;p++){if(0>q[p]&&(l[p]==K||l[p]==Yc))b-=q[p];if(0<q[p]&&(l[p]==od||l[p]==Yc))b+=q[p]}e=0;for(l=1;l<=d;l++)h[j[l]]==G&&e++;1==a.B?B(" "+a.V+":  infeas = "+b+" ("+
e+")"):B("|"+a.V+": obj = "+n(a)+"  infeas = "+b+" ("+e+")");a.Yd=a.V}}function t(a,b,c,d,e){var f=a.f,g=a.h,h=a.Va,j=a.head,l=a.l,m=a.Da,p=a.Ma;b.valid=1;a.valid=0;b.R=a.R;a.R=s;Ca(b.head,1,j,1,f);b.la=c;b.pa=d;b.Y=n(a);b.V=a.V;b.some=e;for(a=1;a<=f;a++)c=j[a],c<=f?(c=b.k[c],c.l=D,c.bind=a,c.q=m[a]/c.ka):(c=b.e[c-f],c.l=D,c.bind=a,c.q=m[a]*c.sa),c.H=0;for(m=1;m<=g;m++)if(c=j[f+m],c<=f){c=b.k[c];c.l=l[m];c.bind=0;switch(l[m]){case K:c.q=c.c;break;case od:c.q=c.d;break;case Yc:c.q=0;break;case Gc:c.q=
c.c}c.H=p[m]*c.ka/h}else{c=b.e[c-f];c.l=l[m];c.bind=0;switch(l[m]){case K:c.q=c.c;break;case od:c.q=c.d;break;case Yc:c.q=0;break;case Gc:c.q=c.c}c.H=p[m]/c.sa/h}}var r=2,w=0,E=0,q=0,z,C,H,O=a.f,J=a.h,L=a.J,u={};u.f=O;u.h=J;u.type=Array(1+O+J);u.c=Array(1+O+J);u.d=Array(1+O+J);u.t=Array(1+O+J);u.Yb=Array(1+O+J);u.Yc=Array(1+O+J);u.Zc=Array(1+O+J);u.Za=Array(1+J);u.ya=Array(1+J+1);u.xa=Array(1+L);u.Fa=Array(1+L);u.dg=Array(1+O+1);u.cg=Array(1+L);u.eg=Array(1+L);u.head=Array(1+O+J);u.bind=Array(1+O+
J);u.l=Array(1+J);u.Da=Array(1+O);u.Ma=Array(1+J);u.dd=Array(1+O+J);u.kc=Array(1+O);u.Qb=Array(1+J);u.hb=Array(1+J);u.tb=Array(1+O);u.Qa=Array(1+O);u.cb=Array(1+O);u.Fc=Array(1+O);u.Gc=Array(1+O);u.bg=Array(1+O);var F=u.f,x=u.h,P=u.type,I=u.c,X=u.d,A=u.t,M=u.Yb,N=u.Yc,za=u.Zc,ua=u.Za,va=u.ya,ka=u.xa,fc=u.Fa,Ee=u.dg,Ve=u.cg,We=u.eg,xb=u.head,Ja=u.bind,ud=u.l,Sd=u.dd,Ic=u.kc,ha,ba,ga,Ob,gb,U,Bb,ca;for(ha=1;ha<=F;ha++)Bb=a.k[ha],P[ha]=Bb.type,I[ha]=Bb.c*Bb.ka,X[ha]=Bb.d*Bb.ka,A[ha]=0;for(ba=1;ba<=x;ba++)ca=
...
Ob;for(U=a.k[ha].j;U!=s;U=U.w)Ve[Ob]=U.e.A,We[Ob]=U.k.ka*U.i*U.e.sa,Ob++}Ee[F+1]=Ob;Ca(xb,1,a.head,1,F);ga=0;for(ha=1;ha<=F;ha++)Bb=a.k[ha],Bb.l!=D&&(ga++,xb[F+ga]=ha,ud[ga]=Bb.l);for(ba=1;ba<=x;ba++)ca=a.e[ba],ca.l!=D&&(ga++,xb[F+ga]=F+ba,ud[ga]=ca.l);for(ga=1;ga<=F+x;ga++)Ja[xb[ga]]=ga;u.valid=1;a.valid=0;u.R=a.R;a.R=s;u.B=0;u.ec=Ga();u.Kf=u.V=a.V;u.Yd=-1;u.Lb=0;Da(Sd,1,0,F+x);for(ha=1;ha<=F;ha++)Ic[ha]=1;for(b.n>=Jg&&B("Objective scale factor = "+u.Va+"");;){if(0==r){var Yb=u,Pb=hj(Yb.R,Yb.f,c,
Yb);Yb.valid=0==Pb;H=Pb;if(0!=H)return b.n>=Jf&&(B("Error: unable to factorize the basis matrix ("+H+")"),B("Sorry, basis recovery procedure not implemented yet")),a.R=u.R,u.R=s,a.la=a.pa=Vb,a.Y=0,a.V=u.V,a.some=0,H=bg;r=u.valid=1;w=E=0}if(0==E){j(u);E=1;if(0==u.B){if(0!=l(u,0.9*b.ob)){u.B=1;for(var wa=u.f,Fa=u.h,Ac=u.type,Hb=u.c,ad=u.d,Jc=u.Yb,Fe=u.head,bd=u.l,ie=u.Ma,cd=k,bb=k,bb=1;bb<=wa+Fa;bb++)switch(Jc[bb]){case yc:Ac[bb]=R;Hb[bb]=-1E3;ad[bb]=1E3;break;case Zc:Ac[bb]=R;Hb[bb]=0;ad[bb]=1;break;
case $c:Ac[bb]=R;Hb[bb]=-1;ad[bb]=0;break;case R:case G:Ac[bb]=G,Hb[bb]=ad[bb]=0}for(cd=1;cd<=Fa;cd++)bb=Fe[wa+cd],bd[cd]=Ac[bb]==G?Gc:0<=ie[cd]?K:od}else u.B=2,m(u);w=u.Lb=0}var fa;a:{for(var qa=b.ob,Q=u.h,Td=u.l,Rg=u.Ma,Wa=k,Wa=1;Wa<=Q;Wa++)if(Rg[Wa]<-qa&&(Td[Wa]==K||Td[Wa]==Yc)||Rg[Wa]>+qa&&(Td[Wa]==od||Td[Wa]==Yc)){fa=1;break a}fa=0}if(0!=fa){b.n>=Jf&&B("Warning: numerical instability (dual simplex, phase "+(1==u.B?"I":"II")+")");if(b.Ya==$f)return t(u,a,Vb,Vb,0),H=bg;r=u.B=0;q=5;continue}}1==
u.B&&0==l(u,b.ob)&&(p(u,b,1),u.B=2,1!=E&&(j(u),E=1),m(u),w=u.Lb=0);0==w&&(g(u,u.Da),2==u.B&&(u.Da[0]=n(u)),w=1);switch(b.bd){case Lg:if(0==u.Lb){var Kc=u.f,Zb=u.h,jg=u.head,je=u.dd,Xa=u.kc,Ha=k,ke=k;u.Lb=1E3;Da(je,1,0,Kc+Zb);for(Ha=1;Ha<=Kc;Ha++)ke=jg[Ha],je[ke]=1,Xa[Ha]=1}}if(2==u.B&&0>u.Va&&b.Ze>-v&&u.Da[0]<=b.Ze){if(1!=w||1!=E){1!=w&&(w=0);1!=E&&(E=0);continue}p(u,b,1);b.n>=fg&&B("OBJECTIVE LOWER LIMIT REACHED; SEARCH TERMINATED");t(u,a,$h,Bg,0);return H=Yh}if(2==u.B&&0<u.Va&&b.$e<+v&&u.Da[0]>=
b.$e){if(1!=w||1!=E){1!=w&&(w=0);1!=E&&(E=0);continue}p(u,b,1);b.n>=fg&&B("OBJECTIVE UPPER LIMIT REACHED; SEARCH TERMINATED");t(u,a,$h,Bg,0);return H=Zh}if(b.lc<pa&&u.V-u.Kf>=b.lc){if(2==u.B&&1!=w||1!=E){2==u.B&&1!=w&&(w=0);1!=E&&(E=0);continue}p(u,b,1);b.n>=fg&&B("ITERATION LIMIT EXCEEDED; SEARCH TERMINATED");switch(u.B){case 1:C=$h;m(u);g(u,u.Da);break;case 2:C=Bg}t(u,a,$h,C,0);return H=yl}if(b.nb<pa&&1E3*La(u.ec)>=b.nb){if(2==u.B&&1!=w||1!=E){2==u.B&&1!=w&&(w=0);1!=E&&(E=0);continue}p(u,b,1);b.n>=
fg&&B("TIME LIMIT EXCEEDED; SEARCH TERMINATED");switch(u.B){case 1:C=$h;m(u);g(u,u.Da);break;case 2:C=Bg}t(u,a,$h,C,0);return H=Sh}p(u,b,0);for(var xa=u,cb=b.Ab,Ib=xa.f,sb=xa.type,rc=xa.c,Bc=xa.d,sc=xa.head,Cb=xa.Da,Xe=xa.kc,hb=k,Aa=k,Qb=k,Ud=k,Cc=k,nb=k,Db=k,Lc=k,Cc=Ud=Qb=0,hb=1;hb<=Ib;hb++){Aa=sc[hb];Db=0;if(sb[Aa]==Zc||sb[Aa]==R||sb[Aa]==G)nb=cb*(1+0.1*Math.abs(rc[Aa])),Cb[hb]<rc[Aa]-nb&&(Db=rc[Aa]-Cb[hb]);if(sb[Aa]==$c||sb[Aa]==R||sb[Aa]==G)nb=cb*(1+0.1*Math.abs(Bc[Aa])),Cb[hb]>Bc[Aa]+nb&&(Db=
Bc[Aa]-Cb[hb]);0!=Db&&(Lc=Xe[hb],Lc<ra&&(Lc=ra),Lc=Db*Db/Lc,Cc<Lc&&(Qb=hb,Ud=Db,Cc=Lc))}xa.r=Qb;xa.Je=Ud;if(0==u.r){if(1!=w||1!=E){1!=w&&(w=0);1!=E&&(E=0);continue}p(u,b,1);switch(u.B){case 1:b.n>=fg&&B("PROBLEM HAS NO DUAL FEASIBLE SOLUTION");m(u);g(u,u.Da);z=$h;C=Gg;break;case 2:b.n>=fg&&B("OPTIMAL SOLUTION FOUND"),z=C=Bg}t(u,a,z,C,0);return H=0}for(var tc=u.bg,la=u,Ge=tc,Nc=la.f,ib=la.r,da=k,da=1;da<=Nc;da++)Ge[da]=0;Ge[ib]=1;rj(la.R,tc);if(q){for(var Oc=u,He=tc,jb=Oc.f,db=Oc.r,Ta=Oc.Gc,Jb=k,Jb=
1;Jb<=jb;Jb++)Ta[Jb]=0;Ta[db]=1;e(Oc,Ta,He)}for(var Ya=u,gc=tc,hc=Ya.f,vd=k,Vd=k,Vd=0,vd=1;vd<=hc;vd++)0!=gc[vd]&&Vd++;if(0.2<=Vd/hc){for(var ic=Ya,Wd=gc,Na=ic.f,Rb=ic.h,Za=ic.ya,$b=ic.xa,Ed=ic.Fa,uc=ic.head,Fd=ic.l,le=ic.Qb,jc=ic.hb,Dc=k,Ra=k,Ie=k,me=k,dd=k,kb=k,lb=k,kb=0,Dc=1;Dc<=Rb;Dc++)if(Fd[Dc]==Gc)jc[Dc]=0;else{Ra=uc[Na+Dc];if(Ra<=Na)lb=-Wd[Ra];else{Ie=Za[Ra-Na];me=Za[Ra-Na+1];lb=0;for(dd=Ie;dd<me;dd++)lb+=Wd[$b[dd]]*Ed[dd]}0!=lb&&(le[++kb]=Dc);jc[Dc]=lb}ic.Ac=kb}else{for(var Pc=Ya,ed=gc,yb=
Pc.f,kc=Pc.h,lc=Pc.dg,Gd=Pc.cg,Qc=Pc.eg,Mb=Pc.bind,Ye=Pc.l,Ec=Pc.Qb,Hd=Pc.hb,ob=k,Ka=k,zb=k,ea=k,mb=k,pb=k,tb=k,Ka=1;Ka<=kc;Ka++)Hd[Ka]=0;for(ob=1;ob<=yb;ob++)if(tb=ed[ob],0!=tb){Ka=Mb[ob]-yb;1<=Ka&&Ye[Ka]!=Gc&&(Hd[Ka]-=tb);zb=lc[ob];ea=lc[ob+1];for(mb=zb;mb<ea;mb++)Ka=Mb[yb+Gd[mb]]-yb,1<=Ka&&Ye[Ka]!=Gc&&(Hd[Ka]+=tb*Qc[mb])}pb=0;for(Ka=1;Ka<=kc;Ka++)0!=Hd[Ka]&&(Ec[++pb]=Ka);Pc.Ac=pb}for(var Ua=u,Sa=b.Ab,T=Ua.Ac,Kb=Ua.Qb,fd=Ua.hb,gd=k,Eb=k,ne=k,Xd=k,Yd=k,Sg=k,Xd=0,ne=1;ne<=T;ne++)Sg=Math.abs(fd[Kb[ne]]),
Xd<Sg&&(Xd=Sg);Ua.ih=Xd;Yd=Sa*(1+0.01*Xd);for(Eb=0;Eb<T;)gd=Kb[T],Math.abs(fd[gd])<Yd?T--:(Eb++,Kb[T]=Kb[Eb],Kb[Eb]=gd);Ua.jh=Eb;switch(b.he){case Mg:h(u,0);break;case Ng:h(u,0.3*b.ob)}if(0==u.C){if(1!=w||1!=E||!q){1!=w&&(w=0);1!=E&&(E=0);q=1;continue}p(u,b,1);switch(u.B){case 1:b.n>=Jf&&B("Error: unable to choose basic variable on phase I");a.R=u.R;u.R=s;a.la=a.pa=Vb;a.Y=0;a.V=u.V;a.some=0;H=bg;break;case 2:b.n>=fg&&B("PROBLEM HAS NO FEASIBLE SOLUTION"),t(u,a,Gg,Bg,u.head[u.r]),H=0}return H}var xh=
u.hb[u.C],hd=1E-5*(1+0.01*u.ih);if(Math.abs(xh)<hd&&(b.n>=Jg&&B("piv = "+xh+"; eps = "+hd+""),!q)){q=5;continue}for(var Lb=u,id=Lb.f,vf=Lb.tb,lg=Lb.Qa,Jd=Lb.Qa,vc=k,Ze=k,mg=k,Ze=Lb.head[id+Lb.C],vc=1;vc<=id;vc++)Jd[vc]=0;if(Ze<=id)Jd[Ze]=-1;else for(var yh=Lb.ya,Je=Lb.xa,ng=Lb.Fa,Tg=k,Ug=k,Kd=k,Tg=yh[Ze-id],Ug=yh[Ze-id+1],Kd=Tg;Kd<Ug;Kd++)Jd[Je[Kd]]=ng[Kd];pj(Lb.R,lg);mg=0;for(vc=1;vc<=id;vc++)0!=lg[vc]&&(vf[++mg]=vc);Lb.Ob=mg;if(q){for(var Sb=u,Rc=Sb.f,oe=Sb.tb,Vg=Sb.Qa,og=Sb.Gc,Sc=k,Of=k,pg=k,Of=
Sb.head[Rc+Sb.C],Sc=1;Sc<=Rc;Sc++)og[Sc]=0;if(Of<=Rc)og[Of]=-1;else for(var qg=Sb.ya,$e=Sb.xa,af=Sb.Fa,Ld=k,wd=k,jd=k,Ld=qg[Of-Rc],wd=qg[Of-Rc+1],jd=Ld;jd<wd;jd++)og[$e[jd]]=af[jd];d(Sb,og,Vg);pg=0;for(Sc=1;Sc<=Rc;Sc++)0!=Vg[Sc]&&(oe[++pg]=Sc);Sb.Ob=pg}var Ke=u.Qa[u.r],wf=u.hb[u.C];if(Math.abs(Ke-wf)>1E-8*(1+Math.abs(Ke))||!(0<Ke&&0<wf||0>Ke&&0>wf)){b.n>=Jg&&B("piv1 = "+Ke+"; piv2 = "+wf+"");if(1!=r||!q){1!=r&&(r=0);q=5;continue}0==u.Qa[u.r]&&(u.Ob++,u.tb[u.Ob]=u.r);u.Qa[u.r]=wf}var xd=u.Da,Pf=u.r,
Wg=u.C,bf=u.Ob,Xg=u.tb,Yg=u.Qa,rg=k,cf=k,df=k,df=u.Je/Yg[Pf];xd[Pf]=f(u,Wg)+df;if(0!=df)for(cf=1;cf<=bf;cf++)rg=Xg[cf],rg!=Pf&&(xd[rg]+=Yg[rg]*df);2==u.B&&(u.Da[0]+=u.Ma[u.C]/u.Va*(u.Je/u.Qa[u.r]));var w=2,sg=u.Ma,Zd=u.Ac,Le=u.Qb,xf=u.hb,ef=u.C,yd=u.Rg,pe=k,tg=k;sg[ef]=yd;if(0!=yd)for(tg=1;tg<=Zd;tg++)pe=Le[tg],pe!=ef&&(sg[pe]-=xf[pe]*yd);E=2;switch(b.bd){case Lg:if(0<u.Lb){var Nb=u,zd=Nb.f,Me=Nb.type,$a=Nb.head,$d=Nb.dd,mc=Nb.kc,Ia=Nb.r,qe=Nb.Ac,Qf=Nb.Qb,Rf=Nb.hb,Tc=Nb.C,yf=Nb.Ob,zf=Nb.tb,Af=Nb.Qa,
...
ac,mc[Oa]<ra&&(mc[Oa]=ra));Me[$a[zd+Tc]]==yc?mc[Ia]=1:(mc[Ia]=ae/(be*be),mc[Ia]<ra&&(mc[Ia]=ra));wc=$a[Ia];if(Me[wc]==G&&$d[wc]){$d[wc]=0;for(kd=1;kd<=yf;kd++){Oa=zf[kd];if(Oa==Ia){if(Me[$a[zd+Tc]]==yc)continue;Ub=1/Af[Ia]}else{if(Me[$a[Oa]]==yc)continue;Ub=Af[Oa]/Af[Ia]}mc[Oa]-=Ub*Ub;mc[Oa]<ra&&(mc[Oa]=ra)}}}}var md=u,wg=u.r,Ad=u.head[u.f+u.C],se=md.f,oa=k,bc=k;if(Ad<=se){var Tf=Array(2),bc=Array(2);Tf[1]=Ad;bc[1]=1;oa=Ek(md.R,wg,1,Tf,0,bc)}else{for(var Fb=md.ya,ub=md.xa,xg=md.Fa,bc=md.cb,Uf=k,Md=
k,Nd=k,Vf=k,Uf=Fb[Ad-se],Md=Fb[Ad-se+1],Vf=0,Nd=Uf;Nd<Md;Nd++)bc[++Vf]=-xg[Nd];oa=Ek(md.R,wg,Vf,ub,Uf-1,bc)}md.valid=0==oa;H=oa;r=0==H?2:u.valid=0;var Cf=u.f,fi=u.type,te=u.head,ue=u.bind,Wf=u.l,de=u.r,Df=u.Je,Wc=u.C,gf=k,gf=te[de];te[de]=te[Cf+Wc];te[Cf+Wc]=gf;ue[te[de]]=de;ue[te[Cf+Wc]]=Cf+Wc;Wf[Wc]=fi[gf]==G?Gc:0<Df?K:od;u.V++;0<q&&q--}};
